regions = [
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": 'Wine production in Austria is not only found in the wine-growing areas of "Weinland" (to include Niederösterreich, Burgenland and Wien) and "Steirerland" (Steiermark), but also in every other federal state. These are included in the wine-growing area of "Bergland".',
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "This region lies on the banks of the Sambre and the Meuse Rivers and on the valleys that have formed in the landscape. The soil consists of a shallow clay or loam layer with an alternating subsoil of limestone, sand and slate.",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Hageland is the oldest Denomination of Origin in Belgium, founded in 1997. It's located in between the cities of Leuven, Aarschot, Diest and Landen. The best vineyards lie on the Southern slopes. The soil of Hageland are iron-rich which gives a nice minerality to the wines. As in other wine regions in Belgium a whole range of grapes is planted.",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Haspengauw lies in the North-East of the Belgian province Limburg. This is the oldest Belgian wine region with winemaking practices dating back to the 10th Centrury AD. The region has a loam and marl soil with chalkrich subsoil. The vineyards in the appellation are spread out across various soil-types which leads to stylistic differences between the various domaines. The region produces (arguably) the most elegant and refined wines of the country.",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "In Heuvelland a variety of grape varieties are grown to produce wines. The winestyles are mostly light and fresh and the majority of wine produced is Sparkling. Yearly 220.000 wines are bottles.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "subregions": [
            ...
            {
                "name": "Mâconnais",
                "subregions": [{"name": "Pouilly-Fuissé"}],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
        ],
        "description": {
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "The Rhône Valley runs from its headwaters in Switzerland the French Mediterranean Sea. The Rhône Valley as a wine region refers to two clusters of appellations along the banks of the River in France, between the city of Vienne (France) and Avignon and is mostly dedicated to the production of red wines. The region is divided between the Northern Rhône and the Southern Rhône. The Northern Rhône is home to the Syrah grape variety and to the legendary vineyards of Côte Rôtie and Hermitage as well as to the tiny appellations of Condrieu and Château Grillet which produce world class Viognier based white wines. The Southern Rhône vineyards are mostly located between Montélimar and Avignon. This part of the Rhône Valley has built its reputation around the grape Grenache Noir, usually blended with Mourvèdre, Cinsault and other varieties. Chateauneuf-du-Pape, the most famous AOC of the region, permits the use of 13 different grape varieties. Other noteworthy appellations include Gigondas, Vacqueyras, Ventoux, Tavel, etc. ",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "The Ahr only has 560 hectares of vineyards, making it one of the smallest in Germany. It produces mainly red wines (80%) from Spätburgunder (Pinot Noir) and Frühburgunder. The Ahr is the northernmost wine region in the western part of the country. The climate is mild and favorable and can be very hot and humid in the steep sites. The precipitation is relatively low. ",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Baden is primarily a long, slim strip of vineyards nestled between the hills of the Black Forest and the Rhine River, stretching from Heidelberg and the Tauber Valley in the north to the Swiss border and Lake Constance in the south. It has 15.200 hectares under vine (third largest in Germany). The sunny, warm climate is influenced by the region’s position between the ridges of the Palatinate Forest and the Oden Forest, and between the Vosges Mountains and the Black Forest. The region has long sun hours and warm summers, with mild winters. The relative Mediterranean climate allows for the growth of citrus fruits, almond trees, and orchids. Baden is the most important German region for Spatburgunder (Pinot Noir). More than half of the vineyards are planted with Burgunder varieties: Spätburgunder, the forementioned Pinot Noir; Grauburgunder (Pinot Gris), a dry, food-compatible wine, and Weißburgunder (Pinot Blanc), neutral enough to accompany many foods.",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Franken has 6.100 hectares under vine, with 80% white wines. Wurzburg is the capital and the heart of the wine region, north-west of Nnurnberg. The climate is Continental with Dry, warm summers and Dry, cold winters. Part of Franken wines’ singular personality is due to the climate: cold winters, high annual rainfall, early frosts. Long, warm autumns are rare. As a result, the late-ripening Riesling plays a minor role, and the focus is on Silvaner and Muller-Thurgau. The soils are majority of weathered rock, Colored sandstone and Shell-limestone. The finest Franken wines are traditionally bottled in a Bocksbeutel, a square green or brown flacon with a round body and short neck, which lends considerable recognition value to the region’s wines.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "The wine-growing region along the Moselle, Saar and Ruwer rivers is considered Germany's oldest wine region, since the Romans. It has 8.700 hectares. The Mosel is named for the serpentine river, along which the banks rise so sharply that the vineyards are among the steepest in the world, up to 70% degrees! The wines on those slopes  produce effervescent wines with a fragrance reminiscent of spring blossoms, a pale color, light body and a refreshing, fruity acidity. The climate is one of the warmer climates in Germany thanks to its sheltered valley location. Steep slate slopes retain heat, and the river helps moderate climate. Ther is Sufficient rainfall, moderate climante and long growing season. The Mosel see themselves as Riesling specialists (60% of the total plantings). The late-maturing, noble white variety thrives in the conditions here. The steep slate slopes above the rivers store the sun's heat during the day and release it again at night. The roots of the vines penetrate deep into the ground to seek water and minerals. In this way, the winemakers can produce uniquely fine, fruity wines that have an enormous depth of flavor and a relatively low alcohol content - ideal for easy enjoyment. Also world-renowned are the noble-sweet wines of this region,  as well as the many excellent, dry and semi-dry wines. Rivaner (Müller-Thurgau) is the second most important grape variety and Elbling, an old grape variety on the Upper Mosel.",
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Nahe has 4.200 hectares under vine, making it one of the smallest wine growing regions in Germany. The Nahe region is named after the river that traverses the valleys of the forested Hunsrück Hills to Bingen, west of Rheinhessen. The high Hunsrück mountains provide protection from the cold winds, mild temperatures and lots of sunshine and no frost. The entire rock cycle of volcanic, sedimentary (sandstone, clay, limestone) and slate rocks is present in the Nahe. The steeper sites of volcanic or weathered stone, and those with red, clayish slate seem predestined for elegant, piquant Riesling wines of great finesse and a light spiciness, while flatter sites of loam, loess and sandy soils yield lighter, fragrant Müller-Thurgau wines with a flowery note. Silvaner grape thrives in a number of soils and produces full-bodied, earthy wines. Nahe also produces Grauburgunder (Pinot Gris), Weissburgunder (Pinot Blanc) Dornfelder & Spatburgunder (Pinot Noir).",
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "The Pfalz is Germany’s second largest regions (and Germany’s largest red wine region), producing every third bottle of German wine purchased domestically, with 23.500 hectares under vine. The climate is variable with lots of sun, making it one of Germany’s warmest regions. The mild climate is due to the slopes of the Palatinate Forest. The Pfalz runs from the south of Worms to the French border (Alsace), between the foothills of the Palatinate Forest. Loam is prevalent, often in a mixture with other soil types, such as loess, chalk, clay, colored sandstone or sand. The English equivalent, Palatinate, is sometimes used to refer to the Pfalz. Pleasant, mild white wines rich in bouquet and full of body are produced from Riesling, Müller-Thurgau and Grauburgunder (Pinot Gris) grapes in the Pfalz, while deep-coloured and quite complex red wines are made from Dornfelder grapes, Spatburgunder (Pinot Noir) and Portugueser grape.",
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Rheingau has 3.200 hectares of vineyards, planted with 85% of white grapes. It is is one of the most famous and distinguished wine regions of the world. The Rhine Valley is practically one long hillside on the northern bank of the river. The Taunus Hills provide natural protection from cold winds and torrential rainfall. The climate has minimal winds thanks to protective forests around the towns of Wiesbaden, Rudesheim and Geisenheim. The winters are mild and the summers are warm. The vineyards benefit from the heat-retaining surface of the Rhine River and the reflection from the river back to the vineyards. Riesling thrives particularly well in the dry, stony south-facing slopes. It also survives cold winter days and uses the long ripening period to develop fine fruit acids and aromas. The Spatlese (late harvest) style originates from the Rheingau, already as early as  1775!",
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Rheinhessen is Germany’s largest wine region with 26.800 hectares of vineyards. It lies in a valley of gentle rolling hills, south of the city of Mainz in the Frankfurt area. The climate is mild with protective hills and forests, long sun hours and little rainfall. It is thus one of Germany’s warmest regions and one of the driest regions in Central Europe. Rheinhessen winegrowers produce modern, uncomplicated, soft and easy drinking wines as well as top-quality products. The focus is on Riesling, Muller-Thurgau (Rivaner), Dornfelder, Silvaner,  Grauburgunder (Pinot Gris) and  Spatburgunder (Pinot Noir). Loess, limestone and loam, often mixed with sand or gravel, are the main soil types. The rolling hills of Rheinhessen are bordered by the Nahe and Rhine Rivers. Steep vineyard sites are confined to small areas near Bingen and south of Mainz along the Rhein Terrasse.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Württemberg has 11.100 hectares under vine. It is known as Germany's premier red wine region with nearly 70 percent that is planted with red grape varieties. The climate is mild with minimal wind. The rivers help temper the climate. The summers are hot and dry. The soils are varied and include shell-limestone, marl, loess and clay. Württemberg is east of the Rhine and Baden, between the Tauber Valley and the foothills of the Swabian Jura. The vineyards are located primarily along the valleys of the Neckar River and its tributaries, north and east of Stuttgart. The Black Forest and Swabian Jura buffer the vineyards from strong, cold winds and excessive rain. Württemberg is one of only a few places in the world that grows the Trollinger grape, and most of it is consumed locally. There are many steep slope vineyards in these valleys and often the sites are terraced and can only be tended by hand.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "subregions": [
            ...
            {
                "name": "Collio",
                "synonyms": ["Collio Goriziano"],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
                "name": "Friuli Aquileia",
                "synonyms": ["Aquileia"],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
    ...
    },
    {
        ...
        "synonyms": ["Castilla y León", "Castilla y Leon"],
        "subregions": [
            {
                "name": "Arlanza",
                "description": {"default": "", "sommelier": "", "julie": ""},
    ...
    },
    {
        ...
        "synonyms": ["Castilla-La Mancha", "Castilla La Mancha", "Castila la Mancha"],
        "subregions": [
            {
                "name": "Almansa",
                "description": {"default": "", "sommelier": "", "julie": ""},
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Neuchatel is one of the smaller wine regions of Switzerland, located in the French-speaking western half of the country, north of the much larger Vaud area. Much like its neighbour, Chasselas dominates white plantings here, however Pinot Noir is more significant here. The region is generally referred to as the 'Three Lakes' as the region - and the four AOCs within it - are found on the relatively low-lying, flatter land, centered around the lakes of Morat, Bienne and Neuchatel. Overall, this puts the wine region on what the Swiss refer to as "
            "la plaine"
            " - a relatively flat area of land from Geneva through Bern to Zurich, sandwiched to the north by the Jura and to the south by the Alps. The vineyards here are on relatively low-lying, flatter land, centered around the lakes. The climate is moderated significantly by the presence of the  lakes, which prevent summer temperatures from rising dramatically and also dampen the effects of frost and snow in winter. To maximize the vines' exposure to sunshine, they are mostly planted on the northern banks of the lakes, where the south-easterly aspect brings them warming rays all through the morning and early afternoon.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Schaffhausen is a typical Swiss-German cantonal appellation in the north, producing predominantly Pinot Noir wines in spectacular scenery and with a large German influence in the styles of wines. It has about 480 hectares under vine, with 80% of it being red varieties. The Schaffhausen landscape is divided between two topographical areas: the gently meandering, forest-topped river valleys which characterize the center and east of the canton, and the flatter land to the west close to the German border.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "The only Swiss vineyard area on the southern slopes of the Alps, Ticino is exposed to abundant rainfall and generous sunshine and has about 1.100 hectares of vineyards. This climate, with maritime influences, favours the development of Merlot. In climatic terms, Ticino stands out somewhat from other Swiss wine regions thanks to its topography, altitude and latitude. As is fitting for the most-southerly region, it has some of the hottest average summer temperatures. ",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Valais is the largest Wine region in Switzerland (30% of the total production, 5000 hectares of vineyards) stretching along the upper course of the Rhone, in the heart of the Alps. The climate is dry and sunny on those spectacular terraced vineyards, that go up to 1.100 meters high. Reinforced by strong and hot foehn winds, this microclimate particularly favours the maturation of late-ripening grape varieties found in the region. It is one of the highest wine regions in Europe. It is planted mostly with red grapes like Pinot Noir and Gamay. The Valais terroir is one of the world's most dramatic. The valley benefits from its sheltered position below the high alpine peaks. ertiginous alpine topography also gives the vines in Valais the advantage of emphasized vineyard orientation and many are planted on steep gradients of up to 42 degrees. This steepness, although making it markedly harder to manage and harvest the vines, brings the significant benefits of excellent drainage and increased exposure to sunlight.",
            "julie": "",
        },
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "Vaud is spread over more than 3.700 hectares and is the second largest wine region in Switzerland, located in the French-speaking southwest of the country. This region is strongly influenced by the proximity of lakes and is full of oenological, historical and cultural jewels. It is the only Swiss wine region to cultivate a majority of white grape varieties, with a focus on Chasselas. The Vaud wine country is divided into four main areas: La Côte stretches out along the western part of Lake Geneva, to Féchy and Mont-sur-Rolle in the centre and municipalities such as Vinzel, Perroy and Aubonne at both sides. The Lavaux region, which has been a UNESCO World Heritage Site since June 2007, extends from Lausanne to Vevey and Montreux.",
            "julie": "",
        },
    },
    {
    ...
    },
    {
        ...
        "subregions": [
            ...
            {
                "name": "Manisa",
                "subregions": [{"name": "Akhisar"}, {"name": "Kula"}],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
                "name": "Denizli",
                "subregions": [{"name": "Bekilli"}, {"name": "Güney"}],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
                "name": "İzmir",
    ...
    },
    {
        ...
        "subregions": [
            ...
            },
            {
                ...
                "subregions": [{"name": "Hastings River"}],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
                "name": "Northern Tablelands",
                "subregions": [{"name": "New England"}],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
                "name": "South Coast",
        ...
        "description": {
            "default": "",
            "sommelier": "",
            "julie": "New South Wales accounts for approximately one-quarter of Australia’s wine production, with over half of the state’s production in the heavily irrigated Riverina region, also known as the Murrumbidgee Irrigation Area. The region is also home to the Hunter Valley GI, a region renowned for the quality of its dry Semillon white wines. Other noteworthy GIs include Canberra Disctrict GI and Tumbarumba GI. ",
        },
    },
    {
        "country": "AU",
    ...
    },
    {
        ...
        "subregions": [
            ...
            {
                "name": "Far North",
                "subregions": [{"name": "Southern Flinders Ranges"}],
                "description": {"default": "", "sommelier": "", "julie": ""},
            },
            {
                "name": "Fleurieu",
        ...
        "description": {
            "default": "",
            "sommelier": "",
            "julie": "The wine state of South Australia is divided into height zones with the production concentrated around Adelaide and in the lower south-eastern sector of the state.  Each of these zones have a specific climate, grape varieties and soil types. Coonawarra GI is one of the most iconic areas of the region. Located in the Limestone Coast zone area, it is characterised by its cool, maritime-influenced climate and its well-drained red terra rossa topsoil that allow for the production of world class Cabernet Sauvignon wines. The McLaren Vale GI, located in the Fleurieu zone, has made its reputation on Grenache-Syrah-Mourvèdre blend, labelled as GSM. North of the Fleurieu zone, the Mount Lofty Ranges is home to Adelaide Hills and Piccadilly Valley GIs. Adelaide hills is famously planted with Sauvignon Blanc, Chardonnay and Pinot Noir, while the Piccadilly Valley produces some of the most iconic Riesling wines of the new world. Finally, the Inland Barossa GI is home to 150-year-old vines and is one of Australia’s most celebrated wine regions. Traditionally, the region has been offering some dense, powerful shiraz wines aged in American 300L casks (hogsheads) but more recently the region has started to produce some more restrained and elegant wines, co-fermenting Shiraz and Viognier, in the style of Côte-Rôtie wines from France.",
        },
    },
    {
        "country": "AU",
    ...
    },
    {
        ...
        "description": {
            "default": "",
            "sommelier": "",
            "julie": "Victoria is the smallest and coolest state on the Australian mainland.  Coastal Victoria is cooled by sea breezes blowing up from Antarctica, and the Port Phillip zone surrounding the city of Melbourne has a cool maritime climate. The zone includes the wine regions of the Yarra Valley, Mornington Peninsula, Geelong, Sunbury and Macedon Ranges. Pinot Noir and Chardonnay show great results here giving wines with great finesse, complexity and ageing potential especially in thee Yarra Valley, Morning Peninsula, Geelong and the coastal Gippsland zone. Shiraz is also a popular grape varieties and produces styles that are fresher and more elegant than many Australian Shiraz. The inland zones of North West Victoria, Central Victoria, and North East Victoria experience a more continental climate,. The North West Victoria zone is the hottest of the three, and irrigation is essential. Central Victoria is only slightly cooler. Red grapes, particularly Shiraz, thrive in the Bendigo, Heathcote, and Goulburn Valley GIs. In the North East Victoria zone, Rutherglen and Glenrowan are famous for sweet fortified wines. Topaque, a fortified style produced from Muscadelle grapes and Rutherglen’s fortified Brown Muscat (Muscat à Petits Grains Rouge) can be incredibly complex, rich and age worthy. ",
        },
    },
    {
        "country": "AU",
