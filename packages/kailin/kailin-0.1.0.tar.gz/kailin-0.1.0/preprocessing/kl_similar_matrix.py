...
def kl_sparse_matrix_sample(sample_name,data_name,if_draw,current_folder_input):
...
def kl_dense_matrix_sample(sample_name,data_name,if_draw,current_folder_input):
