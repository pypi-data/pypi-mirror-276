...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'browser.BrowserPerfCompat_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BROWSERPERFSERVICE._serialized_start=85
  _BROWSERPERFSERVICE._serialized_end=264
