...
class Integration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_integration", b"jfrog_integration", "openai_integration", b"openai_integration", "opsgenie_integration", b"opsgenie_integration", "pagerduty_integration", b"pagerduty_integration", "qwak_slack_app_integration", b"qwak_slack_app_integration", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["integration_id", b"integration_id", "jfrog_integration", b"jfrog_integration", "name", b"name", "openai_integration", b"openai_integration", "opsgenie_integration", b"opsgenie_integration", "pagerduty_integration", b"pagerduty_integration", "qwak_slack_app_integration", b"qwak_slack_app_integration", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["jfrog_integration", "opsgenie_integration", "pagerduty_integration", "qwak_slack_app_integration", "openai_integration"] | None: ...
...
class IntegrationSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_integration_spec", b"jfrog_integration_spec", "openai_integration_spec", b"openai_integration_spec", "opsgenie_integration_spec", b"opsgenie_integration_spec", "pagerduty_integration_spec", b"pagerduty_integration_spec", "qwak_slack_app_integration_spec", b"qwak_slack_app_integration_spec", "spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["jfrog_integration_spec", b"jfrog_integration_spec", "name", b"name", "openai_integration_spec", b"openai_integration_spec", "opsgenie_integration_spec", b"opsgenie_integration_spec", "pagerduty_integration_spec", b"pagerduty_integration_spec", "qwak_slack_app_integration_spec", b"qwak_slack_app_integration_spec", "spec", b"spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["spec", b"spec"]) -> typing_extensions.Literal["jfrog_integration_spec", "opsgenie_integration_spec", "pagerduty_integration_spec", "qwak_slack_app_integration_spec", "openai_integration_spec"] | None: ...
...
class IntegrationValidationSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_validation_spec", b"jfrog_validation_spec", "openai_validation_spec", b"openai_validation_spec", "opsgenie_validation_spec", b"opsgenie_validation_spec", "pagerduty_validation_spec", b"pagerduty_validation_spec", "qwak_slack_app_validation_spec", b"qwak_slack_app_validation_spec", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["jfrog_validation_spec", b"jfrog_validation_spec", "openai_validation_spec", b"openai_validation_spec", "opsgenie_validation_spec", b"opsgenie_validation_spec", "pagerduty_validation_spec", b"pagerduty_validation_spec", "qwak_slack_app_validation_spec", b"qwak_slack_app_validation_spec", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["jfrog_validation_spec", "opsgenie_validation_spec", "pagerduty_validation_spec", "qwak_slack_app_validation_spec", "openai_validation_spec"] | None: ...
...
class IntegrationOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_integration_options", b"jfrog_integration_options", "openai_integration_options", b"openai_integration_options", "opsgenie_integration_options", b"opsgenie_integration_options", "pagerduty_integration_options", b"pagerduty_integration_options", "qwak_slack_app_integration_options", b"qwak_slack_app_integration_options", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["jfrog_integration_options", b"jfrog_integration_options", "openai_integration_options", b"openai_integration_options", "opsgenie_integration_options", b"opsgenie_integration_options", "pagerduty_integration_options", b"pagerduty_integration_options", "qwak_slack_app_integration_options", b"qwak_slack_app_integration_options", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["type", b"type"]) -> typing_extensions.Literal["jfrog_integration_options", "opsgenie_integration_options", "pagerduty_integration_options", "qwak_slack_app_integration_options", "openai_integration_options"] | None: ...
