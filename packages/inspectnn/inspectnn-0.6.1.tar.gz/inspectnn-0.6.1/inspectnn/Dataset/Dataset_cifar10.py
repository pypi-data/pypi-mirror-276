...
def Dataset_cifar10(num_of_samples,sequenzial=False,PATH=None):
...
def Dataset_cifar10_resnet50(num_of_samples,sequenzial=False,PATH=None):
...
def load_percentage_images(v,num_of_samples=10000,PATH=None):
    (x_train, y_train), (x_test, y_test) = tf.keras.datasets.cifar10.load_data()
    x_train, x_val, y_train, y_val = train_test_split(x_train, y_train, test_size=0.1, random_state=1)
