...
class Template:
    ...
    def file_ignore_tpl(self):
        return [self.file_ignore_name + x for x in self._file_ignore_tpl]

    @classproperty
    def file_ignore_override(self):
        return [self.file_ignore_name + x for x in self._file_ignore_override]

    @classproperty
    def file_ignore(self):
        return [self.file_ignore_name + x for x in self._file_ignore]
