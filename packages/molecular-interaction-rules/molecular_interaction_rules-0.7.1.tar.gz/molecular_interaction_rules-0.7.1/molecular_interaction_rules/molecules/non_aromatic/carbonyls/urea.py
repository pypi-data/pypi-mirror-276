...
class Urea(object):
    ...
    def get_nitrogen_zmatrix(self):
        ...
        zmatrix = '''\
            ...
            X11 N11 1.0000 C11  90.0000 N12  180.0000
            0 1
        '''
    ...
    def get_monomer_b_nitrogen_zmatrix(self):
        ...
        zmatrix = '''\
            N21  :1  DISTANCE   :2  90.0000    :3    90.0000
            C21 N21 1.3945      :1  180.0000    :2   180.0000
            N22 C21 1.3945 N21 113.4670         :1     0.0000
