...
class Dimethylamine(object):
    ...
    def get_monomer_a_nitrogen_hydrogen_zmatrix(self):
        ...
        zmatrix = '''\
            H11
            N11  H11  1.0005
            C11  N11  1.4468  N11  109.7680
            H12  C11  1.0932  N11  113.8619  H11  -66.8335
    ...
    def get_monomer_b_nitrogen_zmatrix(self):
        ...
        zmatrix = '''\
          ...
          C21  N21  1.4468    :1  180.0000  :2   180.0000
          H21  C21  1.0932  N21  113.8619   :1     0.0000
    ...
    def get_monomer_b_nitrogen_hydrogen_zmatrix(self):
        ...
        zmatrix = '''\
            ...
            N21  H21  1.0005      X21   90.0000   :2    0.0000
            C21  N21  1.4468  N21  109.7680       :1  180.0000
            H22  C21  1.0932  N21  113.8619  H21  -66.8335
    ...
    def get_monomer_b_carbon_hydrogen_zmatrix(self):
        ...
        zmatrix = '''\
          H21   :1   DISTANCE  :2  90.0000     :3   90.0000
          X21  H21    1.0000   :1  90.0000     :2    0.0000
          C21  H21  1.0932     X21   90.0000   :2    0.0000
