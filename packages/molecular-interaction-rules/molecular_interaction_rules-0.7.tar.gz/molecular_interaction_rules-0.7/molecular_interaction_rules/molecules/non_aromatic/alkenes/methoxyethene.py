...
class Methoxyethene(object):
    ...
    def get_monomer_a_hydrogen_inner_zmatrix(self):
        ...
        zmatrix = '''\
              ...
              H13 C11 1.0912 C12 121.3771 H11    0.0000
    ...
    def get_monomer_b_oxygen_zmatrix(self):
      ...
      zmatrix = '''\
            O21  :1 DISTANCE X11 135.0000  :2 180.0000
            C21 O21 1.4635  :1 126.2746 X11    0.0000
            C22 C21 1.5656 O21 107.5604 X11  0.0000
    ...
    def get_monomer_b_hydrogen_zmatrix(self):
        ...
        zmatrix = '''\
              ...
              C21 C22 1.3486 H21 121.3771   :2  180.0000
    ...
    def get_monomer_b_hydrogen_inner_zmatrix(self):
        ...
        zmatrix = '''\
            H22   :1  DISTANCE :2 180.0000  :3 180.0000
            X21 H21   1.0000   :1  90.0000  :2    0.0000
