...
class TestRiskFunctions(unittest.TestCase):
    ...
    def test_get_hist_sim_pnl(self):
        risk_data = risk.get_hist_sim_pnl(['2171035.IB', '2105288.IB'], '2024-05-28', '2024-05-27')
        if risk_data is not None:
            for data in risk_data:
                print(data)
        else:
    ...
    def test_get_hist_stressed_pnl(self):
        risk_data = risk.get_hist_stressed_pnl(['2171035.IB', '2105288.IB'], '2024-05-28', '2024-05-27')
        if risk_data is not None:
            for data in risk_data:
                print(data)
        else:
    ...
    def test_get_hist_var(self):
        risk_data = risk.get_hist_var("2171035.IB", '2024-05-28', '2024-05-27', ['var', 'es'])
        if risk_data is not None:
            print(risk_data)
        else:
            print(risk_data)
