...
def get_hist_sim_pnl(inst, sim_date, base_date,   num_sims=200):
...
def get_hist_stressed_pnl(inst, sim_date, base_date,   num_sims=200):
    data_json = {'inst': inst, 'simDate': sim_date, 'baseDate': base_date, 'numSims': num_sims}
...
def get_hist_var(inst, sim_date, base_date, fields, confidence_interval=0.95):
