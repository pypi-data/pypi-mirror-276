...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.generate_embeddings  # this is an instance of the class Endpoint
        api_instance.generate_embeddings()  # this invokes api_instance.generate_embeddings.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.generate_embeddings.callable or self.callable in this class
