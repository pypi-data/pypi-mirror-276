...
class preloadIpyweb(metaclass=singleton):
    ...
    def _loadFromPreloadBlocks(self, path=''):
        try:
            ...
            logger.console.error(f'阻塞预载器解析异常:{e}')
        return self
    ...
    def _loadFromPreloadThreads(self, path=''):
        try:
            ...
            logger.console.error(f'线程预载器解析异常:{e}')
        return self
    ...
    def _loadFromPreloadProcess(self, path=''):
        try:
            ...
            logger.console.error(f'进程预载器解析异常:{e}')
        return self
    ...
    def _runBlock(self, name='', module=None):
        try:
            ...
            logger.console.error(f'[{name}]阻塞预载器执行异常:{e}')
        return self
    ...
    def _runThread(self, name='', module=None):
        try:
            ...
            logger.console.error(f'线程预载器执行异常:{e}')
        return self
    ...
    def _runProcess(self, name='', module=None):
        ...
        try:
            ...
            logger.console.error(f'进程预载器执行异常:{e}')
        return self
