...
class eventIpyweb(metaclass=singleton):
    ...
    def _loadFromEventListeners(self, path=''):
        try:
            ...
            logger.console.error(f'事件监听器解析异常:{e}')
        return self
    ...
    def _loadFromEventRegisters(self, path=''):
        ...
        try:
            ...
            logger.console.error(f'事件注册器解析异常:{e}')
        return self
    ...
    def _sysListener(self, module=None):
        try:
            ...
            logger.console.error(f'事件监听器执行异常:{e}')
        return self
    ...
    def _sysRegister(self, className='', module=None):
        try:
            ...
            logger.console.debug(f'事件注册器执行异常: {e}')
    ...
    def _userRegister(self, eventName='', eventFn=None):
        ...
        try:
            ...
            logger.console.debug(f'事件[{eventName}]注册器执行异常: {e}')
        return result
    ...
    def _once(self, eventName='', eventListener=None):
        ...
        try:
            ...
            logger.console.debug(f'一次订阅事件[{eventName}]异常: {e}')
        return result
    ...
    def _on(self, eventName='', eventListener=None):
        ...
        try:
            ...
            logger.console.debug(f'订阅事件[{eventName}]异常: {e}')
        return result
    ...
    def _off(self, eventName=''):
        ...
        try:
            ...
            logger.console.debug(f'关闭[{eventName}]事件异常: {e}')
        return result
    ...
    def _reOn(self, eventName=''):
        ...
        try:
            ...
            logger.console.debug(f'重启[{eventName}]事件异常: {e}')
        return result
    ...
    def _emit(self, eventName, *args, **kwargs):
        ...
        try:
            ...
            logger.console.debug(f'事件[{eventName}]发布异常: {e}')
        return result
    ...
    def _delete(self, eventName=''):
        ...
        try:
            ...
            logger.console.debug(f'事件[{eventName}]删除异常: {e}')
        return result
