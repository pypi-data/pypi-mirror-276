...
def get_config(wrapper_path, num_agents = 1, exploration=True):
    ...
    ppo_config = (
        ...
        .multi_agent(
            ...
            policy_mapping_fn=agent_to_module_mapping_fn if num_agents != 1 else agent_to_module_mapping_fn_single,
        ...
        .training(lr=2e-4)
        .evaluation(evaluation_interval=20, evaluation_parallel_to_training=True, evaluation_config=PPOConfig.overrides(policy_mapping_fn=agent_to_module_mapping_fn if num_agents != 1 else agent_to_module_mapping_fn_single), evaluation_num_workers=1, evaluation_num_episodes=1, evaluation_duration=1)
        .resources(
            num_gpus=1,
