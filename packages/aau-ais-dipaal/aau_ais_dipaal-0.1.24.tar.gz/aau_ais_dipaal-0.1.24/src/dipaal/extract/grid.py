...
from dipaal.extract.sql import draught_query, empty_query, meta_query, ship_query
...
class Grid:
    ...
    def __init__(self, *, gid: str, name: str, schema: str, table: str,
                 width: int, height: int, cell_size: int, description: str = None):
...
class GridExtractor:
    ...
    def extract_cid(self, grid: Grid, *, latitude: float, longitude: float, srid: int = 4326) -> int:
        ...
        Args:
            ...
            srid: The srid of the point. Defaults to 4326 EPSG, which is the World Geodetic System 1984 (WGS84).
    ...
    def _cell_cord_to_cid(self, grid: Grid, cell_cord: tuple) -> int:
        """
        Convert a set of cell coordinates to a unique cell id.

        Args:
            grid: A Grid object containing information about a grid.
            cell_cord: The cell coordinates with the format (longitude, latitude).
    ...
    def _cid_to_cell_cord(self, grid: Grid, cid: int) -> tuple:
        """
        ...
        Returns:
            The cell coordinates with the format (longitude, latitude).
        """
    ...
    def extract_empty(self, grid: Grid, cid: int, *, date_from: str = None, date_to: str = None) -> bool:
        """Extract data from the cell table.
    ...
    def _execute_grid_sql(self, cid: int, date_from: str, date_to: str, grid: Grid, sql: str) -> CursorResult:
        """
