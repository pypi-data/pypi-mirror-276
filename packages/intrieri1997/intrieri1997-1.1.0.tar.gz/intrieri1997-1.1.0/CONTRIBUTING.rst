...
**intrieri1997** could always use more documentation, whether as
part of the official **intrieri1997** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `intrieri1997` for local
development.

1. Fork the `intrieri1997` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/intrieri1997.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd intrieri1997
    (dvlpt) intrieri1997$ flake8
    (dvlpt) intrieri1997$ pytest
    
    (dvlpt) intrieri1997$ tox
...
.. _issues: https://gitlab.com/b326/intrieri1997/issues
