    ...
    def validate(self) -> None:
        ...
        if self.channels is not None:
            if not isinstance(self.channels, list):
                raise ValueError('Property "Channels" of "DeviceCancelAllOutputsScheduleRequest" is not a list.')

            for i, channels_item in enumerate(self.channels):
                if channels_item is None:
                    raise ValueError(f'Item {i} in property "Channels" of "DeviceCancelAllOutputsScheduleRequest" is None.')
