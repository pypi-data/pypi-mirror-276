...
class StreamLineRequest:
    ...
    def validate(self) -> None:
        ...
        if self.endpoint is not None:
            if not isinstance(self.endpoint, list):
                raise ValueError('Property "Endpoint" of "StreamLineRequest" is not a list.')
        ...
        if self.target_axes_indices is not None:
            if not isinstance(self.target_axes_indices, list):
                raise ValueError('Property "TargetAxesIndices" of "StreamLineRequest" is not a list.')
