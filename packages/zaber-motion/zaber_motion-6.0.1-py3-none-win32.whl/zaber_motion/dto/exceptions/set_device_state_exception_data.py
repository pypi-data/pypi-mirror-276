    ...
    def validate(self) -> None:
        ...
        if self.settings is not None:
            if not isinstance(self.settings, list):
                raise ValueError('Property "Settings" of "SetDeviceStateExceptionData" is not a list.')
        ...
        if self.stream_buffers is not None:
            if not isinstance(self.stream_buffers, list):
                raise ValueError('Property "StreamBuffers" of "SetDeviceStateExceptionData" is not a list.')
        ...
        if self.pvt_buffers is not None:
            if not isinstance(self.pvt_buffers, list):
                raise ValueError('Property "PvtBuffers" of "SetDeviceStateExceptionData" is not a list.')
        ...
        if self.triggers is not None:
            if not isinstance(self.triggers, list):
                raise ValueError('Property "Triggers" of "SetDeviceStateExceptionData" is not a list.')
        ...
        if self.stored_positions is not None:
            if not isinstance(self.stored_positions, list):
                raise ValueError('Property "StoredPositions" of "SetDeviceStateExceptionData" is not a list.')
        ...
        if self.storage is not None:
            if not isinstance(self.storage, list):
                raise ValueError('Property "Storage" of "SetDeviceStateExceptionData" is not a list.')
        ...
        if self.peripherals is not None:
            if not isinstance(self.peripherals, list):
                raise ValueError('Property "Peripherals" of "SetDeviceStateExceptionData" is not a list.')
