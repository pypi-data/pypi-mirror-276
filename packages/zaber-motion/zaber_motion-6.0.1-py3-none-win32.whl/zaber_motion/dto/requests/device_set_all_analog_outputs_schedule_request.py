    ...
    def validate(self) -> None:
        ...
        if self.values is not None:
            if not isinstance(self.values, list):
                raise ValueError('Property "Values" of "DeviceSetAllAnalogOutputsScheduleRequest" is not a list.')
        ...
        if self.future_values is not None:
            if not isinstance(self.future_values, list):
                raise ValueError('Property "FutureValues" of "DeviceSetAllAnalogOutputsScheduleRequest" is not a list.')
