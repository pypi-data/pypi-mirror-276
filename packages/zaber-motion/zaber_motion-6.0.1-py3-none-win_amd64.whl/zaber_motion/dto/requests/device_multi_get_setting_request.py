    ...
    def validate(self) -> None:
        ...
        if self.settings is not None:
            if not isinstance(self.settings, list):
                raise ValueError('Property "Settings" of "DeviceMultiGetSettingRequest" is not a list.')
        ...
        if self.axis_settings is not None:
            if not isinstance(self.axis_settings, list):
                raise ValueError('Property "AxisSettings" of "DeviceMultiGetSettingRequest" is not a list.')
