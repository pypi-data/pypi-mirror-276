    ...
    def validate(self) -> None:
        ...
        if self.axes is not None:
            if not isinstance(self.axes, list):
                raise ValueError('Property "Axes" of "StreamSetupStoreCompositeRequest" is not a list.')
        ...
        if self.pvt_axes is not None:
            if not isinstance(self.pvt_axes, list):
                raise ValueError('Property "PvtAxes" of "StreamSetupStoreCompositeRequest" is not a list.')
