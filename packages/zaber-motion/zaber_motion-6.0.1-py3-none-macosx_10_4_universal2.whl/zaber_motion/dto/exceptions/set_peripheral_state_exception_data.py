    ...
    def validate(self) -> None:
        ...
        if self.settings is not None:
            if not isinstance(self.settings, list):
                raise ValueError('Property "Settings" of "SetPeripheralStateExceptionData" is not a list.')
        ...
        if self.stored_positions is not None:
            if not isinstance(self.stored_positions, list):
                raise ValueError('Property "StoredPositions" of "SetPeripheralStateExceptionData" is not a list.')
        ...
        if self.storage is not None:
            if not isinstance(self.storage, list):
                raise ValueError('Property "Storage" of "SetPeripheralStateExceptionData" is not a list.')
