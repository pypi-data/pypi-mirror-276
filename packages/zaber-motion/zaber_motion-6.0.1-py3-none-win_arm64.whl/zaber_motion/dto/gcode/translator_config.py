...
class TranslatorConfig:
    ...
    def validate(self) -> None:
        ...
        if self.axis_mappings is not None:
            if not isinstance(self.axis_mappings, list):
                raise ValueError('Property "AxisMappings" of "TranslatorConfig" is not a list.')
        ...
        if self.axis_transformations is not None:
            if not isinstance(self.axis_transformations, list):
                raise ValueError('Property "AxisTransformations" of "TranslatorConfig" is not a list.')
