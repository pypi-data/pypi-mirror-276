    ...
    def validate(self) -> None:
        ...
        if self.interfaces is not None:
            if not isinstance(self.interfaces, list):
                raise ValueError('Property "Interfaces" of "AxesGetSettingRequest" is not a list.')
        ...
        if self.devices is not None:
            if not isinstance(self.devices, list):
                raise ValueError('Property "Devices" of "AxesGetSettingRequest" is not a list.')
        ...
        if self.axes is not None:
            if not isinstance(self.axes, list):
                raise ValueError('Property "Axes" of "AxesGetSettingRequest" is not a list.')
        ...
        if self.unit is not None:
            if not isinstance(self.unit, list):
                raise ValueError('Property "Unit" of "AxesGetSettingRequest" is not a list.')
