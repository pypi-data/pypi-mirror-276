    ...
    def validate(self) -> None:
        ...
        if self.values is not None:
            if not isinstance(self.values, list):
                raise ValueError('Property "Values" of "DeviceSetAllDigitalOutputsScheduleRequest" is not a list.')
        ...
        if self.future_values is not None:
            if not isinstance(self.future_values, list):
                raise ValueError('Property "FutureValues" of "DeviceSetAllDigitalOutputsScheduleRequest" is not a list.')
