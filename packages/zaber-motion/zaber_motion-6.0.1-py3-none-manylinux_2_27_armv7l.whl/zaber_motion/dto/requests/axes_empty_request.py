    ...
    def validate(self) -> None:
        ...
        if self.interfaces is not None:
            if not isinstance(self.interfaces, list):
                raise ValueError('Property "Interfaces" of "AxesEmptyRequest" is not a list.')
        ...
        if self.devices is not None:
            if not isinstance(self.devices, list):
                raise ValueError('Property "Devices" of "AxesEmptyRequest" is not a list.')
        ...
        if self.axes is not None:
            if not isinstance(self.axes, list):
                raise ValueError('Property "Axes" of "AxesEmptyRequest" is not a list.')
