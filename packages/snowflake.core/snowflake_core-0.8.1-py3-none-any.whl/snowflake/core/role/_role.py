...
from snowflake.core.role._generated.api_client import BridgeApiClient, StoredProcApiClient
...
class RoleCollection(AccountObjectCollectionParent["RoleResource"]):
    ...
    def __init__(self, root: "Root") -> None:
        ...
        self._api = RoleApi(
            ...
            bridge_client=BridgeApiClient(root=self.root, snowflake_connection=root.connection),
