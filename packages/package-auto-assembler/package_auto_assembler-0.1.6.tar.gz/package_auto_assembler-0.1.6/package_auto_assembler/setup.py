...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'nbformat', 'pip_audit==2.7.3', 'nbconvert', 'stdlib-list', 'pyyaml', 'requests', 'attrs>=22.2.0', 'pandas'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.1.6"
)
