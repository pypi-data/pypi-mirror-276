...
def vectorize_dict(dictionary, fill_na=False, deep=False):
    global dict_index
    for key, value in dictionary.items():
        ...
        if is_numeric(value):
            ...
            dictionary[key] = vectorize_dict(value, fill_na)
        elif is_list(value):
            dictionary[key] = vectorize_dicts(value, fill_na)
...
def vectorize_dicts(array_of_dicts, fill_na=False):
    return list(map(lambda x: vectorize_dict(dict(x), fill_na), array_of_dicts))
