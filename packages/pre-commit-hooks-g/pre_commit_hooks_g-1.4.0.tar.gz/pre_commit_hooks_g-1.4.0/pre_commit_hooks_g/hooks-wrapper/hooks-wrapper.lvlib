...
<Library LVVersion="17008000">
	...
	<Item Name="CLI-wrapper.lvclass" Type="LVClass" URL="../cli-wrapper/CLI-wrapper.lvclass"/>
	<Item Name="consolidate-errors.vi" Type="VI" URL="../consolidate-errors.vi"/>
	<Item Name="hook-data.ctl" Type="VI" URL="../hook-data.ctl"/>
	<Item Name="hooks-wrapper.vi" Type="VI" URL="../hooks-wrapper.vi"/>
</Library>
