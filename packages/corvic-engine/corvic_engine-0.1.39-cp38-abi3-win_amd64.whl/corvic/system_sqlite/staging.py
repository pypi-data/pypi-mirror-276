...
from corvic.system import StorageManager, VectorSimilarityMetric
...
class DuckDBStaging:
    ...
    def _update_blobs(self) -> None:
        ...
        """
        next_count: dict[str, int | None] = {}
        self._update_blobs_for_prefix(self._storage_manager.tabular.prefix, next_count)
        self._update_blobs_for_prefix(
            self._storage_manager.vector.prefix, next_count, self._add_vector_indexes
        )
