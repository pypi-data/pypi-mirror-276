    ...
    def authenticate(self, email: str):
        ...
        if not self.creds or not self.creds.valid:
            if self.creds and self.creds.expired and self.creds.refresh_token:
                ...
                refresh_token = self.select_one_value_by_where(
    ...
    def __insert_link_contact_phones(contact_dict: dict) -> None:
        ...
        if phone_number_original1:
            ...
            contact_phones.insert_contact_and_link_to_existing_or_new_phone(
                contact_dict=contact_dict, phone_number=phone_number_original1)
        if phone_number_original2:
            contact_phones.insert_contact_and_link_to_existing_or_new_phone(
                contact_dict=contact_dict, phone_number=phone_number_original2)
        if phone_number_original3:
            contact_phones.insert_contact_and_link_to_existing_or_new_phone(
                contact_dict=contact_dict, phone_number=phone_number_original3)
