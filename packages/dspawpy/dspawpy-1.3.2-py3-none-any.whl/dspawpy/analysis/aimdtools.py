...
def plot_msd(
    ...
    **kwargs : dict
    ...
    >>> plot_msd(lagtime, msd, figname='dspawpy_proj/dspawpy_tests/outputs/doctest/MSD.png', show=False) # doctest: +ELLIPSIS
...
def plot_rdf(
    ...
    **kwargs : dict
    ...
    >>> plot_rdf(rs, rdfs, 'H','O', figname='dspawpy_proj/dspawpy_tests/outputs/doctest/RDF.png', show=False) # doctest: +ELLIPSIS
...
def plot_rmsd(
    ...
    **kwargs : dict
    ...
    >>> plot_rmsd(lagtime, rmsd, figname='dspawpy_proj/dspawpy_tests/outputs/doctest/RMSD.png', show=False) # doctest: +ELLIPSIS
