...
from docarray.typing.url import ImageUrl as OriginalImageUrl
...
class ImageUrl(OriginalImageUrl):
    @classmethod
    def validate(cls, value, field, config):
        try:
            ...
            raise ValueError(
                f'The URL {value} cannot be loaded. Are you sure it is a valid and accessible Image URL?'
            )
...
class ImageDoc(BaseDoc):
    ...
    def validate(
        ...
        if 'url' not in value and 'bytes' not in value:
