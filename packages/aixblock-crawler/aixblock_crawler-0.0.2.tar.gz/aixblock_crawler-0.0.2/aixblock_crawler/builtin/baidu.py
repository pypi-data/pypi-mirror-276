...
class BaiduFeeder(Feeder):
    ...
    def feed(self, keyword, offset, max_num, filters=None):
        ...
        base_url = ('http://image.baidu.com/search/flip?tn=baiduimage&ie=utf-8&word={}&pn={}&gsm=3c&ct=&ic=0&lm=-1&width=0&height=0')
...
class BaiduParser(Parser):
    ...
    def parse(self, response):
        try:
            ...
            img_list = re.findall('"objURL":"(.*?)",',str(soup))
