...
**poni2006** could always use more documentation, whether as
part of the official **poni2006** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `poni2006` for local
development.

1. Fork the `poni2006` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/poni2006.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd poni2006
    (dvlpt) poni2006$ flake8
    (dvlpt) poni2006$ pytest
...
.. _issues: https://gitlab.com/b326/poni2006/issues
