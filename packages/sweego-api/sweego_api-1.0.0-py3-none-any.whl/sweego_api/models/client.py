...
class Client(BaseModel):
    """
    Represent the complete model stored in database
    """ # noqa: E501
    mta_client_id: Annotated[str, Field(strict=True, max_length=100)]
    keycloak_realm_id: Annotated[str, Field(strict=True, max_length=36)]
    id_pg_data_db_name: Annotated[int, Field(le=2147483647, strict=True, ge=0)]
    client_name: Annotated[str, Field(strict=True, max_length=255)]
    tz_id: StrictInt
    ...
    client_type: MbzFastApiSwgSiSharedInputsClientClientType
    billing_email_address: Optional[StrictStr] = None
    sweego_referral_source: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mta_client_id", "keycloak_realm_id", "id_pg_data_db_name", "client_name", "tz_id", "owner_user_id", "id", "uuid", "status", "onboarded", "creation_dt", "last_update_dt", "email_contact", "tz_name", "country", "address", "address_2", "phone_number", "postal_code", "city", "intra_vat", "company_name", "client_type", "billing_email_address", "sweego_referral_source"]
