...
class ModelInLogs(BaseModel):
    """
    ModelInLogs
    """ # noqa: E501
    campaign_tags: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, alias="campaign-tags")
    campaign_type: Optional[StrictStr] = Field(default=None, alias="campaign-type")
    ...
    search_word: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["campaign-tags", "campaign-type", "channel", "domains", "end_date", "msp", "offset", "search_word", "size", "start_date", "status", "transaction_id"]
    ...
    def campaign_type_validate_enum(cls, value):
        ...
        if value not in set(['default', 'market', 'newsletter', 'transac', 'welcome']):
            raise ValueError("must be one of enum values ('default', 'market', 'newsletter', 'transac', 'welcome')")
        return value
    ...
    def status_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['queued', 'delivered', 'undelivered']):
                raise ValueError("each list item must be one of ('queued', 'delivered', 'undelivered')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelInLogs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelInLogs from a dict"""
        if obj is None:
            return None
