...
class ModelInMsp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["domains", "end_date", "msp", "start_date"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelInMsp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelInMsp from a dict"""
        if obj is None:
            return None
