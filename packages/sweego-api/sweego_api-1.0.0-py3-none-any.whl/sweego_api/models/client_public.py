...
class ClientPublic(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "status", "onboarded", "creation_dt", "last_update_dt", "email_contact", "tz_name", "country", "address", "address_2", "phone_number", "postal_code", "city", "intra_vat", "company_name", "client_type", "billing_email_address", "sweego_referral_source"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientPublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientPublic from a dict"""
        if obj is None:
            return None
