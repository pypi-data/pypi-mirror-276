...
class UnrestrictedClientUpdate(BaseModel):
    """
    UnrestrictedClientUpdate
    """ # noqa: E501
    ...
    mta_client_id: Optional[Annotated[str, Field(strict=True, max_length=100)]] = None
    keycloak_realm_id: Optional[Annotated[str, Field(strict=True, max_length=36)]] = None
    id_pg_data_db_name: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    client_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    tz_id: Optional[StrictInt] = None
    owner_user_id: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    password: Optional[SecretStr] = None
    __properties: ClassVar[List[str]] = ["status", "uuid", "onboarded", "creation_dt", "last_update_dt", "email_contact", "tz_name", "country", "address", "address_2", "phone_number", "postal_code", "city", "intra_vat", "company_name", "client_type", "billing_email_address", "sweego_referral_source", "mta_client_id", "keycloak_realm_id", "id_pg_data_db_name", "client_name", "tz_id", "owner_user_id", "password"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnrestrictedClientUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnrestrictedClientUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mta_client_id": obj.get("mta_client_id"),
            "keycloak_realm_id": obj.get("keycloak_realm_id"),
            "id_pg_data_db_name": obj.get("id_pg_data_db_name"),
