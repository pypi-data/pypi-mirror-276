import requests
from .exceptions import AuthenticationError, NotFoundError, ApiError, BadRequestError
...
class VYSPClient:
    ...
    '''
    def __init__(self, tenant_api_key: str, gate_api_key: str, installation_type: str ="cloud", installation_url: str=None):
    ...
    def _send_request(self, endpoint, method="post", data: Dict = None):
        ...
        if response.status_code >= 400:
            if response.status_code == 404:
                ...
                raise BadRequestError("There was an error with your request. Check: \n\t- your Tenant and Gate API Keys, or\n\t- your subscription status")
            elif response.status_code == 403 or response.status_code == 401:
                raise AuthenticationError("Authentication failed")
            else:
                raise ApiError("There was an error with your request")
