...
PrebufferContainer = Literal["mpegts", "mp4"]
...
class CameraSource(Protocol):
    ...
    async def update_prebuffering_state(
        self, container: PrebufferContainer, state: PrebufferState
    ) -> None: ...
    def get_prebuffering_state(self, container: PrebufferContainer) -> PrebufferState: ...
    def on_prebuffering(self, container: PrebufferContainer) -> Observable[PrebufferState]: ...
...
class CameraDevice(Protocol):
    ...
    async def get_motion_frames(self) -> AsyncGenerator[VideoFrame, None]: ...
