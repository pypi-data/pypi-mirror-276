...
- style (dict; optional):
    ...
    _type = 'Graph'
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, defParams=Component.UNDEFINED, meta=Component.UNDEFINED, plotApi=Component.UNDEFINED, figure=Component.UNDEFINED, style=Component.UNDEFINED, selectedData=Component.UNDEFINED, className=Component.UNDEFINED, saveClick=Component.UNDEFINED, longCallback=Component.UNDEFINED, editButton=Component.UNDEFINED, currentConfig=Component.UNDEFINED, showFilter=Component.UNDEFINED, showTransform=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'currentConfig', 'defParams', 'editButton', 'figure', 'longCallback', 'meta', 'plotApi', 'saveClick', 'selectedData', 'showFilter', 'showTransform', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'currentConfig', 'defParams', 'editButton', 'figure', 'longCallback', 'meta', 'plotApi', 'saveClick', 'selectedData', 'showFilter', 'showTransform', 'style']
