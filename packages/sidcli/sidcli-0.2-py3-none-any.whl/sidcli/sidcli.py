...
def sidcli(aws_profile, db_user_name):
    ...
    click.echo(f"Selected Username = \033[103m{db_user_name}\033[0m")
    ...
    click.echo("******************************************************************************************")
    click.echo(f"1. RDS Database Username    : \033[96m{db_user_name}\033[0m")
    click.echo(f"2. RDS Database Hostname    : \033[96m{db_host}\033[0m")
    click.echo(f"3. RDS Database Port        : \033[96m{db_port}\033[0m")
    click.echo(f"4. RDS Database Name        : \033[96m{db_name}\033[0m")
    click.echo("******************************************************************************************")
    click.echo("##### DASH Database Password is on the next line. Make sure that you are not copying extra white spaces. #####")
    click.echo(f"\033[91m{pg_password}\033[0m")
...
#    clusters.sort()
    ...
    if 1 <= cluster_index <= len(clusters):
        ...
        click.echo(f"You have selected \033[96m{selected_cluster}\033[0m")
