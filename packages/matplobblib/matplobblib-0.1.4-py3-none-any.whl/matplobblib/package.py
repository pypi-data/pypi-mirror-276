...
def SDRV_2():
    ...
    answer ='''
    def P(k, A):
        return A**k / mt.factorial(k) * mt.e**(-A)
...
def ACMK_4():
    ...
    for i in range(N):
        ...
        min_angle = mt.degrees(mt.acos((max_side**2 + med_side**2 - min_side**2)/(2 * med_side * max_side)))
        max_angle = mt.degrees(mt.acos((min_side**2 + med_side**2 - max_side**2)/(2 * med_side * min_side)))
