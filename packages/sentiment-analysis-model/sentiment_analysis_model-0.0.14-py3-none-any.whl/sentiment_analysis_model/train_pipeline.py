...
def train():
    ...
    # Read the dataset
    data1 = pd.read_csv(config.data.dataset_path, encoding='ISO-8859-1', header=None, nrows=20000)
    data2 = pd.read_csv(config.data.dataset_path, encoding='ISO-8859-1', header=None, skiprows=798622, nrows=20000)
