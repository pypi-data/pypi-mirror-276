...
def send_email_notification(
    ...
    Args:
        ...
        message (list): Body of the email, provided as a list of strings; a new line
            will be inserted between every two elements of the list
    ...
    body = (
        f"{body} <br>"
        "Best regards, <br> "
        "KYOS Energy Analytics <br> <br>"
        "-- <br> "
        "KYOS Energy Analytics | Niewue Gracht 49 | 2011 ND Haarlem | the "
        "Netherlands | T: +31 (0)23 5510221 | www.kyos.com <br>"
        "-- <br>"
        "<i> Note: This email was automatically generated with a KYOS model. </i>"
    )
