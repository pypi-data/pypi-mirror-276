...
from kozmo_ai.streaming.constants import SinkType
from kozmo_ai.streaming.sinks.base import BaseSink
    ...
    def __io_class(self):
        ...
        return getattr(
            importlib.import_module(
                io_class_config.get('module_path', f'kozmo_ai.io.{self.connector_type}')),
