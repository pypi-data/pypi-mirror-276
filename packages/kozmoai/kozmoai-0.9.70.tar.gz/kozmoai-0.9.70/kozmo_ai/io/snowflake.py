...
from kozmo_ai.io.base import QUERY_ROW_LIMIT, BaseSQLConnection, ExportWritePolicy
...
class Snowflake(BaseSQLConnection):
    """
    Handles data transfer between a Snowflake data warehouse and the Kozmo app.
    """
