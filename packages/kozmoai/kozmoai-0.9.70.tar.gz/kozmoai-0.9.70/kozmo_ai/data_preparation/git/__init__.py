...
from kozmo_ai.data_preparation.git.constants import DEFAULT_KNOWN_HOSTS_FILE
from kozmo_ai.data_preparation.git.utils import (
...
from kozmo_ai.data_preparation.sync import AuthType, GitConfig
from kozmo_ai.orchestration.db.models.oauth import User
from kozmo_ai.server.logger import Logger
from kozmo_ai.settings.platform import git_settings, project_platform_activated
from kozmo_ai.settings.repo import get_repo_path
from kozmo_ai.shared.logger import VerboseFunctionExec

REMOTE_NAME = 'kozmo-repo'
                    ...
                    try:
                        ...
                        if hostname:
                            ...
                            raise TimeoutError(
                                ...
                                " https://docs.kozmo.ai/developing-in-the-cloud/setting-up-git#5-add-github-com-to-known-hosts")  # noqa: E501
    ...
    def remotes(self, limit: int = 40, user: User = None) -> List[Dict]:
        ...
        for idx, remote in enumerate(self.repo.remotes):
            ...
            try:
                ...
                print('WARNING (kozmo_ai.data_preparation.git.remotes):')
                print(err)

            try:
                remote_refs = remote.refs
                if len(remote_refs) == 0 and user:
                    from kozmo_ai.data_preparation.git import api
