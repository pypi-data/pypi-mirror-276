...
from kozmo_ai.data_integrations.utils.scheduler import (
    clear_source_output_files,
    get_extra_variables,
    initialize_state_and_runs,
)
from kozmo_ai.data_preparation.executors.executor_factory import ExecutorFactory
...
from kozmo_ai.data_preparation.models.constants import ExecutorType, PipelineType
from kozmo_ai.data_preparation.models.pipeline import Pipeline
from kozmo_ai.data_preparation.models.triggers import (
    ScheduleInterval,
    ScheduleStatus,
    ScheduleType,
...
from kozmo_ai.data_preparation.sync.git_sync import get_sync_config
from kozmo_ai.orchestration.concurrency import ConcurrencyConfig, OnLimitReached
from kozmo_ai.orchestration.db import db_connection, safe_db_query
from kozmo_ai.orchestration.db.models.schedules import (
    Backfill,
    BlockRun,
    EventMatcher,
    PipelineRun,
...
from kozmo_ai.orchestration.job_manager import JobType, job_manager
from kozmo_ai.orchestration.metrics.pipeline_run import (
...
from kozmo_ai.orchestration.utils.git import log_git_sync, run_git_sync
from kozmo_ai.orchestration.utils.resources import get_compute, get_memory
from kozmo_ai.server.logger import Logger
from kozmo_ai.settings import HOSTNAME
from kozmo_ai.settings.platform import (
    project_platform_activated,
    repo_path_from_database_query_to_project_repo_path,
)
from kozmo_ai.settings.platform.utils import get_pipeline_from_platform
from kozmo_ai.settings.repo import get_repo_path
from kozmo_ai.shared.array import find
from kozmo_ai.shared.dates import compare
from kozmo_ai.shared.environments import get_env
from kozmo_ai.shared.hash import index_by, merge_dict
from kozmo_ai.shared.retry import retry
...
def schedule_all():
    ...
    """
    {
      '/home/src/repo/default_platform2/project1': {
        'test1': [
          <kozmo_ai.orchestration.db.models.schedules.PipelineSchedule object at 0xffff85a0ef80>,
        ],
      },
      '/home/src/repo/default_platform2/project2': {
        'test2_pipeline': [
          <kozmo_ai.orchestration.db.models.schedules.PipelineSchedule object at 0xffff85a0f190>,
        ],
      },
    }
    """
                ...
                try:
                    ...
                    if should_schedule and \
                        ...
                        if (
                            ...
                            from kozmo_ai.orchestration.triggers.utils import (
...
def schedule_with_event(event: Dict = None):
    ...
    if len(matched_pipeline_schedules) > 0:
        from kozmo_ai.orchestration.triggers.utils import create_and_start_pipeline_run
