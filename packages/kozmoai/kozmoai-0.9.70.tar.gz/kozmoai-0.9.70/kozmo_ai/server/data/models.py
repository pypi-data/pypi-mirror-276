from kozmo_ai.data_cleaner.pipelines.base import BasePipeline
from kozmo_ai.server.client.kozmo import Kozmo
from kozmo_ai.server.data.base import Model
...
class Pipeline(Model):
    ...
    def sync_pipeline(self, api_key):
        Kozmo().sync_pipeline(self, api_key)
