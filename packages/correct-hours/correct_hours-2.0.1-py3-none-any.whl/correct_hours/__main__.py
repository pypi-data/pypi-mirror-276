...
from correct_hours.processors.myob.timesheet_processor import MyobTimesheetProcessor
from correct_hours.processors.xero.timesheet_processor import XeroTimesheetProcessor
        ...
        if f.is_file():
            if not should_ignore_file(f):
                ...
                if timesheet_type == 'xero':
                    ...
                    processor = XeroTimesheetProcessor(workbook, rates_workbook)
                elif timesheet_type == 'myob':
                    processor = MyobTimesheetProcessor(workbook)
                else:
