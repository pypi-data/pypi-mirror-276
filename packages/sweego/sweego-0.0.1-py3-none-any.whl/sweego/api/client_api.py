...
class ClientApi:
    ...
    @validate_call
    def restricted_update_client_clients_uuid_client_post(
        self,
        uuid_client: StrictStr,
        restricted_client_update: RestrictedClientUpdate,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param uuid_client: (required)
        :type uuid_client: str
        :param restricted_client_update: (required)
        :type restricted_client_update: RestrictedClientUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._restricted_update_client_clients_uuid_client_post_serialize(
            uuid_client=uuid_client,
            restricted_client_update=restricted_client_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def restricted_update_client_clients_uuid_client_post_with_http_info(
        self,
        uuid_client: StrictStr,
        restricted_client_update: RestrictedClientUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    def restricted_update_client_clients_uuid_client_post_without_preload_content(
        self,
        uuid_client: StrictStr,
        restricted_client_update: RestrictedClientUpdate,
        _request_timeout: Union[
    ...
    def _restricted_update_client_clients_uuid_client_post_serialize(
        self,
        uuid_client,
        restricted_client_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if restricted_client_update is not None:
            _body_params = restricted_client_update
