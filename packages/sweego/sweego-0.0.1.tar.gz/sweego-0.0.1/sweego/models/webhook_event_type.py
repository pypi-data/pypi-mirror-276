...
class WebhookEventType(BaseModel):
    ...
    channel_id: Annotated[int, Field(le=2147483647, strict=True, ge=0)]
    event_type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "channel_id", "event_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookEventType from a dict"""
        if obj is None:
            return None
