...
class Loader:
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self._union_sorted_args_cache = {}  # type: Dict[Type, List[Type]]
...
def _unionload(l: Loader, value: Any, type_) -> Any:
    ...
    try:
        sorted_args = l._union_sorted_args_cache[type_]  # type: List[Type]
    except KeyError:
        sorted_args = list(args)
        sorted_args.sort(key=lambda i: i in l.basictypes)
        l._union_sorted_args_cache[type_] = sorted_args
    ...
    if hasattr(value, 'get'):
        ...
        try:
            discriminatorscache = l._unionload_discriminatorcache[type_]  # type: Tuple[Optional[str], Optional[Dict[Any, Type]]]
