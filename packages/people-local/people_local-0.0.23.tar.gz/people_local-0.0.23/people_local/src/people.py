...
class PeopleLocal(GenericCRUD, metaclass=MetaLogger,
    ...
    def __init__(self, *, first_name_original: str = None, last_names_original: list = None,
        ...
        super().__init__(default_schema_name="contact_person", default_column_name="contact_id",
    ...
    def _process_first_name_str(self, add_people_to_a_group_function: callable, **kwargs) -> str or None:
        ...
        kwargs['groups_names'] = [self.normalized_first_name]
    ...
    def _process_last_names_str(self, add_people_to_a_group_function: callable, **kwargs) -> list:
        ...
        for normalized_last_name in self.normalized_last_names:
            ...
            kwargs['groups_names'] = [normalized_last_name]
    ...
    def _process_organizations_str(self, add_people_to_a_group_function, **kwargs) -> list:
        ...
        for organization_name in self.organizations_names_original:
            kwargs['groups_names'] = [organization_name]
    ...
    def __get_person_id_from_contact_details(self, *, people_entity_name: str, contact_id: int) -> int:
        ...
        person_id = self.select_one_value_by_id(select_clause_value="person_id", column_value=contact_id)
        if person_id is None:
            # Try to get 3 email_address_ids from contact_email_address_table
            email_address_ids = self.select_multi_value_by_id(
            ...
            for email_address_id in email_address_ids:
                ...
                person_id = self.select_one_value_by_id(
        ...
        if person_id is None:
            ...
            phone_ids = self.select_multi_value_by_id(
                schema_name="contact_phone", view_table_name="contact_phone_view",
                select_clause_value="phone_id", column_value=contact_id, limit=3, order_by="phone_id DESC")
