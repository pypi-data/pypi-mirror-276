import io
import struct
from typing import Any, BinaryIO, Generic, Self, TypeVar, cast


T = TypeVar("T")

__all__ = ["UInt", "Int", "F64", "F32", "U8", "Bool", "I8", "U16", "I16", "U32", "I32", "U64", "I64"]

class NumberMixin(Generic[T]):
...
class UInt(NumberMixin[int]):
    ...
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and 0 <= value and value < (1 << 64)
...
class Int(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and -(1 << 63) < value and value < (1 << 63)
...
class F64(NumberMixin[float]):
    ...
    def validate(cls, value: Any) -> bool:
        return isinstance(value, (float, cls))
...
class U8(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and 0 < value and value < (1 << 8)
...
class I8(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and -(1 << 7) < value and value < (1 << 7)
...
class U16(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and 0 < value and value < (1 << 16)
...
class I16(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and -(1 << 15) < value and value < (1 << 15)
...
class U32(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and 0 < value and value < (1 << 32)
...
class I32(NumberMixin[int]):
    ...
    @classmethod
    def validate(cls, value: int) -> bool:
        return isinstance(value, int) and -(1 << 31) < value and value < (1 << 31)
