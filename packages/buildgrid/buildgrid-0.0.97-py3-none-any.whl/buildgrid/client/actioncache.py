...
class ActionCacheClient:
    ...
    def _get(self, action_digest: Digest) -> ActionResult:
        ...
        res = self.__actioncache_stub.GetActionResult(request, metadata=context_module.metadata_list())
        return res
    ...
    def _update(self, action_digest: Digest, action_result: ActionResult) -> ActionResult:
        ...
        res = self.__actioncache_stub.UpdateActionResult(request, metadata=context_module.metadata_list())
        return res
