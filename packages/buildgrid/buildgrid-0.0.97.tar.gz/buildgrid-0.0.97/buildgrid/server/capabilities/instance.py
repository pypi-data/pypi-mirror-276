...
from buildgrid._exceptions import RetriableError
...
from buildgrid.server.metrics_names import CAPABILITIES_GET_CAPABILITIES_EXCEPTION_COUNT_METRIC_NAME
...
class CapabilitiesInstance(Instance):
    ...
    get_capabilities_ignored_exceptions = (RetriableError,)

    @ExceptionCounter(
        CAPABILITIES_GET_CAPABILITIES_EXCEPTION_COUNT_METRIC_NAME,
        ignored_exceptions=get_capabilities_ignored_exceptions,
    )
