...
class Instance(ABC):
    ...
    # Special case due to delayed setup methods
    _instance_name: str = None  # type: ignore[assignment]
    """
    ...
    def set_instance_name(self, instance_name: str) -> None:
        """
        Set the instance name associated with this instance.
        This method may be overriden if extra referencing is required.
