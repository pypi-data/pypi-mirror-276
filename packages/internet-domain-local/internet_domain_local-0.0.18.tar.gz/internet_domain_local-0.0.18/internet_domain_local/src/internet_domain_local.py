...
# TODO Please create array in a separate file. What about [yahoo.com](http://yahoo.com/) ...? Shall we have array in a separate file?
...
class DomainLocal(GenericMapping):
    ...
    def link_contact_to_domain(self, contact_id: int, url: str) -> dict:
        ...
        try:
            ...
            tld = self.get_tld(url)
            # TODO Why commented? - Next time, please add comment when commenting.
