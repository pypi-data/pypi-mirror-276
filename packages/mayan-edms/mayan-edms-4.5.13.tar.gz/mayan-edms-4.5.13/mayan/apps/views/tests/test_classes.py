...
class URLTestCase(BaseTestCase):
    ...
    def test_query_string_to_string(self):
        url = URL(
            url='http://example.com?a=1', query={'a': 'string'}
        )

        self.assertEqual(
            url.to_string(), 'http://example.com?a=string'
        )
    ...
    def test_path_and_querystring_to_string(self):
        ...
        self.assertEqual(
            url.to_string(), 'http://example.com?a=1'
        )

    def test_path_and_query_to_string(self):
        url = URL(
            url='http://example.com', query={'a': 1}
        )
    ...
    def test_port_set(self):
        ...
        self.assertEqual(
            url.to_string(), 'http://127.0.0.1:9999'
        )
    ...
    def test_port_replace(self):
        ...
        self.assertEqual(
            url.to_string(), 'https://127.0.0.1:9999'
        )
    ...
    def test_path_replace(self):
        ...
        self.assertEqual(
            url.to_string(), 'http://127.0.0.1:8000/view_b'
        )
