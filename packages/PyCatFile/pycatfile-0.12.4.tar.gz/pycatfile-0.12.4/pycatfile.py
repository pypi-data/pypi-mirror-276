...
'''
    ...
    $FileInfo: pycatfile.py - Last Update: 6/2/2024 Ver. 0.12.4 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 12, 4, "RC 1", 1);
__version_date_info__ = (2024, 6, 2, "RC 1", 1);
__version_date__ = str(__version_date_info__[0]) + "." + str(__version_date_info__[1]).zfill(2) + "." + str(__version_date_info__[2]).zfill(2);
__revision__ = __version_info__[3];
__revision_id__ = "$Id: 446219c8e774f7c914b64c9c4ed8d463979f99d9 $";
