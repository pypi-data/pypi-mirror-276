...
class VitalService(BaseService):
    ...
    def update_object(self, graph_object: G, update_index=True) -> VitalServiceStatus:
    ...
    def update_object_list(self, graph_object_list: List[G], update_index=True) -> VitalServiceStatus:
    ...
    def delete_object(self, object_uri: str, update_index=True) -> VitalServiceStatus:
    ...
    def delete_object_list(self, object_uri_list: List[str], update_index=True) -> VitalServiceStatus:
