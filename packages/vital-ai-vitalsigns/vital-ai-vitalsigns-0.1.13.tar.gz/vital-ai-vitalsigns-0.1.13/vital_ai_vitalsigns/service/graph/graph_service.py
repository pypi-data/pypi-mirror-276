...
class VitalGraphService:
    ...
    @abstractmethod
    def update_object(self, graph_object: G, graph_uri=None, graph_uri_list=None, vital_managed=True) -> VitalGraphStatus:
        pass

    @abstractmethod
    def update_object_list(self, graph_object_list: List[G], graph_uri=None, graph_uri_list=None, vital_managed=True) -> VitalGraphStatus:
        pass
    ...
    @abstractmethod
    def get_object_list(self, object_uri_list: List[str], graph_uri=None, graph_uri_list=None, vital_managed=True) -> ResultList:
        pass
    ...
    @abstractmethod
    def delete_object(self, object_uri: str, graph_uri=None, graph_uri_list=None, vital_managed=True) -> VitalGraphStatus:
        pass

    @abstractmethod
    def delete_object_list(self, object_uri_list: List[str], graph_uri=None, graph_uri_list=None, vital_managed=True) -> VitalGraphStatus:
        pass

    # filter graph

    @abstractmethod
    def filter_query(self, sparql_query: str, uri_binding='uri', resolve_objects=True, vital_managed=True) -> ResultList:
        pass
