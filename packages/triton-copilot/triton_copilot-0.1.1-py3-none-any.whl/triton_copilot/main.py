...
from triton_copilot.validate import validate_refs, check_dependencies
...
def initialize():
    ...
    typer.secho("We support OpenAI's gpt-4-turbo-preview, Anthropic's claude-3-opus-20240229 models to generate triton "
               "compatible code.", fg=typer.colors.MAGENTA)
