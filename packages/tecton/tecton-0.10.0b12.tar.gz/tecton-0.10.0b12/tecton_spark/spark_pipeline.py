...
from tecton_proto.common.id_pb2 import Id as TectonId
...
class SparkFeaturePipeline:
    ...
    def _apply_transformation_function(
        ...
        if mode == TransformationMode.TRANSFORMATION_MODE_PYSPARK:
            ...
            try:
                return self._run_pandas_on_spark_function(user_function, args, kwargs)
            except Exception as e:
                raise UDF_ERROR(e)
    ...
    def _run_pandas_on_spark_function(
        self,
