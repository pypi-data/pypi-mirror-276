...
class ProcessPartitionerFilter(PartitionerFilter):
    ...
    def run(self):
        ...
        while token_index < token_count:
            ...
            logger.debug(f"Getting unprocessed files for token {token_index} count {token_count}")
            ...
            logger.debug(f"Got unprocessed files for token {token_index} count {token_count}")
