...
def batch_action_command_template(
        batch_type: Annotated[
            str,
            typer.Argument(help="Type of batch to be dealt with, e.g. 'vendor_catalog'")] = ...,
...
def purge_batches(
        ...
        batch_type: Annotated[
            str,
            typer.Argument(help="Type of batch to be purged, e.g. 'vendor_catalog'")] = ...,
        before: Annotated[
            datetime.datetime,
...
def do_run(config, batch_type, action_func, user, params, progress=None):
    ...
    try:
        success = action_func(params, handler, session, user, progress=progress)
