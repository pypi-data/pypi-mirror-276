...
#[allow(non_snake_case)]
fn test_C4F10() {
    let mut C4F10: HelmholtzPure = HelmholtzPure::read_json("C4F10.json").expect("no C4F10.json");
    let vec_value = vec![
        Value::new_long(
            225.0,
            0.0,
...
#[allow(non_snake_case)]
fn test_C5F12() {
    let mut C5F12: HelmholtzPure = HelmholtzPure::read_json("C5F12.json").expect("no C5F12.json");
    let vec_value = vec![
        Value::new_long(
            250.0,
            0.0,
...
#[allow(non_snake_case)]
fn test_C6F14() {
    let mut C6F14: HelmholtzPure = HelmholtzPure::read_json("C6F14.json").expect("no C6F14.json");
    let vec_value = vec![
        Value::new_long(
            260.0,
            0.0,
...
fn test_3MethylPentane() {
    let mut mp: HelmholtzPure =
        HelmholtzPure::read_json("3MethylPentane.json").expect("no 3MethylPentane.json");
    let vec_value = vec![
        Value::new_long(
...
fn test_22DimethylButane() {
    let mut db: HelmholtzPure =
        HelmholtzPure::read_json("22DimethylButane.json").expect("no 22DimethylButane.json");
    let vec_value = vec![
        Value::new_long(
...
fn test_23DimethylButane() {
    let mut db: HelmholtzPure =
        HelmholtzPure::read_json("23DimethylButane.json").expect("no 23DimethylButane.json");
    let vec_value = vec![
        Value::new_long(
