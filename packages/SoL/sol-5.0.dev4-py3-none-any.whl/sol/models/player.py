...
class Player(GloballyUnique, Base):
    ...
    club: Mapped[Club | None] = relationship(
        'Club', back_populates='associated_players',
    ...
    federation: Mapped[Club | None] = relationship(
        'Club', back_populates='federated_players',
    ...
    merged: Mapped[list[Player]] = relationship(
        'MergedPlayer', back_populates='player',
    ...
    owner: Mapped[User] = relationship(
        'User', back_populates='owned_players')
    ...
    def delete(self):
        ...
        tourneys = sasess.execute(select(ct.c.idtourney)
                                  .where(or_(ct.c.idplayer1 == self.idplayer,
    ...
    def caption(self, html=None, localized=True, css_class=None, ignore_privacy=False,
        ...
        if not ignore_privacy:
            sasess = object_session(self)
            if (sasess is not None and sasess.info.get('ignore_privacy')
    ...
    def mergePlayers(self, other_players, clogger=None):
        ...
        for other_player in other_players:
            ...
            if isinstance(id_or_guid, str):
                ...
                midr = sasess.execute(select(pt.c.idplayer)
                ...
                if midr is None:
                    ...
                    already_merged = sasess.execute(select(mpt.c.idmergedplayer)
        ...
        ctors = sasess.query(Competitor).filter(
        ...
        for i in sourceids:
            ...
            sasess.query(MergedPlayer).filter_by(idplayer=p.idplayer) \
    ...
    def participations(self):
        ...
        q = (select(Competitor)
             .join(Tourney)
             .where(or_(Competitor.idplayer1 == self.idplayer,
    ...
    def matchesSummary(self):
        ...
        qm = union_all(
            ...
            .where(or_(ct1.c.idplayer1 == self.idplayer,
            ...
            .select_from(mt
                         .join(ct1, mt.c.idcompetitor1 == ct1.c.idcompetitor)
                         .join(ct2, mt.c.idcompetitor2 == ct2.c.idcompetitor))
            .where(or_(ct2.c.idplayer1 == self.idplayer,
    ...
    def opponents(self):
        ...
        qm = union_all(
            ...
            .select_from(mt
                         .join(ct1, mt.c.idcompetitor1 == ct1.c.idcompetitor)
                         .join(ct2, mt.c.idcompetitor2 == ct2.c.idcompetitor))
            .where(and_(ct1.c.idplayer1 == self.idplayer,
            ...
            .select_from(mt
                         .join(ct1, mt.c.idcompetitor1 == ct1.c.idcompetitor)
                         .join(ct2, mt.c.idcompetitor2 == ct2.c.idcompetitor))
            .where(and_(ct2.c.idplayer1 == self.idplayer,
                        ct1.c.idplayer2 == None,
                        ct2.c.idplayer2 == None,
                        (or_(mt.c.score1 != 0, mt.c.score2 != 0)))))
        ...
        result = [(sasess.get_one(Player, o), d[0], d[1], d[2], d[3], d[4])
