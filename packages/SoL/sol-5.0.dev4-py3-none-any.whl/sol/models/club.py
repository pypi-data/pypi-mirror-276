...
class Club(GloballyUnique, Base):
    ...
    championships: Mapped[list[Championship]] = relationship(
        'Championship', back_populates='club',
    ...
    federated_players: Mapped[list[Player]] = relationship(
        'Player', back_populates='federation',
    ...
    def countChampionships(self):
        ...
        return sasess.scalar(select(func.count(ct.c.idchampionship))
                             .where(ct.c.idclub == self.idclub))
    ...
    def countPlayers(self):
        ...
        assert sasess
        pt = Player.__table__
        return sasess.scalar(select(func.count(pt.c.idplayer))
                        .where(or_(pt.c.idclub == self.idclub,
                                   pt.c.idfederation == self.idclub)))
