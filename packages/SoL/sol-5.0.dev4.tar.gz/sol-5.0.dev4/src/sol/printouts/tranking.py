...
from ..i18n import translatable_string as _, gettext, ngettext
    ...
    def getElements(self) -> Generator:
        ...
        if self.tourney.prized and self.turn is None:
            if self.tourney.system == 'knockout':
                ...
                desc_width = (self.doc.width - rank_width -
                              (country_width if is_intl else 0) -
                              scores_width*2 - prizes_width)
                widths = (
                    rank_width, country_width, desc_width,
                    scores_width, scores_width, prizes_width
                ) if is_intl else (
    ...
    def getArgumentsFromRequest(cls, session, request):
        ...
        if 'age' in kw:
            try:
                ...
                raise OperationAborted(_('Invalid age: $age',
