...
class ContactProfilesLocal(GenericMapping, metaclass=MetaLogger,
    ...
    def insert_and_link_contact_profile(self, *, contact_dict: dict, contact_id: int,
        ...
        if person_ids:
            ...
            if not profile_id_tuple:
                ...
                lang_code_str = LangCode.detect_lang_code_str_restricted(text=contact_dict.get("display_as"),
