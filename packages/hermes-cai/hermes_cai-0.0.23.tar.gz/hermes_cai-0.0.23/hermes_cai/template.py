...
class TemplatingEngine:
    ...
    def _load_template(self, template_name: str = "production.yml.j2") -> Template:
        ...
        # TODO: fix the path to the templates.
        import os

        self._logger.info(f"### {os.listdir()=}")
        self._logger.info(f"### {os.getcwd()=}")
        loader = FileSystemLoader(searchpath="./hermes/hermes_cai/templates")
