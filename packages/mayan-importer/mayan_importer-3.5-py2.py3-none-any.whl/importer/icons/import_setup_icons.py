...
icon_import_setup_process_multiple = Icon(
    driver_name='fontawesome', symbol='play'
)
icon_import_setup_process_single = Icon(
    driver_name='fontawesome', symbol='play'
)
icon_import_setup_populate_multiple = Icon(
    driver_name='fontawesome', symbol='file-signature'
)
icon_import_setup_populate_single = Icon(
    driver_name='fontawesome', symbol='file-signature'
)
