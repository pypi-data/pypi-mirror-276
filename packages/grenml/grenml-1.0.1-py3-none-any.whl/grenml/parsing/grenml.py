...
class GRENMLHandler(xml.sax.ContentHandler, ElementHandler):
    ...
    def startElement(self, name, attrs):
        try:
            ...
            # Raise a SAX exception, since it handles the line/column
            # number
    ...
    class TopologyHandler(RecursiveElementHandler):
        ...
        def endElement(self, name):
            # If the parent handler is a topology, add itself to the
            # parent topology
        ...
        class InstitutionHander(ElementHandler):
            ...
            def endElement(self, name):
                # Quick fix. If an institution id is already in the
                # manager, ignore it.
