...
class GRENMLManager:
    ...
    def __init__(self, name=None, validator=None, writer=GRENMLWriter,
    ...
    def add_institution(
        ...
        """
        Adds a new institution to the topology. If the first argument
        is an institution, add that directly,
        otherwise take the arguments and create a new institution from
        that.
        """
    ...
    def add_institutions(self, institutions):
        ...
        :param institutions: An Iterable that contains iterables,
            dictionaries, and/or Institutions to be
    ...
    def delete_institutions(self, **kwargs):
        """
        Collects a list of institutions based on criteria and deletes
        them all
        """
    ...
    def add_node(
        ...
        if id and isinstance(id, meta.GRENMLObject):
            ...
            node = Node(
                ...
                unlocode=unlocode, address=address,
