...
class AttributeLongitudeError(AttributeError):
    """
    Attribute Longitude was given an invalid coordinate.
    (gt 180 or lt -180)
    """
    pass
...
class AttributeLatitudeError(AttributeError):
    """
    Attribute Latitude was given an invalid coordinate.
    (gt 90 or lt -90)
    """
    pass
...
class InstitutionNotFoundError(ObjectNotFoundError):
    """
    Unable to find an institution when searching for a single
    institution
    """
    pass
...
class MatchError(Exception):
    """
    Something went wrong when trying to perform a match
    """
    pass
