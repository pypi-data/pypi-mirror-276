...
from retriever.ColBERT.colbert.infra.launcher import Launcher

from retriever.ColBERT.colbert.utils.utils import create_directory, print_message

from retriever.ColBERT.colbert.indexing.collection_indexer import encode
