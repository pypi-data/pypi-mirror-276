...
class TCTColBERT():
    ...
    def retrieve_in_chunks(self, 
            ...
            with Run().context(RunConfig(nranks=0, experiment="colbert")):
    ...
    def retrieve(self, 
            ...
            with Run().context(RunConfig(nranks=2, experiment="default")):
                ...
                self.indexer.index(name="tatqa", collection=corpus_texts, overwrite=True)

                self.indexer.get_index()
                searcher = Searcher(index="tatqa", collection=corpus_texts)
