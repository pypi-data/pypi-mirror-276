...
from retriever.ColBERT.colbert.infra import ColBERTConfig
from retriever.ColBERT.colbert.training.rerank_batcher import RerankBatcher

from retriever.ColBERT.colbert.utils.amp import MixedPrecisionManager
from retriever.ColBERT.colbert.training.lazy_batcher import LazyBatcher
from retriever.ColBERT.colbert.parameters import DEVICE

from retriever.ColBERT.colbert.modeling.colbert import ColBERT
from retriever.ColBERT.colbert.modeling.reranker.electra import ElectraReranker

from retriever.ColBERT.colbert.utils.utils import print_message
from retriever.ColBERT.colbert.training.utils import print_progress, manage_checkpoints
...
def train(config: ColBERTConfig, triples, queries=None, collection=None):
    ...
    optimizer = AdamW(filter(lambda p: p.requires_grad, retriever.ColBERT.colbert.parameters()), lr=config.lr, eps=1e-8)
    optimizer.zero_grad()
