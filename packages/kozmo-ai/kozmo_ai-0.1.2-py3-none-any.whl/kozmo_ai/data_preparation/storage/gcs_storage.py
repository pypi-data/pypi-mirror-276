...
from kozmo_ai.shared.constants import GCS_PREFIX
from kozmo_ai.shared.parsers import encode_complex
from kozmo_ai.shared.urls import gcs_url_path
...
class GCSStorage(BaseStorage):
    ...
    def listdir(
        ...
        Example block output path in GCS:
            gs://kozmo_demo/pipelines/example_pipeline/.variables/example_block/output_0/
        """
