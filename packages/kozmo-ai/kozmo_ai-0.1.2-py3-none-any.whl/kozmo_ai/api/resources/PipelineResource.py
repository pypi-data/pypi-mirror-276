...
from kozmo_ai.ai.constants import LLMUseCase
from kozmo_ai.api.operations.constants import (
    DELETE,
    DETAIL,
    META_KEY_LIMIT,
    META_KEY_OFFSET,
...
from kozmo_ai.api.resources.BaseResource import BaseResource
from kozmo_ai.api.resources.BlockResource import BlockResource
from kozmo_ai.api.resources.LlmResource import LlmResource
from kozmo_ai.authentication.operation_history.utils import (
...
from kozmo_ai.data_preparation.models.custom_templates.custom_pipeline_template import (
...
from kozmo_ai.orchestration.pipeline_scheduler import (
    PipelineScheduler,
    retry_pipeline_run,
)
from kozmo_ai.server.active_kernel import switch_active_kernel
from kozmo_ai.server.kernels import PIPELINE_TO_KERNEL_NAME, KernelName
from kozmo_ai.settings.platform import project_platform_activated
from kozmo_ai.settings.platform.utils import get_pipeline_from_platform_async
from kozmo_ai.settings.repo import get_repo_path
from kozmo_ai.shared.array import find, find_index
from kozmo_ai.shared.hash import group_by, ignore_keys, merge_dict
from kozmo_ai.shared.strings import is_number
...
class PipelineResource(BaseResource):
    ...
    async def collection(self, query, meta, user, **kwargs):
        ...
        if from_history_days is not None and is_number(from_history_days):
            ...
            from kozmo_ai.cache.tag import NO_TAGS_QUERY, TagCache
