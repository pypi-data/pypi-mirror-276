...
from kozmo_ai.api.resources.Resource import Resource
from kozmo_ai.api.resources.shared import collective_loaders
...
class BaseResource(Resource, ResultSetMixIn):
    ...
    #     kozmo_ai.api.operations.constants.COOKIE_PREFIX + <cookie_name>
    cookie_names = []
    model_class = None
    parent_models_attr = {}
    ...
    def parser_class(self):
        ...
        module_name = f'kozmo_ai.api.parsers.{model_name}Parser'
    ...
    def policy_class(self):
        ...
        return getattr(
            importlib.import_module(
                'kozmo_ai.api.policies.{}Policy'.format(model_name)),
    ...
    def presenter_class(self):
        ...
        return getattr(
            importlib.import_module(
                'kozmo_ai.api.presenters.{}Presenter'.format(model_name)),
