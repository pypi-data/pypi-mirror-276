...
from kozmo_ai.shared.utils import files_in_path
...
PATHS_TO_TRAVERSE = [
    f'{root_path}/kozmo_ai/io',
]
FILES_TO_READ = [
    f'{root_path}/kozmo_ai/data_cleaner/transformer_actions/constants.py',
    f'{root_path}/kozmo_ai/data_cleaner/transformer_actions/utils.py',
]
