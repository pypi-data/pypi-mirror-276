...
from kozmo_ai.data_cleaner.shared.utils import is_geo_dataframe, is_spark_dataframe
from kozmo_ai.data_preparation.models.utils import (
    infer_variable_type,
    warn_for_repo_path,
)
from kozmo_ai.data_preparation.models.variable import VARIABLE_DIR, Variable
...
from kozmo_ai.data_preparation.storage.local_storage import LocalStorage
from kozmo_ai.settings.platform import project_platform_activated
from kozmo_ai.settings.repo import get_repo_path, get_variables_dir
from kozmo_ai.shared.constants import GCS_PREFIX, S3_PREFIX
from kozmo_ai.shared.dates import str_to_timedelta
...
class S3VariableManager(VariableManager):
    def __init__(self, repo_path=None, variables_dir=None):
        ...
        from kozmo_ai.data_preparation.storage.s3_storage import S3Storage
...
class GCSVariableManager(VariableManager):
    def __init__(self, repo_path=None, variables_dir=None):
        super().__init__(repo_path=repo_path, variables_dir=variables_dir)
        from kozmo_ai.data_preparation.storage.gcs_storage import GCSStorage
