...
setuptools.setup(
    ...
    # kozmo_ai/server/constants.py
    version='0.1.1',
    author='Kozmoai',
    author_email='contact@kozmoai.com',
    description='Kozmo is a tool for building and deploying data pipelines.',
    long_description=readme(),
    long_description_content_type='text/markdown',
    url='https://github.com/kozmoai/kozmoai',
