...
from kozmo_ai.api.constants import AttributeOperationType, AttributeType
from kozmo_ai.api.errors import ApiError
from kozmo_ai.api.mixins.result_set import ResultSetMixIn
from kozmo_ai.api.oauth_scope import OauthScope
from kozmo_ai.api.operations.constants import OperationType
from kozmo_ai.api.policies.mixins.user_permissions import UserPermissionMixIn
from kozmo_ai.api.result_set import ResultSet
from kozmo_ai.api.utils import (
...
from kozmo_ai.server.api.constants import URL_PARAMETER_API_KEY
from kozmo_ai.services.tracking.metrics import increment
from kozmo_ai.settings import (
    DISABLE_NOTEBOOK_EDIT_ACCESS,
    REQUIRE_USER_AUTHENTICATION,
    REQUIRE_USER_PERMISSIONS,
)
from kozmo_ai.shared.hash import extract, ignore_keys
        ...
        if not self.parent_resource_attr and self.parent_model():
            ...
            self.parent_resource_attr = getattr(
                importlib.import_module(
                    'kozmo_ai.api.resources.{}Resource'.format(parent_model_class)),
