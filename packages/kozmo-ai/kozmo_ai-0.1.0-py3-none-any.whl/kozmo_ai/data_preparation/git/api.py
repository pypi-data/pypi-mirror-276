...
from kozmo_ai.data_preparation.git.clients.base import Client as GitClient
...
def switch_branch(
    ...
    **kwargs,
    ...
    from kozmo_ai.data_preparation.git import Git
    ...
    try:
        ...
        try:
            ...
            print('WARNING (kozmo_ai.data_preparation.git.api):')
            print(err)
