from kozmo_ai.settings.backends import (
    AWSSecretsManagerBackend,
    BackendType,
    SettingsBackend,
)
from kozmo_ai.settings.server import *  # noqa: F401, F403
...
class Settings():
    ...
    def get_value(self, key: str, default: str = None) -> str:
        """
        Get the value of an environment variable. Add Kozmo specific logic to handle fetching
