...
from kozmo_ai.api.resources.DatabaseResource import DatabaseResource
from kozmo_ai.api.utils import get_access_for_roles
from kozmo_ai.authentication.oauth2 import encode_token, generate_access_token
from kozmo_ai.authentication.passwords import (
    create_bcrypt_hash,
    generate_salt,
    verify_password,
)
...
from kozmo_ai.orchestration.db.models.oauth import Permission, Role, User, UserRole
from kozmo_ai.shared.hash import extract, ignore_keys, index_by
...
def __load_permissions(resource):
    from kozmo_ai.api.resources.PermissionResource import PermissionResource
...
def __load_roles(resource):
    from kozmo_ai.api.resources.RoleResource import RoleResource
