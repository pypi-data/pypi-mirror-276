...
from kozmo_ai.services.aws.emr import emr
from kozmo_ai.services.aws.emr.config import EmrConfig
from kozmo_ai.services.aws.emr.resource_manager import EmrResourceManager
from kozmo_ai.services.aws.s3 import s3
...
class PySparkBlockExecutor(BlockExecutor):
    ...
    def submit_spark_job(self):
        step = {
            'name': f'run_kozmo_block_{self.pipeline.uuid}_{self.block_uuid}',
