...
from kozmo_ai.services.k8s.constants import DEFAULT_NAMESPACE
from kozmo_ai.services.k8s.job_manager import JobManager as K8sJobManager
    ...
    def get_job_manager(
        ...
        **kwargs,
        ...
        return K8sJobManager(
            job_name=f'kozmo-{job_name_prefix}-pipeline-{pipeline_run_id}',
            logger=self.logger,
