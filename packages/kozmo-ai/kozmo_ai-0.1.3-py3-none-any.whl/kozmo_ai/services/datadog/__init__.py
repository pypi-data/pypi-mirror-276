...
def gauge(metric, value, host='kozmo', tags={}):
...
def create_metrics(metrics, host='kozmo', metric_type='count'):
    # Format of argument
    # metrics = [
    #     ('metric', 'value', 'tags'),
    # ]
...
def create_metric(metric, value, host='kozmo', tags={}):
    return api.Metric.send(
        host=host,
        metric=metric,
        points=[
...
def histogram(metric, value, host='kozmo', tags={}):
    return api.Metric.send(
        host=host,
        metric=metric,
        points=[
...
def timing(metric, value, host='kozmo', tags={}):
    return api.Metric.send(
        host=host,
        metric=metric,
        points=[
