...
def __custom_output():
    ...
    from kozmo_ai.ai.utils.xgboost import create_tree_visualization
    ...
    from kozmo_ai.data_preparation.models.block.outputs import format_output_data
    from kozmo_ai.data_preparation.models.pipeline import Pipeline
    from kozmo_ai.data_preparation.models.utils import infer_variable_type
    from kozmo_ai.data_preparation.models.variable import VariableType
    ...
    if VariableType.MATRIX_SPARSE == variable_type:
        ...
        data = dict(
            text_data=text_data,
            type=DataType.IKOZMO_PNG if success else DataType.TEXT,
