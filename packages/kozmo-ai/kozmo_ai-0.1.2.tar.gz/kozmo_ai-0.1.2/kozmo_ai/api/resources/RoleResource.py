...
from kozmo_ai.orchestration.db.models.oauth import Role, RolePermission, User, UserRole
...
class RoleResource(DatabaseResource):
    ...
    def collection(self, query, meta, user, **kwargs):
        from kozmo_ai.orchestration.db.models.oauth import Permission
...
def __load_users(resource):
    from kozmo_ai.api.resources.UserResource import UserResource
