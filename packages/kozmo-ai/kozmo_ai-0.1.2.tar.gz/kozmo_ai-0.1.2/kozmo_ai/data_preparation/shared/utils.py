...
from kozmo_ai.shared.hash import get_json_value, merge_dict
...
def get_template_vars(include_python_libraries: Dict = None) -> Dict[str, Callable]:
    ...
    kwargs = dict(kozmo_secret_var=get_secret_value)
...
def get_template_vars_no_db(include_python_libraries: Dict = None) -> Dict[str, Callable]:
    ...
    try:
        from kozmo_ai.services.aws.secrets_manager.secrets_manager import get_secret
