...
GIT_ACCESS_TOKEN_SECRET_NAME = 'kozmo_git_access_token'
GIT_SSH_PRIVATE_KEY_SECRET_NAME = 'kozmo_git_ssh_private_key_b64'
GIT_SSH_PUBLIC_KEY_SECRET_NAME = 'kozmo_git_ssh_public_key_b64'
...
class GitConfig(BaseConfig):
    ...
    # Force Kozmo to show git integration panel in the UI
