...
import kozmo_ai.data_preparation.decorators
from kozmo_ai.cache.block import BlockCache
from kozmo_ai.data_integrations.sources.constants import SQL_SOURCES_MAPPING
from kozmo_ai.data_preparation.logging.logger import DictLogger
from kozmo_ai.data_preparation.logging.logger_manager_factory import LoggerManagerFactory
from kozmo_ai.data_preparation.models.block.content import hydrate_block_outputs
from kozmo_ai.data_preparation.models.block.data_integration.mixins import (
    DataIntegrationMixin,
)
from kozmo_ai.data_preparation.models.block.data_integration.utils import (
    execute_data_integration,
)
from kozmo_ai.data_preparation.models.block.dynamic.utils import (
    is_dynamic_block,
    is_dynamic_block_child,
    should_reduce_output,
    uuid_for_output_variables,
)
from kozmo_ai.data_preparation.models.block.dynamic.variables import (
    LazyVariableSet,
...
from kozmo_ai.data_preparation.models.block.errors import HasDownstreamDependencies
from kozmo_ai.data_preparation.models.block.extension.utils import handle_run_tests
from kozmo_ai.data_preparation.models.block.outputs import (
    format_output_data,
    get_outputs_for_display_async,
    get_outputs_for_display_dynamic_block,
    get_outputs_for_display_sync,
)
from kozmo_ai.data_preparation.models.block.platform.mixins import (
    ProjectPlatformAccessible,
)
from kozmo_ai.data_preparation.models.block.platform.utils import from_another_project
from kozmo_ai.data_preparation.models.block.spark.mixins import SparkBlock
from kozmo_ai.data_preparation.models.block.utils import (
    clean_name,
...
from kozmo_ai.data_preparation.models.constants import (
...
from kozmo_ai.data_preparation.models.file import File
from kozmo_ai.data_preparation.models.utils import warn_for_repo_path
from kozmo_ai.data_preparation.models.variable import Variable
from kozmo_ai.data_preparation.models.variables.constants import VariableType
from kozmo_ai.data_preparation.repo_manager import RepoConfig
from kozmo_ai.data_preparation.shared.stream import StreamToLogger
from kozmo_ai.data_preparation.shared.utils import get_template_vars
from kozmo_ai.data_preparation.templates.data_integrations.utils import get_templates
from kozmo_ai.data_preparation.templates.template import load_template
from kozmo_ai.services.spark.config import SparkConfig
from kozmo_ai.services.spark.spark import SPARK_ENABLED, get_spark_session
from kozmo_ai.settings.platform.constants import project_platform_activated
from kozmo_ai.settings.repo import base_repo_path_directory_name, get_repo_path
from kozmo_ai.shared.array import unique_by
from kozmo_ai.shared.constants import ENV_DEV, ENV_TEST
from kozmo_ai.shared.custom_logger import DX_PRINTER
from kozmo_ai.shared.environments import get_env, is_debug
from kozmo_ai.shared.hash import extract, ignore_keys, merge_dict
from kozmo_ai.shared.logger import BlockFunctionExec
from kozmo_ai.shared.parsers import encode_complex
from kozmo_ai.shared.path_fixer import (
    add_absolute_path,
    add_root_repo_path_to_relative_path,
    get_path_parts,
    remove_base_repo_path,
)
from kozmo_ai.shared.strings import format_enum
from kozmo_ai.shared.utils import clean_name as clean_name_orig
from kozmo_ai.shared.utils import is_spark_env
...
class Block(DataIntegrationMixin, SparkBlock, ProjectPlatformAccessible):
    ...
    def full_table_name(self) -> Optional[str]:
        from kozmo_ai.data_preparation.models.block.sql.utils.shared import (
    ...
    def create(
        ...
        from kozmo_ai.data_preparation.models.block.block_factory import BlockFactory
    ...
    def delete(
        ...
        # TODO : delete this block from all pipelines in all projects
        ...
        **kwargs,
        ...
        try:
            ...
            if output_messages_to_logs and not logger:
                from kozmo_ai.data_preparation.models.block.constants import (
    ...
    def __initialize_decorator_modules(
        ...
        for module_name in decorator_module_names:
            ...
            setattr(
                module,
                module_name,
                getattr(kozmo_ai.data_preparation.decorators, module_name),
            )

        module.test = kozmo_ai.data_preparation.decorators.test
    ...
    def analyze_outputs(
        ...
        for uuid, data in variable_mapping.items():
            if isinstance(data, pd.DataFrame):
                ...
                try:
                    from kozmo_ai.data_cleaner.data_cleaner import clean as clean_data
    ...
    def enrich_global_vars(
        ...
        from kozmo_ai.data_preparation.models.block.remote.models import RemoteBlock
    ...
    def __update_name(
        ...
        if (
            ...
            # /home/src/data-vault/perftools/kozmo/data_loaders/team/illusory_glitter
            old_file_path_without_extension = str(Path(old_file_path).with_suffix(''))
            #  /home/src/data-vault/perftools/kozmo/data_loaders/team
            ...
            # perftools/kozmo/data_loaders/team
            ...
            # perftools/kozmo/data_loaders/load_titanic.py
            new_path = str(
                Path(
                    os.path.join(
        ...
        if self.pipeline is not None:
            ...
            cache = BlockCache()
            if detach:
                from kozmo_ai.data_preparation.models.block.block_factory import (
                    BlockFactory,
                )
