...
from kozmo_ai import settings
from kozmo_ai.api.api_context import ApiContext
from kozmo_ai.api.errors import ApiError
from kozmo_ai.api.monitors.BaseMonitor import BaseMonitor
...
from kozmo_ai.api.presenters.BasePresenter import CustomDict, CustomList
from kozmo_ai.api.resources.BaseResource import BaseResource
from kozmo_ai.api.result_set import ResultSet
...
from kozmo_ai.orchestration.db.errors import DoesNotExistError
from kozmo_ai.settings import REQUIRE_USER_PERMISSIONS
from kozmo_ai.shared.array import flatten
from kozmo_ai.shared.environments import is_debug
from kozmo_ai.shared.hash import ignore_keys, merge_dict
from kozmo_ai.shared.strings import classify
...
class BaseOperation():
        ...
        try:
            return getattr(
                importlib.import_module(
                    'kozmo_ai.api.monitors.{}Monitor'.format(
    ...
    def __parser_class(self) -> Union[BaseParser, None]:
        ...
        module_name = f'kozmo_ai.api.parsers.{klass}Parser'
    ...
    def __policy_class(self):
        return getattr(
            importlib.import_module(
                'kozmo_ai.api.policies.{}Policy'.format(
    ...
    def __presenter_class(self):
        return getattr(
            importlib.import_module(
                'kozmo_ai.api.presenters.{}Presenter'.format(
    ...
    def __resource_class(self):
        return getattr(
            importlib.import_module(
                'kozmo_ai.api.resources.{}Resource'.format(
    ...
    def __resource_parent_class(self):
        ...
        if entity_name:
            return getattr(
                importlib.import_module(
                    'kozmo_ai.api.resources.{}Resource'.format(entity_name)),
