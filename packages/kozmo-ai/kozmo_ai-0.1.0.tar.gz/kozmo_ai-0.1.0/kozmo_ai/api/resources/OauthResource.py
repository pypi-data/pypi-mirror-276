...
from kozmo_ai.authentication.oauth2 import generate_access_token
...
from kozmo_ai.authentication.oauth.utils import (
...
from kozmo_ai.data_preparation.git.utils import get_oauth_client_id
from kozmo_ai.orchestration.db import safe_db_query
from kozmo_ai.orchestration.db.models.oauth import Oauth2AccessToken, Oauth2Application
            ...
            if ProviderName.GITHUB == provider:
                query = dict(
                    ...
                    redirect_uri=urllib.parse.quote_plus(
                        '?'.join(
                            [
                                f'https://api.kozmo.ai/v1/oauth/{pk}',
