...
class ContactEmailAdressesLocal(GenericMapping, metaclass=MetaLogger,
    ...
    def insert_contact_and_link_to_email_address(
            self, contact_dict: dict, contact_email_address_str: str, contact_id: int = None, person_id: int = None,
            profile_id: int = None) -> int or None:
        """
        ...
        if contact_email_address_id is not None and profile_id is not None:
            self.insert_mapping_if_not_exists(
