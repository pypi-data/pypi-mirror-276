...
class PossibleCodesEAN13:
    ...
    def __init__(self,scanned,skip_retry=True):
        print(f"{Style.bold}{Back.light_slate_blue}{Fore.dark_blue}::{Fore.red}Code Analsys - EAN13/EAN8{Fore.dark_blue}:: {Fore.white}Start{Style.reset}")
...
{self.mkOption(4.3)}{Fore.light_salmon_3a}CD_LEN({Fore.orange_red_1}{mlen(ean8_chped)}{Fore.light_salmon_3a}) - EAN8 w/o CKSM{Style.reset} -> {ean8_chped}
        ...
        print(f"{Style.bold}{Back.light_slate_blue}{Fore.dark_blue}::{Fore.red}Code Analsys - EAN13/EAN8{Fore.dark_blue}:: {Fore.white}End{Style.reset}")
...
class PossibleCodes:
    ...
    def __init__(self,scanned,use_ean13=False,engine=None):
        print(f"{Style.bold}{Back.light_slate_blue}{Fore.dark_blue}::{Fore.red}Code Analsys - UPCA/UPCE{Fore.dark_blue}:: {Fore.white}Start{Style.reset}")
        upce=False
        try:
            if engine:
...
{self.mkChopped(upce,3)}
        ...
        print(f"{Style.bold}{Back.light_slate_blue}{Fore.dark_blue}::{Fore.red}Code Analsys - UPCA/UPCE{Fore.dark_blue}:: {Fore.white}End{Style.reset}")
