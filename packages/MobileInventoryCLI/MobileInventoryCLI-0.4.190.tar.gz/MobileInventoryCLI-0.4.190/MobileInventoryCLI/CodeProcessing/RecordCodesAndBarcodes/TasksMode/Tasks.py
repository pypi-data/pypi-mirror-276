...
class TasksMode:
        ...
        if (fieldname in self.valid_fields) or (load == True and fieldname == 'ListQty'):
            with Session(self.engine) as session:
                ...
                for num,result in enumerate(results):
                    print(f"{Fore.light_red}{num}{Style.reset} -> {color1}{result.Name}{Style.reset}|{color2}{result.Barcode}|{result.ALT_Barcode}{Style.reset}|{color3}{result.Code}{Style.reset}|{color4}{getattr(result,fieldname)}{Style.reset}|{Fore.orange_red_1}{getattr(result,'EntryId')}{Style.reset}")
        print(f"{m}\n{hr}")
    ...
    entrySepStart=f'{Fore.light_red}\\\\{Fore.light_green}{"*"*10}{Fore.light_yellow}|{Fore.light_steel_blue}#REPLACE#{Fore.light_magenta}|{Fore.orange_red_1}{"+"*10}{Fore.light_yellow}{Style.bold} ({datetime.now()}{Style.reset})'
    entrySepEnd=f'{Fore.light_red}\\\\{Fore.orange_red_1}{"+"*10}{Fore.light_yellow}|{Fore.light_steel_blue}#REPLACE#{Fore.light_magenta}|{Fore.light_green}{"*"*10}{Fore.light_yellow}{Style.bold} ({datetime.now()}{Style.reset})'
                        ...
                        try:
                            ...
                            if text.startswith("-") or text.startswith("+"):
                                ...
                                if result:
                                    ...
                                    print(f"{m}\n{hr}")
                                    print(self.entrySepEnd.replace('#REPLACE#',f'{datetime.now()}'))
                                else:
