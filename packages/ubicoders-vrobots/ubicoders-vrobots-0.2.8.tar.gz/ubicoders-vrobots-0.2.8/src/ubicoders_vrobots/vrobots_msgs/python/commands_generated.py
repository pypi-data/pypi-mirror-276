...
def CommandMsgAddTargetId(builder, targetId):
    builder.PrependInt32Slot(3, targetId, 0)
...
def CommandMsgAddVec3Arr(builder, vec3Arr):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(vec3Arr), 0)

def CommandMsgStartVec3ArrVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def CommandMsgAddVec4Arr(builder, vec4Arr):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(vec4Arr), 0)

def CommandMsgStartVec4ArrVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def CommandMsgAddX(builder, x):
    builder.PrependFloat32Slot(10, x, 0.0)

def CommandMsgAddY(builder, y):
    builder.PrependFloat32Slot(11, y, 0.0)

def CommandMsgAddZ(builder, z):
    builder.PrependFloat32Slot(12, z, 0.0)

def CommandMsgAddW(builder, w):
    builder.PrependFloat32Slot(13, w, 0.0)
...
class CommandMsgT(object):
    ...
    def _UnPack(self, commandMsg):
        ...
        self.targetId = commandMsg.TargetId()
    ...
    def Pack(self, builder):
        ...
        if self.intArr is not None:
            if np is not None and type(self.intArr) is np.ndarray:
                ...
                for i in reversed(range(len(self.intArr))):
                    builder.PrependUint32(self.intArr[i])
        ...
        CommandMsgAddTargetId(builder, self.targetId)
