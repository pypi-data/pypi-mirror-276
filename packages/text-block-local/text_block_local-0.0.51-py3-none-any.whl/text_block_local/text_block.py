...
class TextBlocks(GenericCRUD, metaclass=MetaLogger, object=object1):
    ...
    # TODO The text we send it the text in the text_block_id, just to save the SELECT?
    ...
    # TODO Shall we move this method to PersonsLocal class
    ...
    # TODO Shall we move this method to ProfilesLocal class
    ...
    # TODO Can we use the generic profile mapping method?
    ...
    # TODO Move thise methods to field-local-python-package
    @lru_cache
