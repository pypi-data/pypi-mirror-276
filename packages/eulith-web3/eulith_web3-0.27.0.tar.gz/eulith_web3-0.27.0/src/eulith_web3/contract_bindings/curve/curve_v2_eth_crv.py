...
class CurveV2EthCrv:
    ...
    def add_liquidity(
        ...
        return c.functions.add_liquidity(
            amounts, min_mint_amount, use_eth
    ...
    def exchange_underlying(
        ...
        return c.functions.exchange_underlying(i, j, dx, min_dy).build_transaction(
            override_tx_parameters
        )
    ...
    def remove_liquidity_one_coin(
        ...
        return c.functions.remove_liquidity_one_coin(
            token_amount, i, min_amount, use_eth
        ).build_transaction(override_tx_parameters)
