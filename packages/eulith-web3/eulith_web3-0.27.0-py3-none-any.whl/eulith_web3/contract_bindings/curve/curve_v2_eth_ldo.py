...
class CurveV2EthLdo:
        ...
        self.abi = [
            ...
            },
            {
                "inputs": [
                    ...
                    {"internalType": "address", "name": "receiver", "type": "address"},
                    {"internalType": "bytes32", "name": "cb", "type": "bytes32"},
                ],
    ...
    def add_liquidity(
        ...
        return c.functions.add_liquidity(
            amounts, min_mint_amount, use_eth, receiver
    ...
    def exchange(
        ...
        return c.functions.exchange(
            i, j, dx, min_dy, use_eth, receiver
        ).build_transaction(override_tx_parameters)
    ...
    def exchange_extended(
        ...
        return c.functions.exchange_extended(
            i, j, dx, min_dy, use_eth, sender, receiver, cb
        ).build_transaction(override_tx_parameters)
    ...
    def exchange_underlying(
        ...
        return c.functions.exchange_underlying(
            i, j, dx, min_dy, receiver
        ).build_transaction(override_tx_parameters)
    ...
    def remove_liquidity(
        ...
        return c.functions.remove_liquidity(
            _amount, min_amounts, use_eth, receiver
        ).build_transaction(override_tx_parameters)
    ...
    def remove_liquidity_one_coin(
        ...
        return c.functions.remove_liquidity_one_coin(
            token_amount, i, min_amount, use_eth, receiver
        ).build_transaction(override_tx_parameters)
