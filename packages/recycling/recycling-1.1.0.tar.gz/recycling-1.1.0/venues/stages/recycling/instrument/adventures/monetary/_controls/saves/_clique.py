...
import poetry_uv.mixes.procedure as procedure
#
#
import click
import rich
...
def monetary_saves_clique ():
	...
	'''
		itinerary:
			[ ] poetry_uv_1 adventures monetary saves export --version 2
	...
	'''
		poetry_uv_1 adventures monetary saves import --version 2 --drop
	'''
