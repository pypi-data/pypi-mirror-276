...
'''
	python3 /poetry_uv/venues/stages/poetry_uv/__status/API/status.proc.py adventures/sanique/_status/API_status_besties__food_USDA__nature_v2__FDC_ID_1.py
'''
...
#
#
from poetry_uv.adventures.sanique.utilities.retrieve_sanique_URL import retrieve_sanique_URL
