...
class ApiKeysClient:
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[ApiKeyResponse]:
        """
        List user api keys.
        ...
        _response = self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api_keys"),
            params=encode_query(
                jsonable_encoder(
        ...
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(typing.List[ApiKeyResponse], _response.json())  # type: ignore
    ...
    def delete(self, api_key_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            url=urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"api_keys/{jsonable_encoder(api_key_id)}"
            ),
            params=encode_query(
                jsonable_encoder(
                    request_options.get("additional_query_parameters") if request_options is not None else None
...
class AsyncApiKeysClient:
    ...
    async def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[ApiKeyResponse]:
        """
        List user api keys.
