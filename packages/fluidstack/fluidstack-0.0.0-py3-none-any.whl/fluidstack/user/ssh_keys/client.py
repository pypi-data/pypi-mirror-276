...
class SshKeysClient:
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[SshKeyResponse]:
        ...
        client.user.ssh_keys.list()
        """
        _response = self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "list_user_ssh_keys"),
            params=encode_query(
                jsonable_encoder(
    ...
    def delete(self, ssh_key_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            url=urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"list_user_ssh_keys/{jsonable_encoder(ssh_key_id)}"
            ),
            params=encode_query(
                jsonable_encoder(
                    request_options.get("additional_query_parameters") if request_options is not None else None
...
class AsyncSshKeysClient:
    ...
    async def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[SshKeyResponse]:
        ...
        await client.user.ssh_keys.list()
        """
    ...
    async def create(
        ...
        await client.user.ssh_keys.create(
            name="name",
            public_key="public_key",
        )
        """
    ...
    async def delete(self, ssh_key_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        await client.user.ssh_keys.delete(
            ssh_key_id="ssh_key_id",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
