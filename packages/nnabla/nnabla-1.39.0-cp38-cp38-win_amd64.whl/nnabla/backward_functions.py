...
from .backward_function.trilu import trilu_backward
...
from .backward_function.unique import unique_backward
from .backward_function.eye_like import eye_like_backward
from .backward_function.mod2 import mod2_backward
from .backward_function.bit_shift import bit_shift_backward
from .backward_function.einsum import einsum_backward
...
registry.update(dict(
    ...
    Unique=unique_backward,
    EyeLike=eye_like_backward,
    Mod2=mod2_backward,
    BitShift=bit_shift_backward,
    Einsum=einsum_backward,
))
