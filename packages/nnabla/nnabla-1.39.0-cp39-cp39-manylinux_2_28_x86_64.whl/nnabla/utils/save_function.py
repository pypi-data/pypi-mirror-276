...
def _create_function_nntxt(f, name, function):
    ...
    if f.type == 'Affine':
        ...
        f.trilu_param.k = function['args']['k']
        f.trilu_param.upper = bool(function['args']['upper'])
        pass
        ...
        f.unique_param.flatten = bool(function['args']['flatten'])
        f.unique_param.axis = function['args']['axis']
        f.unique_param.sorted = bool(function['args']['sorted'])
        f.unique_param.with_index = bool(function['args']['with_index'])
        f.unique_param.with_inverse = bool(function['args']['with_inverse'])
        f.unique_param.with_counts = bool(function['args']['with_counts'])
        pass
    elif f.type == 'EyeLike':
        f.eye_like_param.k = function['args']['k']
        pass
    elif f.type == 'Mod2':
        f.mod2_param.fmod = bool(function['args']['fmod'])
        pass
    elif f.type == 'BitShift':
        f.bit_shift_param.direction = function['args']['direction']
        pass
    elif f.type == 'Einsum':
        f.einsum_param.equation = function['args']['equation']
        pass
