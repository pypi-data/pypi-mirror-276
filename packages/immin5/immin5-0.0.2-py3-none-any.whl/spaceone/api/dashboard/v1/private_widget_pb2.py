...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.dashboard.v1.private_widget_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z>github.com/cloudforet-io/api/dist/go/spaceone/api/dashboard/v1'
  _PRIVATEWIDGET.methods_by_name['create']._options = None
  _PRIVATEWIDGET.methods_by_name['create']._serialized_options = b'\202\323\344\223\002%\" /widget/v1/private-widget/create:\001*'
  _PRIVATEWIDGET.methods_by_name['update']._options = None
  _PRIVATEWIDGET.methods_by_name['update']._serialized_options = b'\202\323\344\223\002%\" /widget/v1/private-widget/update:\001*'
  _PRIVATEWIDGET.methods_by_name['delete']._options = None
  _PRIVATEWIDGET.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002%\" /widget/v1/private-widget/delete:\001*'
  _PRIVATEWIDGET.methods_by_name['load']._options = None
  _PRIVATEWIDGET.methods_by_name['load']._serialized_options = b'\202\323\344\223\002#\"\036/widget/v1/private-widget/load:\001*'
  _PRIVATEWIDGET.methods_by_name['get']._options = None
  _PRIVATEWIDGET.methods_by_name['get']._serialized_options = b'\202\323\344\223\002\"\"\035/widget/v1/private-widget/get:\001*'
  _PRIVATEWIDGET.methods_by_name['list']._options = None
  _PRIVATEWIDGET.methods_by_name['list']._serialized_options = b'\202\323\344\223\002#\"\036/widget/v1/private-widget/list:\001*'
  _CREATEPRIVATEWIDGETREQUEST._serialized_start=198
  _CREATEPRIVATEWIDGETREQUEST._serialized_end=393
  _UPDATEPRIVATEWIDGETREQUEST._serialized_start=396
  _UPDATEPRIVATEWIDGETREQUEST._serialized_end=580
  _PRIVATEWIDGETREQUEST._serialized_start=582
  _PRIVATEWIDGETREQUEST._serialized_end=623
  _LOADPRIVATEWIDGETREQUEST._serialized_start=626
  _LOADPRIVATEWIDGETREQUEST._serialized_end=794
  _PRIVATEWIDGETQUERY._serialized_start=796
  _PRIVATEWIDGETQUERY._serialized_end=923
  _PRIVATEWIDGETINFO._serialized_start=926
  _PRIVATEWIDGETINFO._serialized_end=1229
  _PRIVATEWIDGETSINFO._serialized_start=1231
  _PRIVATEWIDGETSINFO._serialized_end=1332
  _PRIVATEWIDGET._serialized_start=1335
  _PRIVATEWIDGET._serialized_end=2201
