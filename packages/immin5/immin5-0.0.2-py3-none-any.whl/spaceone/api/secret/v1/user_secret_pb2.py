...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.secret.v1.user_secret_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z@github.com/cloudforet-io/api/dist/go/spaceone/api/user_secret/v1'
  _USERSECRET.methods_by_name['create']._options = None
  _USERSECRET.methods_by_name['create']._serialized_options = b'\202\323\344\223\002\"\"\035/secret/v1/user-secret/create:\001*'
  _USERSECRET.methods_by_name['update']._options = None
  _USERSECRET.methods_by_name['update']._serialized_options = b'\202\323\344\223\002\"\"\035/secret/v1/user-secret/update:\001*'
  _USERSECRET.methods_by_name['delete']._options = None
  _USERSECRET.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002\"\"\035/secret/v1/user-secret/delete:\001*'
  _USERSECRET.methods_by_name['update_data']._options = None
  _USERSECRET.methods_by_name['update_data']._serialized_options = b'\202\323\344\223\002\'\"\"/secret/v1/user-secret/update-data:\001*'
  _USERSECRET.methods_by_name['get']._options = None
  _USERSECRET.methods_by_name['get']._serialized_options = b'\202\323\344\223\002\037\"\032/secret/v1/user-secret/get:\001*'
  _USERSECRET.methods_by_name['list']._options = None
  _USERSECRET.methods_by_name['list']._serialized_options = b'\202\323\344\223\002 \"\033/secret/v1/user-secret/list:\001*'
  _USERSECRET.methods_by_name['stat']._options = None
  _USERSECRET.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002 \"\033/secret/v1/user-secret/stat:\001*'
  _CREATEUSERSECRETREQUEST._serialized_start=197
  _CREATEUSERSECRETREQUEST._serialized_end=333
  _UPDATEUSERSECRETREQUEST._serialized_start=335
  _UPDATEUSERSECRETREQUEST._serialized_end=437
  _USERSECRETREQUEST._serialized_start=439
  _USERSECRETREQUEST._serialized_end=482
  _GETUSERSECRETDATAREQUEST._serialized_start=484
  _GETUSERSECRETDATAREQUEST._serialized_end=553
  _UPDATEUSERSECRETDATAREQUEST._serialized_start=555
  _UPDATEUSERSECRETDATAREQUEST._serialized_end=666
  _USERSECRETQUERY._serialized_start=669
  _USERSECRETQUERY._serialized_end=805
  _USERSECRETDATAINFO._serialized_start=808
  _USERSECRETDATAINFO._serialized_end=936
  _USERSECRETINFO._serialized_start=939
  _USERSECRETINFO._serialized_end=1207
  _USERSECRETINFO_RESOURCEGROUP._serialized_start=1127
  _USERSECRETINFO_RESOURCEGROUP._serialized_end=1207
  _USERSECRETSINFO._serialized_start=1209
  _USERSECRETSINFO._serialized_end=1309
  _USERSECRETSTATQUERY._serialized_start=1311
  _USERSECRETSTATQUERY._serialized_end=1405
  _USERSECRET._serialized_start=1408
  _USERSECRET._serialized_end=2515
