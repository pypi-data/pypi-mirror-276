...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.search.v1.resource_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z;github.com/cloudforet-io/api/dist/go/spaceone/api/search/v1'
  _RESOURCE.methods_by_name['search']._options = None
  _RESOURCE.methods_by_name['search']._serialized_options = b'\202\323\344\223\002\037\"\032/search/v1/resource/search:\001*'
  _SEARCHRESOURCEREQUEST._serialized_start=189
  _SEARCHRESOURCEREQUEST._serialized_end=331
  _RESOURCEINFO._serialized_start=334
  _RESOURCEINFO._serialized_end=504
  _RESOURCESINFO._serialized_start=506
  _RESOURCESINFO._serialized_end=596
  _RESOURCE._serialized_start=599
  _RESOURCE._serialized_end=745
