...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.cost_analysis.v1.cost_report_data_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'ZBgithub.com/cloudforet-io/api/dist/go/spaceone/api/cost_analysis/v1'
  _COSTREPORTDATA.methods_by_name['list']._options = None
  _COSTREPORTDATA.methods_by_name['list']._serialized_options = b'\202\323\344\223\002,\"\'/cost-analysis/v1/cost-report-data/list:\001*'
  _COSTREPORTDATA.methods_by_name['analyze']._options = None
  _COSTREPORTDATA.methods_by_name['analyze']._serialized_options = b'\202\323\344\223\002/\"*/cost-analysis/v1/cost-report-data/analyze:\001*'
  _COSTREPORTDATA.methods_by_name['stat']._options = None
  _COSTREPORTDATA.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002,\"\'/cost-analysis/v1/cost-report-data/stat:\001*'
  _COSTREPORTDATAQUERY._serialized_start=252
  _COSTREPORTDATAQUERY._serialized_end=504
  _COSTREPORTDATAANALYZEQUERY._serialized_start=507
  _COSTREPORTDATAANALYZEQUERY._serialized_end=730
  _COSTREPORTDATAINFO._serialized_start=733
  _COSTREPORTDATAINFO._serialized_end=1257
  _COSTREPORTSDATAINFO._serialized_start=1259
  _COSTREPORTSDATAINFO._serialized_end=1369
  _COSTREPORTDATASTATQUERY._serialized_start=1372
  _COSTREPORTDATASTATQUERY._serialized_end=1506
  _COSTREPORTDATA._serialized_start=1509
  _COSTREPORTDATA._serialized_end=1983
