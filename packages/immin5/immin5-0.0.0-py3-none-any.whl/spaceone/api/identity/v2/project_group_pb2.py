...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.identity.v2.project_group_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PROJECTGROUP.methods_by_name['add_users']._options = None
  _PROJECTGROUP.methods_by_name['add_users']._serialized_options = b'\202\323\344\223\002)\"$/identity/v2/project-group/add-users:\001*'
  _PROJECTGROUP.methods_by_name['remove_users']._options = None
  _PROJECTGROUP.methods_by_name['remove_users']._serialized_options = b'\202\323\344\223\002,\"\'/identity/v2/project-group/remove-users:\001*'
  ...
  _CREATEPROJECTGROUPREQUEST._serialized_start=197
  _CREATEPROJECTGROUPREQUEST._serialized_end=302
  _UPDATEPROJECTGROUPREQUEST._serialized_start=304
  _UPDATEPROJECTGROUPREQUEST._serialized_end=410
  _CHANGEPARENTGROUPREQUEST._serialized_start=412
  _CHANGEPARENTGROUPREQUEST._serialized_end=489
  _PROJECTGROUPREQUEST._serialized_start=491
  _PROJECTGROUPREQUEST._serialized_end=538
  _USERSPROJECTGROUPREQUEST._serialized_start=540
  _USERSPROJECTGROUPREQUEST._serialized_end=607
  _PROJECTGROUPINFO._serialized_start=610
  _PROJECTGROUPINFO._serialized_end=902
  _PROJECTGROUPSEARCHQUERY._serialized_start=905
  _PROJECTGROUPSEARCHQUERY._serialized_end=1061
  _PROJECTGROUPSINFO._serialized_start=1063
  _PROJECTGROUPSINFO._serialized_end=1164
  _PROJECTGROUPSTATQUERY._serialized_start=1166
  _PROJECTGROUPSTATQUERY._serialized_end=1243
  _PROJECTGROUP._serialized_start=1246
  _PROJECTGROUP._serialized_end=2615
