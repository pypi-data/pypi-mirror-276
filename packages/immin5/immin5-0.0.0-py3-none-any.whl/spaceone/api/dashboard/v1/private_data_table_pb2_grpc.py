...
class PrivateDataTable(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.data_table.v1.PrivateDataTable/create',
    ...
    def update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.data_table.v1.PrivateDataTable/update',
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.data_table.v1.PrivateDataTable/delete',
    ...
    def load(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.data_table.v1.PrivateDataTable/load',
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.data_table.v1.PrivateDataTable/get',
            spaceone_dot_api_dot_dashboard_dot_v1_dot_private__data__table__pb2.PrivateDataTableRequest.SerializeToString,
            spaceone_dot_api_dot_dashboard_dot_v1_dot_private__data__table__pb2.PrivateDataTableInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.data_table.v1.PrivateDataTable/list',
