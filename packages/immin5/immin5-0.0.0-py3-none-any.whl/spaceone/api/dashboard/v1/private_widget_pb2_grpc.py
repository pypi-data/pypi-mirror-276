...
class PrivateWidget(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.widget.v1.PrivateWidget/create',
    ...
    def update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.widget.v1.PrivateWidget/update',
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.widget.v1.PrivateWidget/delete',
    ...
    def load(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.widget.v1.PrivateWidget/load',
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.widget.v1.PrivateWidget/get',
            spaceone_dot_api_dot_dashboard_dot_v1_dot_private__widget__pb2.PrivateWidgetRequest.SerializeToString,
            spaceone_dot_api_dot_dashboard_dot_v1_dot_private__widget__pb2.PrivateWidgetInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.widget.v1.PrivateWidget/list',
