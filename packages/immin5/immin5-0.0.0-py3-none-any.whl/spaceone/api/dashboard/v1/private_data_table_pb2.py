...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.dashboard.v1.private_data_table_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z>github.com/cloudforet-io/api/dist/go/spaceone/api/dashboard/v1'
  _PRIVATEDATATABLE.methods_by_name['create']._options = None
  _PRIVATEDATATABLE.methods_by_name['create']._serialized_options = b'\202\323\344\223\002-\"(/data_table/v1/private-data-table/create:\001*'
  _PRIVATEDATATABLE.methods_by_name['update']._options = None
  _PRIVATEDATATABLE.methods_by_name['update']._serialized_options = b'\202\323\344\223\002-\"(/data_table/v1/private-data-table/update:\001*'
  _PRIVATEDATATABLE.methods_by_name['delete']._options = None
  _PRIVATEDATATABLE.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002-\"(/data_table/v1/private-data-table/delete:\001*'
  _PRIVATEDATATABLE.methods_by_name['load']._options = None
  _PRIVATEDATATABLE.methods_by_name['load']._serialized_options = b'\202\323\344\223\002+\"&/data_table/v1/private-data-table/load:\001*'
  _PRIVATEDATATABLE.methods_by_name['get']._options = None
  _PRIVATEDATATABLE.methods_by_name['get']._serialized_options = b'\202\323\344\223\002*\"%/data_table/v1/private-data-table/get:\001*'
  _PRIVATEDATATABLE.methods_by_name['list']._options = None
  _PRIVATEDATATABLE.methods_by_name['list']._serialized_options = b'\202\323\344\223\002+\"&/data_table/v1/private-data-table/list:\001*'
  _CREATEPRIVATEDATATABLEREQUEST._serialized_start=206
  _CREATEPRIVATEDATATABLEREQUEST._serialized_end=511
  _CREATEPRIVATEDATATABLEREQUEST_SOURCETYPE._serialized_start=444
  _CREATEPRIVATEDATATABLEREQUEST_SOURCETYPE._serialized_end=511
  _UPDATEPRIVATEDATATABLEREQUEST._serialized_start=514
  _UPDATEPRIVATEDATATABLEREQUEST._serialized_end=663
  _PRIVATEDATATABLEREQUEST._serialized_start=665
  _PRIVATEDATATABLEREQUEST._serialized_end=713
  _LOADPRIVATEDATATABLEREQUEST._serialized_start=716
  _LOADPRIVATEDATATABLEREQUEST._serialized_end=852
  _PRIVATEDATATABLEQUERY._serialized_start=855
  _PRIVATEDATATABLEQUERY._serialized_end=1130
  _PRIVATEDATATABLEQUERY_SOURCETYPE._serialized_start=444
  _PRIVATEDATATABLEQUERY_SOURCETYPE._serialized_end=511
  _PRIVATEDATATABLEINFO._serialized_start=1133
  _PRIVATEDATATABLEINFO._serialized_end=1617
  _PRIVATEDATATABLEINFO_SOURCETYPE._serialized_start=444
  _PRIVATEDATATABLEINFO_SOURCETYPE._serialized_end=511
  _PRIVATEDATATABLESINFO._serialized_start=1619
  _PRIVATEDATATABLESINFO._serialized_end=1730
  _PRIVATEDATATABLE._serialized_start=1733
  _PRIVATEDATATABLE._serialized_end=2728
