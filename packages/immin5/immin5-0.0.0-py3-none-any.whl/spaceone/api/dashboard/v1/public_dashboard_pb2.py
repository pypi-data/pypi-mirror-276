...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.dashboard.v1.public_dashboard_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PUBLICDASHBOARD.methods_by_name['create']._serialized_options = b'\202\323\344\223\002*\"%/dashboard/v1/public-dashboard/create:\001*'
  _PUBLICDASHBOARD.methods_by_name['update']._options = None
  _PUBLICDASHBOARD.methods_by_name['update']._serialized_options = b'\202\323\344\223\002*\"%/dashboard/v1/public-dashboard/update:\001*'
  _PUBLICDASHBOARD.methods_by_name['delete']._options = None
  _PUBLICDASHBOARD.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002*\"%/dashboard/v1/public-dashboard/delete:\001*'
  _PUBLICDASHBOARD.methods_by_name['get']._options = None
  _PUBLICDASHBOARD.methods_by_name['get']._serialized_options = b'\202\323\344\223\002\'\"\"/dashboard/v1/public-dashboard/get:\001*'
  _PUBLICDASHBOARD.methods_by_name['list']._options = None
  _PUBLICDASHBOARD.methods_by_name['list']._serialized_options = b'\202\323\344\223\002(\"#/dashboard/v1/public-dashboard/list:\001*'
  _PUBLICDASHBOARD.methods_by_name['stat']._options = None
  _PUBLICDASHBOARD.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002(\"#/dashboard/v1/public-dashboard/stat:\001*'
  _CREATEPUBLICDASHBOARDREQUEST._serialized_start=203
  _CREATEPUBLICDASHBOARDREQUEST._serialized_end=771
  _CREATEPUBLICDASHBOARDREQUEST_RESOURCEGROUP._serialized_start=691
  _CREATEPUBLICDASHBOARDREQUEST_RESOURCEGROUP._serialized_end=771
  _UPDATEPUBLICDASHBOARDREQUEST._serialized_start=774
  _UPDATEPUBLICDASHBOARDREQUEST._serialized_end=1152
  _PUBLICDASHBOARDREQUEST._serialized_start=1154
  _PUBLICDASHBOARDREQUEST._serialized_end=1207
  _PUBLICDASHBOARDQUERY._serialized_start=1210
  _PUBLICDASHBOARDQUERY._serialized_end=1361
  _PUBLICDASHBOARDINFO._serialized_start=1364
  _PUBLICDASHBOARDINFO._serialized_end=2019
  _PUBLICDASHBOARDINFO_RESOURCEGROUP._serialized_start=691
  _PUBLICDASHBOARDINFO_RESOURCEGROUP._serialized_end=771
  _PUBLICDASHBOARDSINFO._serialized_start=2021
  _PUBLICDASHBOARDSINFO._serialized_end=2129
  _PUBLICDASHBOARDSTATQUERY._serialized_start=2131
  _PUBLICDASHBOARDSTATQUERY._serialized_end=2211
  _PUBLICDASHBOARD._serialized_start=2214
  _PUBLICDASHBOARD._serialized_end=3143
