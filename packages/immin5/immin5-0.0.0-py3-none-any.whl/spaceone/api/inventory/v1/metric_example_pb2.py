...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.inventory.v1.metric_example_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1'
  _METRICEXAMPLE.methods_by_name['create']._options = None
  _METRICEXAMPLE.methods_by_name['create']._serialized_options = b'\202\323\344\223\002(\"#/inventory/v1/metric-example/create:\001*'
  _METRICEXAMPLE.methods_by_name['update']._options = None
  _METRICEXAMPLE.methods_by_name['update']._serialized_options = b'\202\323\344\223\002(\"#/inventory/v1/metric-example/update:\001*'
  _METRICEXAMPLE.methods_by_name['delete']._options = None
  _METRICEXAMPLE.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002(\"#/inventory/v1/metric-example/delete:\001*'
  _METRICEXAMPLE.methods_by_name['get']._options = None
  _METRICEXAMPLE.methods_by_name['get']._serialized_options = b'\202\323\344\223\002%\" /inventory/v1/metric-example/get:\001*'
  _METRICEXAMPLE.methods_by_name['list']._options = None
  _METRICEXAMPLE.methods_by_name['list']._serialized_options = b'\202\323\344\223\002&\"!/inventory/v1/metric-example/list:\001*'
  _METRICEXAMPLE.methods_by_name['stat']._options = None
  _METRICEXAMPLE.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002&\"!/inventory/v1/metric-example/stat:\001*'
  _CREATEMETRICEXAMPLEREQUEST._serialized_start=201
  _CREATEMETRICEXAMPLEREQUEST._serialized_end=343
  _UPDATEMETRICEXAMPLEREQUEST._serialized_start=346
  _UPDATEMETRICEXAMPLEREQUEST._serialized_end=489
  _METRICEXAMPLEREQUEST._serialized_start=491
  _METRICEXAMPLEREQUEST._serialized_end=533
  _METRICEXAMPLEQUERY._serialized_start=536
  _METRICEXAMPLEQUERY._serialized_end=675
  _METRICEXAMPLEINFO._serialized_start=678
  _METRICEXAMPLEINFO._serialized_end=951
  _METRICEXAMPLESINFO._serialized_start=953
  _METRICEXAMPLESINFO._serialized_end=1057
  _METRICEXAMPLESTATQUERY._serialized_start=1059
  _METRICEXAMPLESTATQUERY._serialized_end=1137
  _METRICEXAMPLE._serialized_start=1140
  _METRICEXAMPLE._serialized_end=2035
