...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.inventory.v1.metric_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1'
  _METRIC.methods_by_name['create']._options = None
  _METRIC.methods_by_name['create']._serialized_options = b'\202\323\344\223\002 \"\033/inventory/v1/metric/create:\001*'
  _METRIC.methods_by_name['update']._options = None
  _METRIC.methods_by_name['update']._serialized_options = b'\202\323\344\223\002 \"\033/inventory/v1/metric/update:\001*'
  _METRIC.methods_by_name['delete']._options = None
  _METRIC.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002 \"\033/inventory/v1/metric/delete:\001*'
  _METRIC.methods_by_name['run']._options = None
  _METRIC.methods_by_name['run']._serialized_options = b'\202\323\344\223\002\035\"\030/inventory/v1/metric/run:\001*'
  _METRIC.methods_by_name['test']._options = None
  _METRIC.methods_by_name['test']._serialized_options = b'\202\323\344\223\002\036\"\031/inventory/v1/metric/test:\001*'
  _METRIC.methods_by_name['get']._options = None
  _METRIC.methods_by_name['get']._serialized_options = b'\202\323\344\223\002\035\"\030/inventory/v1/metric/get:\001*'
  _METRIC.methods_by_name['list']._options = None
  _METRIC.methods_by_name['list']._serialized_options = b'\202\323\344\223\002\036\"\031/inventory/v1/metric/list:\001*'
  _METRIC.methods_by_name['stat']._options = None
  _METRIC.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002\036\"\031/inventory/v1/metric/stat:\001*'
  _METRICTYPE._serialized_start=1611
  _METRICTYPE._serialized_end=1669
  _CREATEMETRICREQUEST._serialized_start=193
  _CREATEMETRICREQUEST._serialized_end=484
  _UPDATEMETRICREQUEST._serialized_start=487
  _UPDATEMETRICREQUEST._serialized_end=673
  _METRICREQUEST._serialized_start=675
  _METRICREQUEST._serialized_end=709
  _METRICTESTREQUEST._serialized_start=711
  _METRICTESTREQUEST._serialized_end=808
  _METRICQUERY._serialized_start=811
  _METRICQUERY._serialized_end=1034
  _METRICINFO._serialized_start=1037
  _METRICINFO._serialized_end=1444
  _METRICSINFO._serialized_start=1446
  _METRICSINFO._serialized_end=1536
  _METRICSTATQUERY._serialized_start=1538
  _METRICSTATQUERY._serialized_end=1609
  _METRIC._serialized_start=1672
  _METRIC._serialized_end=2665
