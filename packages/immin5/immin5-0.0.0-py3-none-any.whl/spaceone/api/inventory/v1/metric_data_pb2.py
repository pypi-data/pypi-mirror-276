...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.inventory.v1.metric_data_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z>github.com/cloudforet-io/api/dist/go/spaceone/api/inventory/v1'
  _METRICDATA.methods_by_name['list']._options = None
  _METRICDATA.methods_by_name['list']._serialized_options = b'\202\323\344\223\002#\"\036/inventory/v1/metric-data/list:\001*'
  _METRICDATA.methods_by_name['stat']._options = None
  _METRICDATA.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002#\"\036/inventory/v1/metric-data/stat:\001*'
  _METRICDATA.methods_by_name['analyze']._options = None
  _METRICDATA.methods_by_name['analyze']._serialized_options = b'\202\323\344\223\002&\"!/inventory/v1/metric-data/analyze:\001*'
  _METRICDATAQUERY._serialized_start=237
  _METRICDATAQUERY._serialized_end=359
  _METRICDATAINFO._serialized_start=362
  _METRICDATAINFO._serialized_end=645
  _METRICDATASINFO._serialized_start=647
  _METRICDATASINFO._serialized_end=745
  _METRICDATAANALYZEQUERY._serialized_start=747
  _METRICDATAANALYZEQUERY._serialized_end=851
  _METRICDATASTATQUERY._serialized_start=853
  _METRICDATASTATQUERY._serialized_end=947
  _METRICDATA._serialized_start=950
  _METRICDATA._serialized_end=1360
