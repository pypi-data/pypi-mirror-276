...
class WorkspaceConfig(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/create',
    ...
    def update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/update',
            spaceone_dot_api_dot_config_dot_v1_dot_workspace__config__pb2.CreateWorkspaceConfigRequest.SerializeToString,
            spaceone_dot_api_dot_config_dot_v1_dot_workspace__config__pb2.WorkspaceConfigInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def set(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/set',
            spaceone_dot_api_dot_config_dot_v1_dot_workspace__config__pb2.CreateWorkspaceConfigRequest.SerializeToString,
            spaceone_dot_api_dot_config_dot_v1_dot_workspace__config__pb2.WorkspaceConfigInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/delete',
    ...
    def get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/get',
            spaceone_dot_api_dot_config_dot_v1_dot_workspace__config__pb2.WorkspaceConfigRequest.SerializeToString,
            spaceone_dot_api_dot_config_dot_v1_dot_workspace__config__pb2.WorkspaceConfigInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def list(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/list',
    ...
    def stat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.config.v1.WorkspaceConfig/stat',
