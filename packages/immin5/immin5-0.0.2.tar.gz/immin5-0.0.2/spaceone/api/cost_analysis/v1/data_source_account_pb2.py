...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.cost_analysis.v1.data_source_account_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'ZBgithub.com/cloudforet-io/api/dist/go/spaceone/api/cost_analysis/v1'
  _DATASOURCEACCOUNT.methods_by_name['update']._options = None
  _DATASOURCEACCOUNT.methods_by_name['update']._serialized_options = b'\202\323\344\223\0021\",/cost-analysis/v1/data-source-account/update:\001*'
  _DATASOURCEACCOUNT.methods_by_name['reset']._options = None
  _DATASOURCEACCOUNT.methods_by_name['reset']._serialized_options = b'\202\323\344\223\0020\"+/cost-analysis/v1/data-source-account/reset:\001*'
  _DATASOURCEACCOUNT.methods_by_name['get']._options = None
  _DATASOURCEACCOUNT.methods_by_name['get']._serialized_options = b'\202\323\344\223\002.\")/cost-analysis/v1/data-source-account/get:\001*'
  _DATASOURCEACCOUNT.methods_by_name['list']._options = None
  _DATASOURCEACCOUNT.methods_by_name['list']._serialized_options = b'\202\323\344\223\002/\"*/cost-analysis/v1/data-source-account/list:\001*'
  _DATASOURCEACCOUNT.methods_by_name['analyze']._options = None
  _DATASOURCEACCOUNT.methods_by_name['analyze']._serialized_options = b'\202\323\344\223\0022\"-/cost-analysis/v1/data-source-account/analyze:\001*'
  _DATASOURCEACCOUNT.methods_by_name['stat']._options = None
  _DATASOURCEACCOUNT.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002/\"*/cost-analysis/v1/data-source-account/stat:\001*'
  _UPDATEDATASOURCEACCOUNTREQUEST._serialized_start=214
  _UPDATEDATASOURCEACCOUNTREQUEST._serialized_end=360
  _RESETDATASOURCEACCOUNTREQUEST._serialized_start=362
  _RESETDATASOURCEACCOUNTREQUEST._serialized_end=437
  _DATASOURCEACCOUNTREQUEST._serialized_start=439
  _DATASOURCEACCOUNTREQUEST._serialized_end=517
  _DATASOURCEACCOUNTQUERY._serialized_start=520
  _DATASOURCEACCOUNTQUERY._serialized_end=702
  _DATASOURCEACCOUNTINFO._serialized_start=705
  _DATASOURCEACCOUNTINFO._serialized_end=951
  _DATASOURCEACCOUNTSINFO._serialized_start=953
  _DATASOURCEACCOUNTSINFO._serialized_end=1069
  _DATASOURCEACCOUNTANALYZEQUERY._serialized_start=1072
  _DATASOURCEACCOUNTANALYZEQUERY._serialized_end=1230
  _DATASOURCEACCOUNTSTATQUERY._serialized_start=1232
  _DATASOURCEACCOUNTSTATQUERY._serialized_end=1314
  _DATASOURCEACCOUNT._serialized_start=1317
  _DATASOURCEACCOUNT._serialized_end=2325
