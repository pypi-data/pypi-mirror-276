...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.identity.v2.user_profile_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z=github.com/cloudforet-io/api/dist/go/spaceone/api/identity/v2'
  _USERPROFILE.methods_by_name['update']._options = None
  _USERPROFILE.methods_by_name['update']._serialized_options = b'\202\323\344\223\002%\" /identity/v2/user-profile/update:\001*'
  _USERPROFILE.methods_by_name['verify_email']._options = None
  _USERPROFILE.methods_by_name['verify_email']._serialized_options = b'\202\323\344\223\002+\"&/identity/v2/user-profile/verify-email:\001*'
  _USERPROFILE.methods_by_name['confirm_email']._options = None
  _USERPROFILE.methods_by_name['confirm_email']._serialized_options = b'\202\323\344\223\002,\"\'/identity/v2/user-profile/confirm-email:\001*'
  _USERPROFILE.methods_by_name['reset_password']._options = None
  _USERPROFILE.methods_by_name['reset_password']._serialized_options = b'\202\323\344\223\002-\"(/identity/v2/user-profile/reset-password:\001*'
  _USERPROFILE.methods_by_name['enable_mfa']._options = None
  _USERPROFILE.methods_by_name['enable_mfa']._serialized_options = b'\202\323\344\223\002)\"$/identity/v2/user-profile/enable-mfa:\001*'
  _USERPROFILE.methods_by_name['disable_mfa']._options = None
  _USERPROFILE.methods_by_name['disable_mfa']._serialized_options = b'\202\323\344\223\002*\"%/identity/v2/user-profile/disable-mfa:\001*'
  _USERPROFILE.methods_by_name['confirm_mfa']._options = None
  _USERPROFILE.methods_by_name['confirm_mfa']._serialized_options = b'\202\323\344\223\002*\"%/identity/v2/user-profile/confirm-mfa:\001*'
  _USERPROFILE.methods_by_name['get']._options = None
  _USERPROFILE.methods_by_name['get']._serialized_options = b'\202\323\344\223\002\"\"\035/identity/v2/user-profile/get:\001*'
  _USERPROFILE.methods_by_name['get_workspaces']._options = None
  _USERPROFILE.methods_by_name['get_workspaces']._serialized_options = b'\202\323\344\223\002-\"(/identity/v2/user-profile/get-workspaces:\001*'
  _UPDATEUSERPROFILEREQUEST._serialized_start=276
  _UPDATEUSERPROFILEREQUEST._serialized_end=424
  _VERIFYEMAILREQUEST._serialized_start=426
  _VERIFYEMAILREQUEST._serialized_end=461
  _CONFIRMEMAILREQUEST._serialized_start=463
  _CONFIRMEMAILREQUEST._serialized_end=505
  _ENABLEMFAREQUEST._serialized_start=507
  _ENABLEMFAREQUEST._serialized_end=585
  _DISABLEMFAREQUEST._serialized_start=587
  _DISABLEMFAREQUEST._serialized_end=606
  _CONFIRMMFAREQUEST._serialized_start=608
  _CONFIRMMFAREQUEST._serialized_end=648
  _USERPROFILEREQUEST._serialized_start=650
  _USERPROFILEREQUEST._serialized_end=670
  _USERPASSWORDRESETREQUEST._serialized_start=672
  _USERPASSWORDRESETREQUEST._serialized_end=734
  _MYWORKSPACEINFO._serialized_start=737
  _MYWORKSPACEINFO._serialized_end=1264
  _MYWORKSPACEINFO_STATE._serialized_start=1127
  _MYWORKSPACEINFO_STATE._serialized_end=1171
  _MYWORKSPACEINFO_ROLETYPE._serialized_start=1173
  _MYWORKSPACEINFO_ROLETYPE._serialized_end=1264
  _MYWORKSPACESINFO._serialized_start=1266
  _MYWORKSPACESINFO._serialized_end=1365
  _USERPROFILE._serialized_start=1368
  _USERPROFILE._serialized_end=2696
