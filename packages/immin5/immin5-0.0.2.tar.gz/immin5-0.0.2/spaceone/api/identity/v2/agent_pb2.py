...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.identity.v2.agent_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z=github.com/cloudforet-io/api/dist/go/spaceone/api/identity/v2'
  _AGENT.methods_by_name['create']._options = None
  _AGENT.methods_by_name['create']._serialized_options = b'\202\323\344\223\002\036\"\031/identity/v2/agent/create:\001*'
  _AGENT.methods_by_name['enable']._options = None
  _AGENT.methods_by_name['enable']._serialized_options = b'\202\323\344\223\002\036\"\031/identity/v2/agent/enable:\001*'
  _AGENT.methods_by_name['disable']._options = None
  _AGENT.methods_by_name['disable']._serialized_options = b'\202\323\344\223\002\037\"\032/identity/v2/agent/disable:\001*'
  _AGENT.methods_by_name['regenerate']._options = None
  _AGENT.methods_by_name['regenerate']._serialized_options = b'\202\323\344\223\002\"\"\035/identity/v2/agent/regenerate:\001*'
  _AGENT.methods_by_name['delete']._options = None
  _AGENT.methods_by_name['delete']._serialized_options = b'\202\323\344\223\002\036\"\031/identity/v2/agent/delete:\001*'
  _AGENT.methods_by_name['get']._options = None
  _AGENT.methods_by_name['get']._serialized_options = b'\202\323\344\223\002\033\"\026/identity/v2/agent/get:\001*'
  _AGENT.methods_by_name['list']._options = None
  _AGENT.methods_by_name['list']._serialized_options = b'\202\323\344\223\002\034\"\027/identity/v2/agent/list:\001*'
  _CREATEAGENTREQUEST._serialized_start=225
  _CREATEAGENTREQUEST._serialized_end=315
  _AGENTREQUEST._serialized_start=317
  _AGENTREQUEST._serialized_end=359
  _AGENTINFO._serialized_start=362
  _AGENTINFO._serialized_end=1002
  _AGENTINFO_STATE._serialized_start=808
  _AGENTINFO_STATE._serialized_end=871
  _AGENTINFO_ROLETYPE._serialized_start=873
  _AGENTINFO_ROLETYPE._serialized_end=942
  _AGENTINFO_RESOURCEGROUP._serialized_start=944
  _AGENTINFO_RESOURCEGROUP._serialized_end=1002
  _AGENTSEARCHQUERY._serialized_start=1005
  _AGENTSEARCHQUERY._serialized_end=1243
  _AGENTSEARCHQUERY_STATE._serialized_start=808
  _AGENTSEARCHQUERY_STATE._serialized_end=871
  _AGENTSINFO._serialized_start=1245
  _AGENTSINFO._serialized_end=1332
  _AGENT._serialized_start=1335
  _AGENT._serialized_end=2217
