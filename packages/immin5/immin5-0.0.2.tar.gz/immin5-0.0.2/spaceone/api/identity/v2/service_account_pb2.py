...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'spaceone.api.identity.v2.service_account_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SERVICEACCOUNT.methods_by_name['update_secret_data']._options = None
  _SERVICEACCOUNT.methods_by_name['update_secret_data']._serialized_options = b'\202\323\344\223\0024\"//identity/v2/service-account/update-secret-data:\001*'
  _SERVICEACCOUNT.methods_by_name['delete_secret_data']._options = None
  _SERVICEACCOUNT.methods_by_name['delete_secret_data']._serialized_options = b'\202\323\344\223\0024\"//identity/v2/service-account/delete-secret-data:\001*'
  ...
  _CREATESERVICEACCOUNTREQUEST._serialized_start=236
  _CREATESERVICEACCOUNTREQUEST._serialized_end=495
  _UPDATESERVICEACCOUNTREQUEST._serialized_start=498
  _UPDATESERVICEACCOUNTREQUEST._serialized_end=667
  _UPDATESERVICEACCOUNTSECRETREQUEST._serialized_start=670
  _UPDATESERVICEACCOUNTSECRETREQUEST._serialized_end=833
  _SERVICEACCOUNTREQUEST._serialized_start=835
  _SERVICEACCOUNTREQUEST._serialized_end=886
  _SERVICEACCOUNTINFO._serialized_start=889
  _SERVICEACCOUNTINFO._serialized_end=1267
  _SERVICEACCOUNTSEARCHQUERY._serialized_start=1270
  _SERVICEACCOUNTSEARCHQUERY._serialized_end=1516
  _SERVICEACCOUNTSINFO._serialized_start=1518
  _SERVICEACCOUNTSINFO._serialized_end=1623
  _SERVICEACCOUNTSTATQUERY._serialized_start=1625
  _SERVICEACCOUNTSTATQUERY._serialized_end=1704
  _SERVICEACCOUNT._serialized_start=1707
  _SERVICEACCOUNT._serialized_end=2977
