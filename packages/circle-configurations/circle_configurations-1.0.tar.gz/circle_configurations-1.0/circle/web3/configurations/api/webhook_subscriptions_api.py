...
class WebhookSubscriptionsApi(object):
    ...
    @validate_arguments
    def get_notification_signature(self, id : Annotated[StrictStr, Field(..., description="Universally unique identifier (UUID v4) of a resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Universally unique identifier (UUID v4) for the request. Helpful for identifying a request when communicating with Circle support.")] = None, **kwargs) -> GetNotificationSignature:  # noqa: E501
    ...
    @validate_arguments
    def get_notification_signature_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Universally unique identifier (UUID v4) of a resource.")], x_request_id : Annotated[Optional[StrictStr], Field(description="Universally unique identifier (UUID v4) for the request. Helpful for identifying a request when communicating with Circle support.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a notification signature public key  # noqa: E501
