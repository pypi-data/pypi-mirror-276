...
class BlockchainAddresses:
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_address_by_id("d56bcbe4-586f-4980-b6ca-6e9f557750e8")
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.add_tracking_address(
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_address_by_address("0x788529118F2A28C60b9de2Ba0353f5EE4293e044")
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.set_meta("d56bcbe4-586f-4980-b6ca-6e9f557750e8", {"key": "value"})
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_transactions("8e2d5033-139f-46d4-b769-4a2d2cee37c4")
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_payin_addresses()
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_business_addresses()
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_recurrent_addresses()
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.get_payout_balances()
    """
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.create_business_address(
            "USDT",
            "ethereum",
            "My address alias",
    ...
    :example:
    >>> blablabla_api.blockchain_addresses.create_recurrent_address("USDT", "ethereum")
    """
    ...
    def __repr__(self):
        return "<blablabla_api.BlockchainAddresses>"
