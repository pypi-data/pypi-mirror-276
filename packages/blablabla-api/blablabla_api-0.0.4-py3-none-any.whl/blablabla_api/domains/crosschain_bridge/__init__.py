...
class CrosschainBridge:
    ...
    :example:
    >>> blablabla_api.crosschain_bridge.get_commission_token(
            "USDT",
            "ethereum",
            "tron",
            "100"
    ...
    :example:
    >>> blablabla_api.crosschain_bridge.get_limits()
    """
    ...
    :example:
    >>> blablabla_api.crosschain_bridge.get_transfer_by_id("37ca03bc-e0f3-41d8-9ba3-fc214128fe08")
    """
    ...
    :example:
    >>> blablabla_api.crosschain_bridge.create_transfer(
    ...
    def __repr__(self):
        return "<blablabla_api.CrosschainBridge>"
