...
class Withdraws:
    ...
    :example:
    >>> blablabla_api.withdraws.get_commission_token(
    ...
    :example:
    >>> blablabla_api.withdraws.create_withdrawal(
            "8e2d5033-139f-46d4-b769-4a2d2cee37c4",
    ...
    :example:
    >>> blablabla_api.withdraws.get_withdrawal_by_id("bd6631c2-7f8f-4509-ba4c-418b899465be")
    """
    ...
    def __repr__(self):
        return "<blablabla_api.Withdraws>"
