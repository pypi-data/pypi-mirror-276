...
class AdvancedAccount:
    ...
    :example:
    >>> blablabla_api.advanced_account.get_all_advanced_balances()
    """
    ...
    :example:
    >>> blablabla_api.advanced_account.get_advanced_balance()
    """
    ...
    :example:
    >>> blablabla_api.advanced_account.get_payment_address(
            "ethereum", 
            "USDT"
        )
    """
    ...
    def __repr__(self):
        return "<blablabla_api.AdvancedBalance>"
