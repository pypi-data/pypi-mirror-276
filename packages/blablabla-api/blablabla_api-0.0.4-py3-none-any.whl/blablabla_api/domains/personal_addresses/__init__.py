...
class PersonalAddresses:
    ...
    :example:
    >>> blablabla_api.personal_addresses.create_or_update_user(
            "id123",
            "user@mail.com",
            "User Name",
        )
    ...
    :example:
    >>> blablabla_api.personal_addresses.get_user_address(
    ...
    :example:
    >>> blablabla_api.personal_addresses.get_addresses(limit=10, offset=0)
    """
    ...
    :example:
    >>> blablabla_api.personal_addresses.get_user("463fa3c3-bc26-451a-9eb9-5cb0d7d7c5aa")
    """
    ...
    def __repr__(self):
        return "<blablabla_api.PersonalAddresses>"
