from blablabla_api import Client
from blablabla_api.resources.utils import check_required_field
...
class PartnersApi:
    ...
    :example:
    >>> blablabla_api.partners_api.create_user("mail@example.com")
    """
    ...
    :example:
    >>> blablabla_api.partners_api.get_user("8efa4a83-86c9-4eb9-899a-27ce1079a2f8")
    """
    ...
    :example:
    >>> blablabla_api.partners_api.get_users()
    """
    ...
    :example:
    >>> blablabla_api.partners_api.create_organization("8efa4a83-86c9-4eb9-899a-27ce1079a2f8")
    """
    ...
    :example:
    >>> blablabla_api.partners_api.get_organizations("8efa4a83-86c9-4eb9-899a-27ce1079a2f8")
    """
    ...
    :example:
    >>> blablabla_api.partners_api.get_user_advanced_balance(
    ...
    :example:
    >>> blablabla_api.partners_api.replenish_user_balance(
            "8efa4a83-86c9-4eb9-899a-27ce1079a2f8", 
            "e3b5315a-1de9-4b12-9c76-fb79fe4edf33", 
            "100"
        )
    ...
    :example:
    >>> blablabla_api.partners_api.get_general_tariffs()
    """
    ...
    :example:
    >>> blablabla_api.partners_api.create_or_update_user_tariffs(
            "8efa4a83-86c9-4eb9-899a-27ce1079a2f8", 
            "e3b5315a-1de9-4b12-9c76-fb79fe4edf33", 
            "INTERNAL_TRANSFER", 
            "100",
    ...
    :example:
    >>> blablabla_api.partners_api.get_organization_tariffs(
            "8efa4a83-86c9-4eb9-899a-27ce1079a2f8", 
            "e3b5315a-1de9-4b12-9c76-fb79fe4edf33"
        )
    """
    ...
    :example:
    >>> blablabla_api.partners_api.create_api_key(
            "8efa4a83-86c9-4eb9-899a-27ce1079a2f8", 
            "e3b5315a-1de9-4b12-9c76-fb79fe4edf33", 
            "Integration key"
        )
    ...
    :example:
    >>> blablabla_api.partners_api.get_api_keys("8efa4a83-86c9-4eb9-899a-27ce1079a2f8")
    """
    ...
    :example:
    >>> blablabla_api.partners_api.delete_api_key(
            "8efa4a83-86c9-4eb9-899a-27ce1079a2f8", 
            "e3b5315a-1de9-4b12-9c76-fb79fe4edf33", 
    ...
    def __repr__(self):
        return "<blablabla_api.PartnersApi>"
