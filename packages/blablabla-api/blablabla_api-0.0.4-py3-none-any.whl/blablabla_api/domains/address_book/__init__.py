...
class AddressBook:
    ...
    :example:
    >>> blablabla_api.address_book.add_address(
    ...
    :example:
    >>> blablabla_api.address_book.delete_address("cd3867c2-2d55-4bfa-be7e-b2964ccedcc4")
    """
    ...
    :example:
    >>> blablabla_api.address_book.update_address(
    ...
    :example:
    >>> blablabla_api.address_book.get_addresses()
    """
    ...
    def __repr__(self):
        return "<blablabla_api.AddressBook>"
