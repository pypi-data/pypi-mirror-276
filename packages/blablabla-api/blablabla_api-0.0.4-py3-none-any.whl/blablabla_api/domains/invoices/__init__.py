...
class Invoices:
    ...
    :example:
    >>> blablabla_api.invoices.create_invoice(
            "USD",
            "100",
            5,
        )
    ...
    :example:
    >>> blablabla_api.invoices.get_invoice_by_id("9f3318d2-66e6-4035-9841-055a83da8974")
    """
    ...
    :example:
    >>> blablabla_api.invoices.get_invoices(10, 0, ["CREATED", "INIT"])
    """
