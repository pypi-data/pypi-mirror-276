...
class RecurringPayments:
    ...
    :example:
    >>> blablabla_api.recurring_payments.create_payment_link(
    ...
    :example:
    >>> blablabla_api.recurring_payments.get_payment_link(
    ...
    :example:
    >>> blablabla_api.recurring_payments.get_payment_links("672c1e2d-354f-49a1-8a5b-75af87e92f0a")
    """
    ...
    :example:
    >>> blablabla_api.recurring_payments.disable_payment_link(
            "d56bcbe4-586f-4980-b6ca-6e9f557750e8", 
            "672c1e2d-354f-49a1-8a5b-75af87e92f0a"
        )
    """
    ...
    :example:
    >>> blablabla_api.recurring_payments.create_subscription(
            "672c1e2d-354f-49a1-8a5b-75af87e92f0a", 
    ...
    :example:
    >>> blablabla_api.recurring_payments.get_subscription(
    ...
    :example:
    >>> blablabla_api.recurring_payments.cancel_subscription(
            "be1179ff-586f-4980-b6ca-7e11a93bb99f", 
            "672c1e2d-354f-49a1-8a5b-75af87e92f0a"
        )
    """
    ...
    :example:
    >>> blablabla_api.recurring_payments.create_payment(
            "672c1e2d-354f-49a1-8a5b-75af87e92f0a", 
            "2bfbdf44-fb5b-4e75-9962-f28c0594e483", 
            "100"
        )
    ...
    def __repr__(self):
        return "<blablabla_api.RecurringPayments>"
