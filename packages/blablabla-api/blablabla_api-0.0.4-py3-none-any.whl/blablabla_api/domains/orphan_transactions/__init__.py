...
class OrphanTransactions:
    ...
    :example:
    >>> blablabla_api.orphan_transactions.get_transaction_by_id("5cbf7135-d75a-4360-a9c4-8de7bf516baa")
    """
    ...
    :example:
    >>> blablabla_api.orphan_transactions.get_transactions(
    ...
    :example:
    >>> blablabla_api.orphan_transactions.get_commission_token("5cbf7135-d75a-4360-a9c4-8de7bf516baa")
    """
    ...
    :example:
    >>> blablabla_api.orphan_transactions.get_withdrawal(
            "5cbf7135-d75a-4360-a9c4-8de7bf516baa",
    ...
    def __repr__(self):
        return "<blablabla_api.OrphanTransactions>"
