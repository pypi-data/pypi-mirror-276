...
class CrosschainSwaps:
    ...
    :example:
    >>> blablabla_api.crosschain_swaps.get_commission_token(
            "USDT",
            "USDT",
            "ethereum",
            "tron",
    ...
    :example:
    >>> blablabla_api.crosschain_swaps.get_limits()
    """
    ...
    :example:
    >>> blablabla_api.crosschain_swaps.get_transfer_by_id("de2b4697-c758-4759-aa87-218a486589c7")
    """
    ...
    :example:
    >>> blablabla_api.crosschain_swaps.create_transfer(
    ...
    def __repr__(self):
        return "<blablabla_api.CrosschainSwaps>"
