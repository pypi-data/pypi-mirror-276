...
class Orders:
    ...
    :example:
    >>> blablabla_api.orders.create_order(
            "USDT",
            "ethereum",
            "0.0001",
            "order-1234",
    ...
    :example:
    >>> blablabla_api.orders.get_order_by_id("8e2d5033-139f-46d4-b769-4a2d2cee37c4")
    """
    ...
    :example:
    >>> blablabla_api.orders.get_orders()
    """
