...
class BasicActions:
    ...
    :example:
    >>> blablabla_api.basic_actions.check_x_api_signature()
    """
    ...
    :example:
    >>> blablabla_api.basic_actions.get_currencies()
    """
    ...
    :example:
    >>> blablabla_api.basic_actions.get_current_price("BTC", "USDT")
    """
    ...
    :example:
    >>> blablabla_api.basic_actions.get_operation_by_tx_hash("0x788529118F2A28C60b9de2Ba0353f5EE4293e044")
    """
    ...
    :example:
    >>> blablabla_api.basic_actions.check_address_format("0x788529118F2A28C60b9a0353f5EE4293e044", "ethereum")
    """
    ...
    def __repr__(self):
        return "<blablabla_api.BasicActions>"
