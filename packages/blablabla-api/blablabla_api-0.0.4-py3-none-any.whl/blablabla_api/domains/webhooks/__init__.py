...
class Webhooks:
    ...
    :example:
    >>> blablabla_api.webhooks.get_webhook_by_id("8d7db145-80cc-4c43-9cfb-9cde10f8ef40")
    """
    ...
    :example:
    >>> blablabla_api.webhooks.get_webhook_by_id_extended(
