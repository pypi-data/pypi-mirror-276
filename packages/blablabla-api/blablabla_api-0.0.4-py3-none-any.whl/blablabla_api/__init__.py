import requests
from blablabla_api.error import AuthenticationError, InternalSDKError
from blablabla_api.resources.requester import APIRequestor
...
class Client:
    def __init__(self, public_key="", private_key=""):
        ...
        self._base_url = "https://app.blablabla.io/api-gateway"
        self._partners_base_url = "https://app.blablabla.io/partner/api"
    ...
    def advanced_account(self):
        if self._advanced_account is None:
            from blablabla_api.domains.advanced_account import AdvancedAccount
    ...
    def blockchain_address(self):
        if self._blockchain_addresses is None:
            from blablabla_api.domains.blockchain_addresses import BlockchainAddresses
    ...
    def invoices(self):
        if self._invoices is None:
            from blablabla_api.domains.invoices import Invoices
    ...
    def personal_addresses(self):
        if self._personal_addresses is None:
            from blablabla_api.domains.personal_addresses import PersonalAddresses
    ...
    def orders(self):
        if self._orders is None:
            from blablabla_api.domains.orders import Orders
    ...
    def withdraws(self):
        if self._withdraws is None:
            from blablabla_api.domains.withdraws import Withdraws
    ...
    def crosschain_bridge(self):
        if self._crosschain_bridge is None:
            from blablabla_api.domains.crosschain_bridge import CrosschainBridge
    ...
    def crosschain_swaps(self):
        if self._crosschain_swaps is None:
            from blablabla_api.domains.crosschain_swaps import CrosschainSwaps
    ...
    def auto_swaps(self):
        if self._auto_swaps is None:
            from blablabla_api.domains.auto_swaps import AutoSwaps
    ...
    def basic_actions(self):
        if self._basic_actions is None:
            from blablabla_api.domains.basic_actions import BasicActions
    ...
    def recurring_payments(self):
        if self._recurring_payments is None:
            from blablabla_api.domains.recurring_payments import RecurringPayments
    ...
    def kyt(self):
        if self._kyt is None:
            from blablabla_api.domains.kyt import KYT
    ...
    def partners_api(self):
        if self._partners_api is None:
            from blablabla_api.domains.partners_api import PartnersApi
    ...
    def orphan_transactions(self):
        if self._orphan_transactions is None:
            from blablabla_api.domains.orphan_transactions import OrphanTransactions
    ...
    def address_book(self):
        if self._address_book is None:
            from blablabla_api.domains.address_book import AddressBook
    ...
    def webhooks(self):
        if self._webhooks is None:
            from blablabla_api.domains.webhooks import Webhooks
