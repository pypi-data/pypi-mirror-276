...
class LbrResearch(BaseModel):
    ...
    research_profile = models.ForeignKey("OmsKlResearchProfile", models.DO_NOTHING, db_column="rf_kl_ResearchProfileID")
    consult_doc_prvd = models.ForeignKey("HltDocPrvd", models.DO_NOTHING, db_column="rf_ConsultDocPRVDID")
    ...
    cancel_doc_prvd = models.ForeignKey("HltDocPrvd", models.DO_NOTHING, db_column="rf_CancelDocPRVDID")
    ...
    lpu_second_opinion = models.ForeignKey(
        "OmsLpu", models.DO_NOTHING, db_column="rf_LPUSecondOpinionGUID", to_field="GUIDLPU"
    )
