...
**prieto2010** could always use more documentation, whether as
part of the official **prieto2010** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `prieto2010` for local
development.

1. Fork the `prieto2010` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/prieto2010.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd prieto2010
    (dvlpt) prieto2010$ flake8
    (dvlpt) prieto2010$ pytest
    
    (dvlpt) prieto2010$ tox
...
.. _issues: https://gitlab.com/b326/prieto2010/issues
