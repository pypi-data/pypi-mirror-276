...
class ChatCompletionParams(betterproto.Message):
    ...
    logprobs: List[float] = betterproto.double_field(8)
...
class EvaluateRequest(betterproto.Message):
    ...
    eval_results_set: "EvaluateResponse" = betterproto.message_field(10)
...
class EvaluateResponse(betterproto.Message):
    ...
    evaluation_request: "EvaluateRequest" = betterproto.message_field(8)
