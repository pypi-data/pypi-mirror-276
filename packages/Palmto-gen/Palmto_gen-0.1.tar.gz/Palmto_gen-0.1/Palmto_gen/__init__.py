...
class TrajGenerator:
    ...
    def generate_sentences_using_origin(self, length):
      text = []
    ...
    def generate_trajs_using_origin(self, sentence_length):
        new_generated_sentences = []
        with tqdm(total=self.num_sentences, desc="Generating sentences") as pbar:
            while len(new_generated_sentences) < self.num_sentences:
                generated_text = self.generate_sentences_using_origin(sentence_length)
