...
if "Import":
    ...
    from  rag.engine import torch_getdevice
    import evaluate
...
"""### infos 
    ...
    ##### Sample data
        ...
        1,"Patriots Sign Top Pick Watson (Reuters) Reuters - The New England Patriots\Monday announced the signing of first-round draft pick Benjamin\Watson. As per team policy, terms of the tight end's deal were\not released.",
            __en__ __sv__ Pick Watson __uk__ The New England Patriots __vi__ member of sports team</s>
        ...
        3,"U.S. Awaits Judgment on Venezuela Voting (AP) AP - There was no evident pattern of fraud in Venezuela's balloting that left President Hugo Chavez in office but a final judgment depends on what observers report, the State Department said Monday.",
        ...
        5,"Insurers face massive storm bill Insurers are counting the cost of Hurricane Charley in Florida, with early damage estimates reaching as high as \$14bn (7.6; 11bn euros).",__en__ __sv__ Hurricane Charley __tn__ Florida __tn__ located in the administrative territorial entity</s>
        6,"Fischer Appeals to Powell to Help Him Renounce U.S. Citizenship Former chess champion Bobby Fischer announced plans Monday to marry a leading Japanese chess official and appealed to Secretary of State Colin Powell to help him renounce U.S. citizenship, the latest in a series of moves as he seeks to block attempts to deport him to the United States.",__en__ __sv__ Fischer Appeals to Powell to Help Him Renounce U.S. Citizenship Former chess __zu__ chess __zu__ sport __sv__ Bobby Fischer __uk__ chess __zu__ sport __sv__ Colin Powell __uk__ chess __zu__ sport</s>
        ...
        12,Columnists: Big Brother's Last Mile The FCC's new ruling on broadband wiretaps will force customers to pay for the privilege of making  the Internet less secure.\,__en__ __sv__ broadband __zu__ wiretap __zu__ subclass of</s>
        13,"US to withdraw up to 70,000 troops from Europe and Asia: Bush (AFP) AFP - The United States will withdraw up to 70,000 troops from Europe and Asia over the next decade, President George W. Bush said, in a move aimed at increasing the capability to fight the ""war on terror"" and meet other new threats.",__en__ __sv__ George W. Bush __uk__ President __zu__ position held</s>
        14,"Thorpedo Sinks Phelps' Shot at Record ATHENS, Greece - The kid couldn't catch the Thorpedo - and he won't be catching Mark Spitz, either. Michael Phelps' quest for seven gold medals ended after just three events, doomed by another bronze Monday night in the most anticipated race at the Olympic pool - the head-to-head showdown with Australia's Ian Thorpe in the 200-meter freestyle...",__en__ __sv__ Ian Thorpe __uk__ Australia __tn__ country of citizenship</s>
        15,"AP: Group Finds Cave Linked to Baptist KIBBUTZ TZUBA, Israel - Archaeologists said Monday they have found a cave where they believe John the Baptist anointed many of his disciples - a huge cistern with 28 steps leading to an underground pool of water.    During an exclusive tour of the cave by The Associated Press, archaeologists presented wall carvings they said tell the story of the fiery New Testament preacher, as well as a stone they believe was used for ceremonial foot washing...",__en__ __sv__ KIBBUTZ TZUBA __tn__ Israel __tn__ country</s>
        ...
        17,"Private Firms to Buy Intelsat for \$3 Bln  PARIS (Reuters) - Four private equity firms plan to buy  Bermuda-based Intelsat for about \$3 billion, the world's  second-largest satellite operator said on Monday.",__en__ __sv__ Intelsat __vi__ Bermuda __tn__ headquarters location</s>
        18,"Biometric ID System Said to Delay Venezuela Recall By CHRISTOPHER TOOTHAKER     CARACAS, Venezuela (AP) -- The high-tech thumbprint devices were meant to keep people from voting more than once in the recall ballot against President Hugo Chavez. Instead, they often wound up working fitfully - even when Chavez himself voted - contributing to huge delays in Sunday's historic referendum...",__en__ __sv__ CHRISTOPHER TOOTHAKER CARACAS __vi__ Venezuela __tn__ country __sv__ Venezuela __tn__ President __uk__ office held by head of government __sv__ President __uk__ Venezuela __tn__ country __sv__ Hugo Chavez __uk__ Venezuela __tn__ country of citizenship __uk__ President __uk__ position held</s>
        19,"Hurricane Emergency Aid Set Up in Florida (AP) AP - More than 76,000 meals and snacks have been served to hurricane-ravaged counties in Florida, with thousands more available from federal, local and private agencies, the Federal Emergency Management Agency said Monday.",__en__ __sv__ Hurricane Emergency Aid Set Up in Florida __tn__ Florida __tn__ located in the administrative territorial entity __sv__ hurricane-ravaged counties __tn__ Florida __tn__ located in the administrative territorial entity</s>
