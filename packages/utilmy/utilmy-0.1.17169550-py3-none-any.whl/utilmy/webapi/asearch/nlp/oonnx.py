...
def export_onnx(dirmodel: str=None,  dirout:str=None, 
                query_0='find the restaurant around US',
    ...
    torch.onnx.export(model_export,               # model being run
                    ...
                    f'{dirout}/model.onnx',   # where to save the model (can be a file or file-like object)
    ...
    log("Exported model has been tested with ONNXRuntime, and the result looks good!")
    log( ort_outs[0])
...
# export
python3 nlp/oonnx.py export_onnx --dirmodel tuenguyen/token_classification_model --dirout /home/tuenv2/export_onnx
# tuenguyen/token_classification_model : path of the model after training: i.e log_training/checkpoint-314
