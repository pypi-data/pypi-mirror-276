...
def model():
    ...
    parser.add_argument('--mcool',  help='cool file path',required=True,
                        default=None)
    parser.add_argument('--resolution', help='resolution',required=True, default=None, type=int)
    parser.add_argument('--output', help='output file path',required=True, default=None)

    
    
    args = parser.parse_args()
    impute(args.mcool, args.resolution, args.output)
