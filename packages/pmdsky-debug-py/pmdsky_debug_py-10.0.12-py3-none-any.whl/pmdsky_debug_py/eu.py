...
class EuArm9Functions:
    ...
    Svc_SoftReset = Symbol([0x1A4], [0x20001A4], None, "Software interrupt.", None)

    Svc_WaitByLoop = Symbol([0x6B0], [0x20006B0], None, "Software interrupt.", None)

    Svc_CpuSet = Symbol([0x79E], [0x200079E], None, "Software interrupt.", None)
...
class EuArm9Data:
    ...
    AURA_BOW_ID_LAST = Symbol(
        [0xCCBC], [0x200CCBC], 0x4, "Highest item ID of the aura bows.", "enum item_id"
    )
    ...
    STRING_DEBUG_EMPTY = Symbol([0x94EF8], [0x2094EF8], None, "", "char[4]")

    STRING_DEBUG_FORMAT_LINE_FILE = Symbol([0x94EFC], [0x2094EFC], None, "", "char[28]")

    STRING_DEBUG_NO_PROG_POS = Symbol([0x94F18], [0x2094F18], None, "", "char[24]")

    STRING_DEBUG_SPACED_PRINT = Symbol([0x94F30], [0x2094F30], None, "", "char[12]")

    STRING_DEBUG_FATAL = Symbol([0x94F3C], [0x2094F3C], None, "", "char[20]")

    STRING_DEBUG_NEWLINE = Symbol([0x94F50], [0x2094F50], None, "", "char[4]")

    STRING_DEBUG_LOG_NULL = Symbol([0x94F54], [0x2094F54], None, "", "char[8]")

    STRING_DEBUG_STRING_NEWLINE = Symbol([0x94F5C], [0x2094F5C], None, "", "char[4]")

    STRING_EFFECT_EFFECT_BIN = Symbol([0x94F60], [0x2094F60], None, "", "char[20]")

    STRING_MONSTER_MONSTER_BIN = Symbol([0x94F74], [0x2094F74], None, "", "char[20]")

    STRING_BALANCE_M_LEVEL_BIN = Symbol([0x94F88], [0x2094F88], None, "", "char[20]")

    STRING_DUNGEON_DUNGEON_BIN = Symbol([0x94F9C], [0x2094F9C], None, "", "char[20]")

    STRING_MONSTER_M_ATTACK_BIN = Symbol([0x94FB0], [0x2094FB0], None, "", "char[24]")

    STRING_MONSTER_M_GROUND_BIN = Symbol([0x94FC8], [0x2094FC8], None, "", "char[24]")

    STRING_FILE_DIRECTORY_INIT = Symbol([0x94FE0], [0x2094FE0], None, "", "char[40]")
    ...
    SPECIAL_BAND_STAT_BOOST = Symbol(
        [0xA1DF0], [0x20A1DF0], 0x2, "Stat boost value for the Special Band.", "int16_t"
    )

    MUNCH_BELT_STAT_BOOST = Symbol(
        [0xA1E00], [0x20A1E00], 0x2, "Stat boost value for the Munch Belt.", "int16_t"
    )
    ...
    MIN_IQ_EXCLUSIVE_MOVE_USER = Symbol([0xA1E10], [0x20A1E10], 0x4, "", "int32_t")

    WONDER_GUMMI_IQ_GAIN = Symbol(
        [0xA1E14], [0x20A1E14], 0x2, "IQ gain when ingesting wonder gummis.", "int16_t"
    )

    AURA_BOW_STAT_BOOST = Symbol(
        [0xA1E1C], [0x20A1E1C], 0x2, "Stat boost value for the aura bows.", "int16_t"
    )

    MIN_IQ_ITEM_MASTER = Symbol([0xA1E28], [0x20A1E28], 0x4, "", "int32_t")
    ...
    POWER_BAND_STAT_BOOST = Symbol(
        [0xA1E30], [0x20A1E30], 0x2, "Stat boost value for the Power Band.", "int16_t"
    )
    ...
    ZINC_BAND_STAT_BOOST = Symbol(
        [0xA1E38], [0x20A1E38], 0x2, "Stat boost value for the Zinc Band.", "int16_t"
    )
    ...
    TACTICS_UNLOCK_LEVEL_TABLE = Symbol(
        [0xA1EC4], [0x20A1EC4], 0x18, "type: int16_t[12]", "int16_t[12]"
    )
    ...
    IQ_GROUP_SKILLS = Symbol(
        [0xA2314], [0x20A2314], 0x190, "Irdkwia's notes: 25*16*0x1", "uint8_t[400]"
    )
    ...
    IQ_GUMMI_GAIN_TABLE = Symbol(
        [0xA2834], [0x20A2834], 0x288, "type: int16_t[18][18]", "int16_t[18]"
    )

    GUMMI_BELLY_RESTORE_TABLE = Symbol(
        [0xA2ABC], [0x20A2ABC], 0x288, "type: int16_t[18][18]", "int16_t[18]"
    )
    ...
    RANK_UP_TABLE = Symbol(
        [0xA30C8], [0x20A30C8], 0xD0, "", "struct rankup_table_entry[13]"
    )
    ...
    MONSTER_SPRITE_DATA = Symbol([0xA332C], [0x20A332C], 0x4B0, "", "undefined[1200]")
    ...
    LFO_OUTPUT_VOICE_UPDATE_FLAGS = Symbol(
        [0xAA840], [0x20AA840], 0x10, "", "struct dse_voice_update_flags"
    )
    ...
    TEX_START_ADDR_TABLE = Symbol([0xAE964], [0x20AE964], 0x60, "", "int16_t[48]")
    ...
    DEBUG_IS_INITIALIZED = Symbol([0xAFF50], [0x20AFF50], None, "", "bool")
    ...
    LFO_WAVEFORM_CALLBACKS = Symbol(
        [0xB1B94], [0x20B1B94], 0x40, "", "sound_lfo_waveform_callback[16]"
    )

    IS_DISP_ON = Symbol([0xB34D8], [0x20B34D8], 0x1, "", "bool")

    GXI_DMA_ID = Symbol([0xB34DC], [0x20B34DC], 0x4, "", "uint32_t")
...
class EuLibsFunctions:
    ...
    DseDriver_LoadDefaultSettings = Symbol([0xE8], [0x206C558], None, "", None)
    ...
    DseDriver_ConfigureHeap = Symbol([0x264], [0x206C6D4], None, "", None)

    DseDriver_Init = Symbol([0x308], [0x206C778], None, "", None)

    Dse_SetError = Symbol([0x77C], [0x206CBEC], None, "", None)

    Dse_SetError2 = Symbol([0x7B0], [0x206CC20], None, "", None)

    DseUtil_ByteSwap32 = Symbol([0x7EC], [0x206CC5C], None, "", None)
    ...
    DseMem_Init = Symbol([0x844], [0x206CCB4], None, "", None)

    DseMem_Quit = Symbol([0x8B4], [0x206CD24], None, "", None)

    DseMem_AllocateUser = Symbol([0x8D0], [0x206CD40], None, "", None)

    DseMem_Allocate = Symbol([0x8E4], [0x206CD54], None, "", None)

    DseMem_AllocateThreadStack = Symbol([0x9F4], [0x206CE64], None, "", None)

    DseMem_Free = Symbol([0xB3C], [0x206CFAC], None, "", None)

    DseMem_Clear = Symbol([0xBE4], [0x206D054], None, "", None)

    DseFile_CheckHeader = Symbol([0xC44], [0x206D0B4], None, "", None)

    DseSwd_SysInit = Symbol([0xCC4], [0x206D134], None, "", None)

    DseSwd_SysQuit = Symbol([0xD50], [0x206D1C0], None, "", None)

    DseSwd_SampleLoaderMain = Symbol([0xD90], [0x206D200], None, "", None)

    DseSwd_MainBankDummyCallback = Symbol([0xDF0], [0x206D260], None, "", None)

    DseSwd_LoadMainBank = Symbol([0xDF8], [0x206D268], None, "", None)

    DseSwd_LoadBank = Symbol([0x1030], [0x206D4A0], None, "", None)

    DseSwd_IsBankLoading = Symbol([0x1234], [0x206D6A4], None, "", None)

    DseSwd_LoadWaves = Symbol([0x1250], [0x206D6C0], None, "", None)

    DseSwd_LoadWavesInternal = Symbol([0x1300], [0x206D770], None, "", None)

    DseSwd_Unload = Symbol([0x140C], [0x206D87C], None, "", None)
    ...
    DseSwd_GetInstrument = Symbol([0x14B8], [0x206D928], None, "", None)

    DseSwd_GetNextSplitInRange = Symbol([0x14F0], [0x206D960], None, "", None)

    DseSwd_GetMainBankById = Symbol([0x1578], [0x206D9E8], None, "", None)

    DseSwd_GetBankById = Symbol([0x15C8], [0x206DA38], None, "", None)

    DseSwd_InitMainBankFileReader = Symbol([0x1618], [0x206DA88], None, "", None)

    DseSwd_OpenMainBankFileReader = Symbol([0x1628], [0x206DA98], None, "", None)

    DseSwd_CloseMainBankFileReader = Symbol([0x1654], [0x206DAC4], None, "", None)

    DseSwd_ReadMainBank = Symbol([0x1664], [0x206DAD4], None, "", None)

    DseBgm_DefaultSignalCallback = Symbol([0x1728], [0x206DB98], None, "", None)

    DseBgm_Load = Symbol([0x1730], [0x206DBA0], None, "", None)

    DseBgm_Unload = Symbol([0x1834], [0x206DCA4], None, "", None)

    DseBgm_SetSignalCallback = Symbol([0x186C], [0x206DCDC], None, "", None)

    DseBgm_IsPlaying = Symbol([0x18CC], [0x206DD3C], None, "", None)
    ...
    DseBgm_Stop = Symbol([0x19C4], [0x206DE34], None, "", None)

    DseBgm_StopAll = Symbol([0x1A04], [0x206DE74], None, "", None)

    DseBgm_SetFades = Symbol([0x1A64], [0x206DED4], None, "", None)

    DseSequence_Start = Symbol([0x1AA4], [0x206DF14], None, "", None)

    DseSequence_PauseList = Symbol([0x1B34], [0x206DFA4], None, "", None)

    DseSequence_SetFades = Symbol([0x1C98], [0x206E108], None, "", None)

    DseSequence_GetParameter = Symbol([0x1F8C], [0x206E3FC], None, "", None)

    DseSequence_GetSmallestNumLoops = Symbol([0x2140], [0x206E5B0], None, "", None)

    DseSequence_Reset = Symbol([0x2194], [0x206E604], None, "", None)

    DseSequence_Stop = Symbol([0x22EC], [0x206E75C], None, "", None)
    ...
    DseSequence_LoadSong = Symbol([0x247C], [0x206E8EC], None, "", None)

    DseSequence_GetById = Symbol([0x257C], [0x206E9EC], None, "", None)

    DseSequence_AllocateNew = Symbol([0x25C8], [0x206EA38], None, "", None)

    DseSequence_Unload = Symbol([0x2700], [0x206EB70], None, "", None)

    DseSequence_InitTracks = Symbol([0x2784], [0x206EBF4], None, "", None)

    DseBgm_SysSetupNoteList = Symbol([0x27D4], [0x206EC44], None, "", None)

    DseSe_SysReset = Symbol([0x2848], [0x206ECB8], None, "", None)

    DseSe_Load = Symbol([0x2940], [0x206EDB0], None, "", None)

    DseSe_Unload = Symbol([0x2AF4], [0x206EF64], None, "", None)

    DseSe_GetUsedBankIDs = Symbol([0x2B84], [0x206EFF4], None, "", None)

    DseSe_HasPlayingInstances = Symbol([0x2C58], [0x206F0C8], None, "", None)

    DseSe_Play = Symbol([0x2D24], [0x206F194], None, "", None)

    DseSe_GetEffectSong = Symbol([0x2ED8], [0x206F348], None, "", None)

    DseSe_CheckTooManyInstances = Symbol([0x2F20], [0x206F390], None, "", None)

    DseSe_CheckTooManyInstancesInGroup = Symbol([0x3028], [0x206F498], None, "", None)

    DseSe_GetBestSeqAllocation = Symbol([0x31EC], [0x206F65C], None, "", None)

    DseSe_GetById = Symbol([0x3268], [0x206F6D8], None, "", None)

    DseSe_Stop = Symbol([0x32B4], [0x206F724], None, "", None)

    DseSe_StopAll = Symbol([0x3408], [0x206F878], None, "", None)

    DseSe_StopSeq = Symbol([0x3474], [0x206F8E4], None, "", None)
    ...
    DseDriver_StartMainThread = Symbol([0x4D34], [0x20711A4], None, "", None)

    DseDriver_StartTickTimer = Symbol([0x4E04], [0x2071274], None, "", None)

    DseDriver_NotifyTick = Symbol([0x4EFC], [0x207136C], None, "", None)

    DseDriver_Main = Symbol([0x4F3C], [0x20713AC], None, "", None)

    DseSequence_TickNotes = Symbol([0x5088], [0x20714F8], None, "", None)
    ...
    DseSequence_TickFades = Symbol([0x56AC], [0x2071B1C], None, "", None)

    DseTrackEvent_Invalid = Symbol([0x5844], [0x2071CB4], None, "", None)

    DseTrackEvent_WaitSame = Symbol([0x5850], [0x2071CC0], None, "", None)

    DseTrackEvent_WaitDelta = Symbol([0x585C], [0x2071CCC], None, "", None)

    DseTrackEvent_Wait8 = Symbol([0x5874], [0x2071CE4], None, "", None)

    DseTrackEvent_Wait16 = Symbol([0x5884], [0x2071CF4], None, "", None)

    DseTrackEvent_Wait24 = Symbol([0x58A0], [0x2071D10], None, "", None)

    DseTrackEvent_WaitUntilFadeout = Symbol([0x58C4], [0x2071D34], None, "", None)

    DseTrackEvent_EndTrack = Symbol([0x58F0], [0x2071D60], None, "", None)

    DseTrackEvent_MainLoopBegin = Symbol([0x593C], [0x2071DAC], None, "", None)

    DseTrackEvent_SubLoopBegin = Symbol([0x5944], [0x2071DB4], None, "", None)

    DseTrackEvent_SubLoopEnd = Symbol([0x5984], [0x2071DF4], None, "", None)

    DseTrackEvent_SubLoopBreakOnLastIteration = Symbol(
        [0x59C0], [0x2071E30], None, "", None
    )

    DseTrackEvent_SetOctave = Symbol([0x59E8], [0x2071E58], None, "", None)

    DseTrackEvent_OctaveDelta = Symbol([0x59F4], [0x2071E64], None, "", None)

    DseTrackEvent_SetBpm = Symbol([0x5A08], [0x2071E78], None, "", None)

    DseTrackEvent_SetBpm2 = Symbol([0x5A48], [0x2071EB8], None, "", None)

    DseTrackEvent_SetBank = Symbol([0x5A88], [0x2071EF8], None, "", None)

    DseTrackEvent_SetBankMsb = Symbol([0x5AB4], [0x2071F24], None, "", None)

    DseTrackEvent_SetBankLsb = Symbol([0x5AE4], [0x2071F54], None, "", None)

    DseTrackEvent_Dummy1Byte = Symbol([0x5B14], [0x2071F84], None, "", None)

    DseTrackEvent_SetInstrument = Symbol([0x5B1C], [0x2071F8C], None, "", None)

    DseTrackEvent_SongVolumeFade = Symbol([0x5B64], [0x2071FD4], None, "", None)

    DseTrackEvent_RestoreEnvelopeDefaults = Symbol(
        [0x5BF0], [0x2072060], None, "", None
    )

    DseTrackEvent_SetEnvelopeAttackBegin = Symbol([0x5C08], [0x2072078], None, "", None)

    DseTrackEvent_SetEnvelopeAttackTime = Symbol([0x5C28], [0x2072098], None, "", None)

    DseTrackEvent_SetEnvelopeHoldTime = Symbol([0x5C48], [0x20720B8], None, "", None)

    DseTrackEvent_SetEnvelopeDecayTimeAndSustainLevel = Symbol(
        [0x5C68], [0x20720D8], None, "", None
    )

    DseTrackEvent_SetEnvelopeSustainTime = Symbol([0x5C98], [0x2072108], None, "", None)

    DseTrackEvent_SetEnvelopeReleaseTime = Symbol([0x5CB8], [0x2072128], None, "", None)

    DseTrackEvent_SetNoteDurationMultiplier = Symbol(
        [0x5CD8], [0x2072148], None, "", None
    )

    DseTrackEvent_ForceLfoEnvelopeLevel = Symbol([0x5CE4], [0x2072154], None, "", None)

    DseTrackEvent_SetHoldNotes = Symbol([0x5D00], [0x2072170], None, "", None)

    DseTrackEvent_SetFlagBit1Unknown = Symbol([0x5D38], [0x20721A8], None, "", None)

    DseTrackEvent_SetOptionalVolume = Symbol([0x5D48], [0x20721B8], None, "", None)

    DseTrackEvent_Dummy2Bytes = Symbol([0x5D54], [0x20721C4], None, "", None)

    DseTrackEvent_SetTuning = Symbol([0x5D5C], [0x20721CC], None, "", None)

    DseTrackEvent_TuningDeltaCoarse = Symbol([0x5DDC], [0x207224C], None, "", None)

    DseTrackEvent_TuningDeltaFine = Symbol([0x5E64], [0x20722D4], None, "", None)

    DseTrackEvent_TuningDeltaFull = Symbol([0x5EEC], [0x207235C], None, "", None)

    DseTrackEvent_TuningFade = Symbol([0x5F7C], [0x20723EC], None, "", None)

    DseTrackEvent_SetNoteRandomRegion = Symbol([0x606C], [0x20724DC], None, "", None)

    DseTrackEvent_SetTuningJitterAmplitude = Symbol(
        [0x6094], [0x2072504], None, "", None
    )

    DseTrackEvent_SetKeyBend = Symbol([0x60AC], [0x207251C], None, "", None)

    DseTrackEvent_SetUnknown2 = Symbol([0x60D8], [0x2072548], None, "", None)

    DseTrackEvent_SetKeyBendRange = Symbol([0x60F0], [0x2072560], None, "", None)

    DseTrackEvent_SetupKeyBendLfo = Symbol([0x60FC], [0x207256C], None, "", None)

    DseTrackEvent_SetupKeyBendLfoEnvelope = Symbol(
        [0x6154], [0x20725C4], None, "", None
    )

    DseTrackEvent_UseKeyBendLfo = Symbol([0x617C], [0x20725EC], None, "", None)

    DseTrackEvent_SetVolume = Symbol([0x61A4], [0x2072614], None, "", None)

    DseTrackEvent_VolumeDelta = Symbol([0x6238], [0x20726A8], None, "", None)

    DseTrackEvent_VolumeFade = Symbol([0x62E8], [0x2072758], None, "", None)

    DseTrackEvent_SetExpression = Symbol([0x6344], [0x20727B4], None, "", None)

    DseTrackEvent_SetupVolumeLfo = Symbol([0x63D0], [0x2072840], None, "", None)

    DseTrackEvent_SetupVolumeLfoEnvelope = Symbol([0x642C], [0x207289C], None, "", None)

    DseTrackEvent_UseVolumeLfo = Symbol([0x6454], [0x20728C4], None, "", None)

    DseTrackEvent_SetPan = Symbol([0x647C], [0x20728EC], None, "", None)

    DseTrackEvent_PanDelta = Symbol([0x64FC], [0x207296C], None, "", None)

    DseTrackEvent_PanFade = Symbol([0x6590], [0x2072A00], None, "", None)

    DseTrackEvent_SetupPanLfo = Symbol([0x65EC], [0x2072A5C], None, "", None)

    DseTrackEvent_SetupPanLfoEnvelope = Symbol([0x6648], [0x2072AB8], None, "", None)

    DseTrackEvent_UsePanLfo = Symbol([0x6670], [0x2072AE0], None, "", None)

    DseTrackEvent_SetupLfo = Symbol([0x6698], [0x2072B08], None, "", None)

    DseTrackEvent_SetupLfoEnvelope = Symbol([0x66F0], [0x2072B60], None, "", None)

    DseTrackEvent_SetLfoParameter = Symbol([0x6724], [0x2072B94], None, "", None)

    DseTrackEvent_UseLfo = Symbol([0x6860], [0x2072CD0], None, "", None)

    DseTrackEvent_Signal = Symbol([0x6894], [0x2072D04], None, "", None)

    DseTrackEvent_Dummy2Bytes2 = Symbol([0x68C4], [0x2072D34], None, "", None)

    DseSynth_Reset = Symbol([0x7130], [0x20735A0], None, "", None)

    DseSynth_AllocateNew = Symbol([0x71A8], [0x2073618], None, "", None)

    DseSynth_Unload = Symbol([0x7278], [0x20736E8], None, "", None)

    DseSynth_ClearHeldNotes = Symbol([0x72E4], [0x2073754], None, "", None)

    DseSynth_ResetAndSetBankAndSequence = Symbol([0x7380], [0x20737F0], None, "", None)

    DseSynth_StopChannels = Symbol([0x73A8], [0x2073818], None, "", None)

    DseSynth_ResetAllVoiceTimersAndVolumes = Symbol(
        [0x73D4], [0x2073844], None, "", None
    )

    DseSynth_RestoreHeldNotes = Symbol([0x742C], [0x207389C], None, "", None)

    DseSynth_SetGlobalVolumeIndex = Symbol([0x7494], [0x2073904], None, "", None)

    DseSynth_SetBend = Symbol([0x757C], [0x20739EC], None, "", None)

    DseSynth_SetVolume = Symbol([0x7610], [0x2073A80], None, "", None)

    DseSynth_SetPan = Symbol([0x76E0], [0x2073B50], None, "", None)

    DseSynth_SetBankAndSequence = Symbol([0x7774], [0x2073BE4], None, "", None)

    DseChannel_Init = Symbol([0x7804], [0x2073C74], None, "", None)

    DseChannel_DeallocateVoices = Symbol([0x79B8], [0x2073E28], None, "", None)

    DseChannel_ResetTimerAndVolumeForVoices = Symbol(
        [0x7A3C], [0x2073EAC], None, "", None
    )

    DseChannel_SetBank = Symbol([0x7AB8], [0x2073F28], None, "", None)

    DseChannel_SetInstrument = Symbol([0x7AF0], [0x2073F60], None, "", None)

    DseChannel_SetLfoConstEnvelopeLevel = Symbol([0x7B84], [0x2073FF4], None, "", None)

    DseChannel_SetKeyBend = Symbol([0x7BB8], [0x2074028], None, "", None)

    DseChannel_AllocateNote = Symbol([0x7C00], [0x2074070], None, "", None)

    DseChannel_ReleaseNoteInternal = Symbol([0x7C90], [0x2074100], None, "", None)

    DseChannel_ChangeNote = Symbol([0x7D38], [0x20741A8], None, "", None)

    DseChannel_ReleaseNote = Symbol([0x7DC8], [0x2074238], None, "", None)

    DseVoice_PlayNote = Symbol([0x7E04], [0x2074274], None, "", None)

    DseVoice_ReleaseNote = Symbol([0x8078], [0x20744E8], None, "", None)

    DseVoice_UpdateParameters = Symbol([0x80BC], [0x207452C], None, "", None)

    DseVoice_ResetAll = Symbol([0x8260], [0x20746D0], None, "", None)

    DseVoice_ResetHW = Symbol([0x8304], [0x2074774], None, "", None)
    ...
    DseVoice_Cleanup = Symbol([0x84A4], [0x2074914], None, "", None)

    DseVoice_Allocate = Symbol([0x8540], [0x20749B0], None, "", None)

    DseVoice_Start = Symbol([0x86A8], [0x2074B18], None, "", None)

    DseVoice_ReleaseHeld = Symbol([0x8704], [0x2074B74], None, "", None)

    DseVoice_Release = Symbol([0x8784], [0x2074BF4], None, "", None)

    DseVoice_Deallocate = Symbol([0x87C8], [0x2074C38], None, "", None)

    DseVoice_FlagForActivation = Symbol([0x88CC], [0x2074D3C], None, "", None)

    DseVoice_FlagForDeactivation = Symbol([0x891C], [0x2074D8C], None, "", None)

    DseVoice_CountNumActiveInChannel = Symbol([0x8954], [0x2074DC4], None, "", None)

    DseVoice_UpdateHardware = Symbol([0x8980], [0x2074DF0], None, "", None)

    SoundEnvelope_Reset = Symbol(
        [0x8B98], [0x2075008], None, "r0: Sound envelope pointer", None
    )

    SoundEnvelopeParameters_Reset = Symbol(
        [0x8BAC], [0x207501C], None, "r0: Sound envelope parameters pointer", None
    )

    SoundEnvelopeParameters_CheckValidity = Symbol(
        [0x8BC8], [0x2075038], None, "r0: Sound envelope parameters pointer", None
    )
    ...
    SoundEnvelope_Release = Symbol(
        [0x8E00], [0x2075270], None, "r0: Sound envelope pointer", None
    )

    SoundEnvelope_Stop = Symbol(
        [0x8E2C], [0x207529C], None, "r0: Sound envelope pointer", None
    )
    ...
    SoundEnvelope_Stop2 = Symbol(
        [0x8E64], [0x20752D4], None, "r0: Sound envelope pointer", None
    )
    ...
    SoundLfoBank_Reset = Symbol(
        [0x8FC4], [0x2075434], None, "r0: LFO bank pointer", None
    )
    ...
    Crypto_RC4Init = Symbol([0x9648], [0x2075AB8], None, "", None)

    Mtx_LookAt = Symbol([0x9750], [0x2075BC0], None, "", None)

    Mtx_OrthoW = Symbol([0x9858], [0x2075CC8], None, "", None)

    FX_Div = Symbol([0x9A60], [0x2075ED0], None, "", None)

    FX_GetDivResultFx64c = Symbol([0x9A70], [0x2075EE0], None, "", None)

    FX_GetDivResult = Symbol([0x9A94], [0x2075F04], None, "", None)

    FX_InvAsync = Symbol([0x9ACC], [0x2075F3C], None, "", None)

    FX_DivAsync = Symbol([0x9AFC], [0x2075F6C], None, "", None)

    FX_DivS32 = Symbol([0x9B24], [0x2075F94], None, "", None)

    FX_ModS32 = Symbol([0x9B60], [0x2075FD0], None, "", None)

    Vec_DotProduct = Symbol([0x9B9C], [0x207600C], None, "", None)

    Vec_CrossProduct = Symbol([0x9BD8], [0x2076048], None, "", None)

    Vec_Normalize = Symbol([0x9C5C], [0x20760CC], None, "", None)

    Vec_Distance = Symbol([0x9D74], [0x20761E4], None, "", None)

    FX_Atan2Idx = Symbol([0x9DF0], [0x2076260], None, "", None)

    GX_Init = Symbol([0x9F9C], [0x207640C], None, "", None)

    GX_HBlankIntr = Symbol([0xA0E8], [0x2076558], None, "", None)

    GX_VBlankIntr = Symbol([0xA110], [0x2076580], None, "", None)

    GX_DispOff = Symbol([0xA144], [0x20765B4], None, "", None)

    GX_DispOn = Symbol([0xA180], [0x20765F0], None, "", None)

    GX_SetGraphicsMode = Symbol([0xA1C8], [0x2076638], None, "", None)

    Gxs_SetGraphicsMode = Symbol([0xA230], [0x20766A0], None, "", None)

    GXx_SetMasterBrightness = Symbol([0xA24C], [0x20766BC], None, "", None)

    GX_InitGxState = Symbol([0xA274], [0x20766E4], None, "", None)
    ...
    GX_SetBankForBg = Symbol([0xA38C], [0x20767FC], None, "", None)

    GX_SetBankForObj = Symbol([0xA61C], [0x2076A8C], None, "", None)

    GX_SetBankForBgExtPltt = Symbol([0xA76C], [0x2076BDC], None, "", None)

    GX_SetBankForObjExtPltt = Symbol([0xA86C], [0x2076CDC], None, "", None)

    GX_SetBankForTex = Symbol([0xA918], [0x2076D88], None, "", None)

    GX_SetBankForTexPltt = Symbol([0xAAF0], [0x2076F60], None, "", None)

    GX_SetBankForClearImage = Symbol([0xABD8], [0x2077048], None, "", None)

    GX_SetBankForArm7 = Symbol([0xAD0C], [0x207717C], None, "", None)

    GX_SetBankForLcdc = Symbol([0xADB8], [0x2077228], None, "", None)

    GX_SetBankForSubBg = Symbol([0xADD8], [0x2077248], None, "", None)

    GX_SetBankForSubObj = Symbol([0xAE80], [0x20772F0], None, "", None)

    GX_SetBankForSubBgExtPltt = Symbol([0xAEF0], [0x2077360], None, "", None)

    GX_SetBankForSubObjExtPltt = Symbol([0xAF70], [0x20773E0], None, "", None)
    ...
    GX_ResetBankForBgExtPltt = Symbol([0xB024], [0x2077494], None, "", None)

    GX_ResetBankForObjExtPltt = Symbol([0xB048], [0x20774B8], None, "", None)

    GX_ResetBankForTex = Symbol([0xB06C], [0x20774DC], None, "", None)

    GX_ResetBankForTexPltt = Symbol([0xB080], [0x20774F0], None, "", None)

    GX_ResetBankForSubBgExtPltt = Symbol([0xB094], [0x2077504], None, "", None)

    GX_ResetBankForSubObjExtPltt = Symbol([0xB0BC], [0x207752C], None, "", None)

    DisableBankForX = Symbol([0xB0E4], [0x2077554], None, "", None)

    GX_DisableBankForBg = Symbol([0xB1C4], [0x2077634], None, "", None)

    GX_DisableBankForObj = Symbol([0xB1D8], [0x2077648], None, "", None)

    GX_DisableBankForBgExtPltt = Symbol([0xB1EC], [0x207765C], None, "", None)

    GX_DisableBankForObjExtPltt = Symbol([0xB210], [0x2077680], None, "", None)

    GX_DisableBankForTex = Symbol([0xB234], [0x20776A4], None, "", None)

    GX_DisableBankForTexPltt = Symbol([0xB248], [0x20776B8], None, "", None)

    GX_DisableBankForClearImage = Symbol([0xB25C], [0x20776CC], None, "", None)

    GX_DisableBankForArm7 = Symbol([0xB270], [0x20776E0], None, "", None)

    GX_DisableBankForLcdc = Symbol([0xB284], [0x20776F4], None, "", None)

    GX_DisableBankForSubBg = Symbol([0xB298], [0x2077708], None, "", None)

    GX_DisableBankForSubObj = Symbol([0xB2AC], [0x207771C], None, "", None)

    GX_DisableBankForSubBgExtPltt = Symbol([0xB2C0], [0x2077730], None, "", None)

    GX_DisableBankForSubObjExtPltt = Symbol([0xB2E8], [0x2077758], None, "", None)

    G2_GetBG0ScrPtr = Symbol([0xB310], [0x2077780], None, "", None)

    G2S_GetBG0ScrPtr = Symbol([0xB344], [0x20777B4], None, "", None)

    G2_GetBG1ScrPtr = Symbol([0xB364], [0x20777D4], None, "", None)

    G2S_GetBG1ScrPtr = Symbol([0xB398], [0x2077808], None, "", None)

    G2_GetBG2ScrPtr = Symbol([0xB3B8], [0x2077828], None, "", None)

    G2_GetBG3ScrPtr = Symbol([0xB43C], [0x20778AC], None, "", None)

    G2_GetBG0CharPtr = Symbol([0xB4C0], [0x2077930], None, "", None)

    G2S_GetBG0CharPtr = Symbol([0xB4F4], [0x2077964], None, "", None)

    G2_GetBG1CharPtr = Symbol([0xB514], [0x2077984], None, "", None)

    G2S_GetBG1CharPtr = Symbol([0xB548], [0x20779B8], None, "", None)

    G2_GetBG2CharPtr = Symbol([0xB568], [0x20779D8], None, "", None)

    G2_GetBG3CharPtr = Symbol([0xB5B8], [0x2077A28], None, "", None)

    G2x_SetBlendAlpha = Symbol([0xB610], [0x2077A80], None, "", None)

    G2x_SetBlendBrightness = Symbol([0xB62C], [0x2077A9C], None, "", None)

    G2x_ChangeBlendBrightness = Symbol([0xB654], [0x2077AC4], None, "", None)

    G3_LoadMtx44 = Symbol([0xB698], [0x2077B08], None, "", None)
    ...
    G3X_Init = Symbol([0xB6EC], [0x2077B5C], None, "", None)

    G3X_Reset = Symbol([0xB7F8], [0x2077C68], None, "", None)

    G3X_ClearFifo = Symbol([0xB864], [0x2077CD4], None, "", None)

    G3X_InitMtxStack = Symbol([0xB88C], [0x2077CFC], None, "", None)

    G3X_ResetMtxStack = Symbol([0xB924], [0x2077D94], None, "", None)

    G3X_SetClearColor = Symbol([0xB9B4], [0x2077E24], None, "", None)

    G3X_InitTable = Symbol([0xB9DC], [0x2077E4C], None, "", None)

    G3X_GetMtxStackLevelPV = Symbol([0xBA7C], [0x2077EEC], None, "", None)

    G3X_GetMtxStackLevelPJ = Symbol([0xBAAC], [0x2077F1C], None, "", None)

    GXi_NopClearFifo128 = Symbol([0xBADC], [0x2077F4C], None, "", None)

    G3i_OrthoW = Symbol([0xBB70], [0x2077FE0], None, "", None)

    G3i_LookAt = Symbol([0xBBD4], [0x2078044], None, "", None)

    GX_LoadBgPltt = Symbol([0xBC20], [0x2078090], None, "", None)

    Gxs_LoadBgPltt = Symbol([0xBC74], [0x20780E4], None, "", None)

    GX_LoadObjPltt = Symbol([0xBCCC], [0x207813C], None, "", None)

    Gxs_LoadObjPltt = Symbol([0xBD24], [0x2078194], None, "", None)

    GX_LoadOam = Symbol([0xBD7C], [0x20781EC], None, "", None)

    Gxs_LoadOam = Symbol([0xBDD0], [0x2078240], None, "", None)

    GX_LoadObj = Symbol([0xBE28], [0x2078298], None, "", None)

    Gxs_LoadObj = Symbol([0xBE80], [0x20782F0], None, "", None)

    GX_LoadBg0Scr = Symbol([0xBED8], [0x2078348], None, "", None)

    GX_LoadBg1Scr = Symbol([0xBF38], [0x20783A8], None, "", None)

    Gxs_LoadBg1Scr = Symbol([0xBF98], [0x2078408], None, "", None)

    GX_LoadBg2Scr = Symbol([0xBFF8], [0x2078468], None, "", None)

    GX_LoadBg3Scr = Symbol([0xC058], [0x20784C8], None, "", None)

    GX_LoadBg0Char = Symbol([0xC0B8], [0x2078528], None, "", None)

    Gxs_LoadBg0Char = Symbol([0xC118], [0x2078588], None, "", None)

    GX_LoadBg1Char = Symbol([0xC178], [0x20785E8], None, "", None)

    Gxs_LoadBg1Char = Symbol([0xC1D8], [0x2078648], None, "", None)

    GX_LoadBg2Char = Symbol([0xC238], [0x20786A8], None, "", None)

    GX_LoadBg3Char = Symbol([0xC298], [0x2078708], None, "", None)

    GX_BeginLoadBgExtPltt = Symbol([0xC2F8], [0x2078768], None, "", None)

    GX_EndLoadBgExtPltt = Symbol([0xC398], [0x2078808], None, "", None)

    GX_BeginLoadObjExtPltt = Symbol([0xC3E0], [0x2078850], None, "", None)

    GX_EndLoadObjExtPltt = Symbol([0xC428], [0x2078898], None, "", None)

    Gxs_BeginLoadBgExtPltt = Symbol([0xC46C], [0x20788DC], None, "", None)

    Gxs_EndLoadBgExtPltt = Symbol([0xC484], [0x20788F4], None, "", None)

    Gxs_BeginLoadObjExtPltt = Symbol([0xC4C4], [0x2078934], None, "", None)

    Gxs_EndLoadObjExtPltt = Symbol([0xC4DC], [0x207894C], None, "", None)

    GX_BeginLoadTex = Symbol([0xC51C], [0x207898C], None, "", None)

    GX_LoadTex = Symbol([0xC578], [0x20789E8], None, "", None)

    GX_EndLoadTex = Symbol([0xC6B8], [0x2078B28], None, "", None)

    GX_BeginLoadTexPltt = Symbol([0xC704], [0x2078B74], None, "", None)

    GX_LoadTexPltt = Symbol([0xC738], [0x2078BA8], None, "", None)

    GX_EndLoadTexPltt = Symbol([0xC7A4], [0x2078C14], None, "", None)
    ...
    GX_SendFifo64B = Symbol([0xC80C], [0x2078C7C], None, "", None)

    OS_GetLockID = Symbol([0xCF54], [0x20793C4], None, "", None)
...
class EuOverlay10Data:
    ...
    OREN_BERRY_DAMAGE = Symbol(
        [0x79D0], [0x22C4D90], 0x2, "Damage dealt by eating an Oren Berry.", "int16_t"
    )
    ...
    GOLD_THORN_POWER = Symbol(
        [0x7A68], [0x22C4E28], 0x2, "Attack power for Golden Thorns.", "int16_t"
    )
    ...
    STICK_POWER = Symbol(
        [0x7BBC], [0x22C4F7C], 0x2, "Attack power for Sticks.", "int16_t"
    )
    ...
    GEO_PEBBLE_DAMAGE = Symbol(
        [0x7C4C], [0x22C500C], 0x2, "Damage dealt by Geo Pebbles.", "int16_t"
    )

    GRAVELEROCK_DAMAGE = Symbol(
        [0x7C50], [0x22C5010], 0x2, "Damage dealt by Gravelerocks.", "int16_t"
    )

    RARE_FOSSIL_DAMAGE = Symbol(
        [0x7C54], [0x22C5014], 0x2, "Damage dealt by Rare Fossils.", "int16_t"
    )
    ...
    CORSOLA_TWIG_POWER = Symbol(
        [0x7C70], [0x22C5030], 0x2, "Attack power for Corsola Twigs.", "int16_t"
    )

    CACNEA_SPIKE_POWER = Symbol(
        [0x7C74], [0x22C5034], 0x2, "Attack power for Cacnea Spikes.", "int16_t"
    )

    GOLD_FANG_POWER = Symbol(
        [0x7C78], [0x22C5038], 0x2, "Attack power for Gold Fangs.", "int16_t"
    )

    SILVER_SPIKE_POWER = Symbol(
        [0x7C7C], [0x22C503C], 0x2, "Attack power for Silver Spikes.", "int16_t"
    )

    IRON_THORN_POWER = Symbol(
        [0x7C80], [0x22C5040], 0x2, "Attack power for Iron Thorns.", "int16_t"
    )
...
class EuOverlay11Functions:
    ...
    SsbLoad2 = Symbol([0x84BC], [0x22E503C], None, "", None)
    ...
    StationLoadHanger = Symbol([0x8994], [0x22E5514], None, "", None)

    ScriptStationLoadTalk = Symbol([0x91A4], [0x22E5D24], None, "", None)

    SsbLoad1 = Symbol([0x9B10], [0x22E6690], None, "", None)
...
class EuOverlay11Data:
    ...
    WORLD_MAP_MODE = Symbol(
        [0x48DA4], [0x2325924], 0x4, "The current world map", "uint32_t"
    )
...
class EuOverlay13Data:
    ...
    QUIZ_QUESTION_STRINGS = Symbol(
        [0x206C], [0x238CCEC], 0x84, "0x2 * (66 questions)", "uint16_t[66]"
    )
...
class EuOverlay14Functions:
    ...
    SentryState0 = Symbol([0x20A8], [0x238CD28], None, "No params.", None)

    SentryState1 = Symbol([0x20CC], [0x238CD4C], None, "No params.", None)

    SentryState2 = Symbol([0x2124], [0x238CDA4], None, "No params.", None)

    SentryState3 = Symbol([0x2148], [0x238CDC8], None, "No params.", None)

    SentryState4 = Symbol([0x2270], [0x238CEF0], None, "No params.", None)
    ...
    SentryState6 = Symbol([0x22A0], [0x238CF20], None, "No params.", None)
    ...
    SentryState8 = Symbol([0x22DC], [0x238CF5C], None, "No params.", None)

    SentryState9 = Symbol([0x2300], [0x238CF80], None, "No params.", None)
    ...
    SentryStateB = Symbol([0x233C], [0x238CFBC], None, "No params.", None)
    ...
    SentryStateF = Symbol([0x31C8], [0x238DE48], None, "No params.", None)

    SentryState10 = Symbol([0x31E0], [0x238DE60], None, "No params.", None)
    ...
    SentryState12 = Symbol([0x3270], [0x238DEF0], None, "No params.", None)
    ...
    SentryState15 = Symbol([0x32E8], [0x238DF68], None, "No params.", None)

    SentryState16 = Symbol([0x3328], [0x238DFA8], None, "No params.", None)
    ...
    SentryState18 = Symbol([0x33F8], [0x238E078], None, "No params.", None)
    ...
    SentryState1A = Symbol([0x3448], [0x238E0C8], None, "No params.", None)
    ...
    SentryState1D = Symbol([0x355C], [0x238E1DC], None, "No params.", None)
    ...
    SentryState1F = Symbol([0x35D8], [0x238E258], None, "No params.", None)
    ...
    SentryState21 = Symbol([0x366C], [0x238E2EC], None, "No params.", None)
...
class EuOverlay14Data:
    ...
    SENTRY_DEBUG_MENU_ITEMS = Symbol(
        [0x39C0], [0x238E640], 0x48, "", "struct simple_menu_id_item[9]"
    )
...
class EuOverlay15Data:
    ...
    BANK_MAIN_MENU_ITEMS = Symbol(
        [0xF40], [0x238BBC0], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class EuOverlay16Data:
    ...
    EVO_MENU_ITEMS_CONFIRM = Symbol(
        [0x2BCC], [0x238D84C], 0x18, "", "struct simple_menu_id_item[3]"
    )

    EVO_SUBMENU_ITEMS = Symbol(
        [0x2BE4], [0x238D864], 0x20, "", "struct simple_menu_id_item[4]"
    )

    EVO_MAIN_MENU_ITEMS = Symbol(
        [0x2C04], [0x238D884], 0x20, "", "struct simple_menu_id_item[4]"
    )
...
class EuOverlay17Data:
    ...
    ASSEMBLY_MENU_ITEMS_CONFIRM = Symbol(
        [0x1A44], [0x238C6C4], 0x18, "", "struct simple_menu_id_item[3]"
    )

    ASSEMBLY_MAIN_MENU_ITEMS_1 = Symbol(
        [0x1A5C], [0x238C6DC], 0x18, "", "struct simple_menu_id_item[3]"
    )

    ASSEMBLY_MAIN_MENU_ITEMS_2 = Symbol(
        [0x1A74], [0x238C6F4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    ASSEMBLY_SUBMENU_ITEMS_1 = Symbol(
        [0x1A94], [0x238C714], 0x28, "", "struct simple_menu_id_item[5]"
    )

    ASSEMBLY_SUBMENU_ITEMS_2 = Symbol(
        [0x1ABC], [0x238C73C], 0x30, "", "struct simple_menu_id_item[6]"
    )

    ASSEMBLY_SUBMENU_ITEMS_3 = Symbol(
        [0x1AEC], [0x238C76C], 0x30, "", "struct simple_menu_id_item[6]"
    )

    ASSEMBLY_SUBMENU_ITEMS_4 = Symbol(
        [0x1B1C], [0x238C79C], 0x38, "", "struct simple_menu_id_item[7]"
    )

    ASSEMBLY_SUBMENU_ITEMS_5 = Symbol(
        [0x1B54], [0x238C7D4], 0x38, "", "struct simple_menu_id_item[7]"
    )

    ASSEMBLY_SUBMENU_ITEMS_6 = Symbol(
        [0x1B8C], [0x238C80C], 0x38, "", "struct simple_menu_id_item[7]"
    )

    ASSEMBLY_SUBMENU_ITEMS_7 = Symbol(
        [0x1BC4], [0x238C844], 0x40, "", "struct simple_menu_id_item[8]"
    )
...
class EuOverlay18Data:
    ...
    LINK_SHOP_MENU_ITEMS_CONFIRM = Symbol(
        [0x31E0], [0x238DE60], 0x18, "", "struct simple_menu_id_item[3]"
    )

    LINK_SHOP_SUBMENU_ITEMS_1 = Symbol(
        [0x31F8], [0x238DE78], 0x20, "", "struct simple_menu_id_item[4]"
    )

    LINK_SHOP_SUBMENU_ITEMS_2 = Symbol(
        [0x3218], [0x238DE98], 0x20, "", "struct simple_menu_id_item[4]"
    )

    LINK_SHOP_MAIN_MENU_ITEMS = Symbol(
        [0x3238], [0x238DEB8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    LINK_SHOP_SUBMENU_ITEMS_3 = Symbol(
        [0x3258], [0x238DED8], 0x28, "", "struct simple_menu_id_item[5]"
    )

    LINK_SHOP_SUBMENU_ITEMS_4 = Symbol(
        [0x3280], [0x238DF00], 0x30, "", "struct simple_menu_id_item[6]"
    )

    LINK_SHOP_SUBMENU_ITEMS_5 = Symbol(
        [0x32B0], [0x238DF30], 0x48, "", "struct simple_menu_id_item[9]"
    )

    LINK_SHOP_SUBMENU_ITEMS_6 = Symbol(
        [0x32F8], [0x238DF78], 0x48, "", "struct simple_menu_id_item[9]"
    )

    LINK_SHOP_SUBMENU_ITEMS_7 = Symbol(
        [0x3340], [0x238DFC0], 0x48, "", "struct simple_menu_id_item[9]"
    )
...
class EuOverlay19Data:
    ...
    BAR_MENU_ITEMS_CONFIRM_1 = Symbol(
        [0x40BC], [0x238ED3C], 0x18, "", "struct simple_menu_id_item[3]"
    )

    BAR_MENU_ITEMS_CONFIRM_2 = Symbol(
        [0x40D4], [0x238ED54], 0x18, "", "struct simple_menu_id_item[3]"
    )
    ...
    BAR_MAIN_MENU_ITEMS = Symbol(
        [0x4104], [0x238ED84], 0x20, "", "struct simple_menu_id_item[4]"
    )

    BAR_SUBMENU_ITEMS_1 = Symbol(
        [0x4124], [0x238EDA4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    BAR_SUBMENU_ITEMS_2 = Symbol(
        [0x4144], [0x238EDC4], 0x30, "", "struct simple_menu_id_item[6]"
    )
...
class EuOverlay20Data:
    ...
    RECYCLE_MENU_ITEMS_CONFIRM_1 = Symbol(
        [0x2E44], [0x238DAC4], 0x18, "", "struct simple_menu_id_item[3]"
    )

    RECYCLE_MENU_ITEMS_CONFIRM_2 = Symbol(
        [0x2E5C], [0x238DADC], 0x18, "", "struct simple_menu_id_item[3]"
    )

    RECYCLE_SUBMENU_ITEMS_1 = Symbol(
        [0x2E74], [0x238DAF4], 0x18, "", "struct simple_menu_id_item[3]"
    )

    RECYCLE_SUBMENU_ITEMS_2 = Symbol(
        [0x2E8C], [0x238DB0C], 0x20, "", "struct simple_menu_id_item[4]"
    )

    RECYCLE_MAIN_MENU_ITEMS_1 = Symbol(
        [0x2EAC], [0x238DB2C], 0x28, "", "struct simple_menu_id_item[5]"
    )
    ...
    RECYCLE_MAIN_MENU_ITEMS_2 = Symbol(
        [0x2F48], [0x238DBC8], 0x20, "", "struct simple_menu_id_item[4]"
    )
    ...
    RECYCLE_MAIN_MENU_ITEMS_3 = Symbol(
        [0x2FB8], [0x238DC38], 0x18, "", "struct simple_menu_id_item[3]"
    )
...
class EuOverlay21Data:
    ...
    SWAP_SHOP_MENU_ITEMS_CONFIRM = Symbol(
        [0x28F8], [0x238D578], 0x18, "", "struct simple_menu_id_item[3]"
    )

    SWAP_SHOP_SUBMENU_ITEMS_1 = Symbol(
        [0x2910], [0x238D590], 0x18, "", "struct simple_menu_id_item[3]"
    )

    SWAP_SHOP_SUBMENU_ITEMS_2 = Symbol(
        [0x2928], [0x238D5A8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SWAP_SHOP_MAIN_MENU_ITEMS_1 = Symbol(
        [0x2948], [0x238D5C8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SWAP_SHOP_MAIN_MENU_ITEMS_2 = Symbol(
        [0x2968], [0x238D5E8], 0x28, "", "struct simple_menu_id_item[5]"
    )

    SWAP_SHOP_SUBMENU_ITEMS_3 = Symbol(
        [0x2990], [0x238D610], 0x30, "", "struct simple_menu_id_item[6]"
    )
...
class EuOverlay22Data:
    ...
    SHOP_MENU_ITEMS_CONFIRM = Symbol(
        [0x4728], [0x238F3A8], 0x18, "", "struct simple_menu_id_item[3]"
    )

    SHOP_MAIN_MENU_ITEMS_1 = Symbol(
        [0x4740], [0x238F3C0], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SHOP_MAIN_MENU_ITEMS_2 = Symbol(
        [0x4760], [0x238F3E0], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SHOP_MAIN_MENU_ITEMS_3 = Symbol(
        [0x4780], [0x238F400], 0x30, "", "struct simple_menu_id_item[6]"
    )
...
class EuOverlay23Data:
    ...
    STORAGE_MENU_ITEMS_CONFIRM = Symbol(
        [0x31BC], [0x238DE3C], 0x18, "", "struct simple_menu_id_item[3]"
    )

    STORAGE_MAIN_MENU_ITEMS_1 = Symbol(
        [0x31D4], [0x238DE54], 0x20, "", "struct simple_menu_id_item[4]"
    )

    STORAGE_MAIN_MENU_ITEMS_2 = Symbol(
        [0x31F4], [0x238DE74], 0x20, "", "struct simple_menu_id_item[4]"
    )

    STORAGE_MAIN_MENU_ITEMS_3 = Symbol(
        [0x3214], [0x238DE94], 0x20, "", "struct simple_menu_id_item[4]"
    )

    STORAGE_MAIN_MENU_ITEMS_4 = Symbol(
        [0x3234], [0x238DEB4], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class EuOverlay24Data:
    ...
    DAYCARE_MENU_ITEMS_CONFIRM = Symbol(
        [0x23E0], [0x238D060], 0x18, "", "struct simple_menu_id_item[3]"
    )

    DAYCARE_MAIN_MENU_ITEMS = Symbol(
        [0x23F8], [0x238D078], 0x20, "", "struct simple_menu_id_item[4]"
    )
...
class EuOverlay25Data:
    ...
    APPRAISAL_MENU_ITEMS_CONFIRM = Symbol(
        [0x1374], [0x238BFF4], 0x18, "", "struct simple_menu_id_item[3]"
    )

    APPRAISAL_MAIN_MENU_ITEMS = Symbol(
        [0x138C], [0x238C00C], 0x20, "", "struct simple_menu_id_item[4]"
    )

    APPRAISAL_SUBMENU_ITEMS = Symbol(
        [0x13AC], [0x238C02C], 0x20, "", "struct simple_menu_id_item[4]"
    )
...
class EuOverlay27Data:
    ...
    DISCARD_ITEMS_MENU_ITEMS_CONFIRM = Symbol(
        [0x281C], [0x238D49C], 0x18, "", "struct simple_menu_id_item[3]"
    )

    DISCARD_ITEMS_SUBMENU_ITEMS_1 = Symbol(
        [0x2834], [0x238D4B4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DISCARD_ITEMS_SUBMENU_ITEMS_2 = Symbol(
        [0x2854], [0x238D4D4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DISCARD_ITEMS_MAIN_MENU_ITEMS = Symbol(
        [0x2874], [0x238D4F4], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class EuOverlay29Functions:
    ...
    GetDungeonGenInfoUnk0C = Symbol(
        [0x5C8D0], [0x2339450], None, "return: dungeon_generation_info::field_0xc", None
    )
    ...
    DisplayMessage2 = Symbol(
        [0x7132C], [0x234DEAC], None, "Very similar to DisplayMessage", None
    )
...
class EuOverlay31Data:
    ...
    DUNGEON_MAIN_MENU_ITEMS = Symbol(
        [0x75D8], [0x238A9F8], 0x40, "", "struct simple_menu_id_item[8]"
    )
    ...
    DUNGEON_SUBMENU_ITEMS_1 = Symbol(
        [0x7674], [0x238AA94], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DUNGEON_SUBMENU_ITEMS_2 = Symbol(
        [0x7694], [0x238AAB4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DUNGEON_SUBMENU_ITEMS_3 = Symbol(
        [0x76B4], [0x238AAD4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DUNGEON_SUBMENU_ITEMS_4 = Symbol(
        [0x76D4], [0x238AAF4], 0x20, "", "struct simple_menu_id_item[4]"
    )
    ...
    DUNGEON_SUBMENU_ITEMS_5 = Symbol(
        [0x7920], [0x238AD40], 0x18, "", "struct simple_menu_id_item[3]"
    )
    ...
    DUNGEON_SUBMENU_ITEMS_6 = Symbol(
        [0x79A4], [0x238ADC4], 0x48, "", "struct simple_menu_id_item[9]"
    )
...
class EuOverlay34Data:
    ...
    START_MENU_ITEMS_CONFIRM = Symbol(
        [0xD4C], [0x22DD8CC], 0x18, "", "struct simple_menu_id_item[3]"
    )
    ...
    DUNGEON_DEBUG_MENU_ITEMS = Symbol(
        [0xD74], [0x22DD8F4], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class EuRamData:
    ...
    BAG_ITEMS_PTR = Symbol(
        [0x2A44E8], [0x22A44E8], 0x4, "Pointer to BAG_ITEMS.", "struct item*"
    )
    ...
    DISP_MODE = Symbol([0x2B9EC8], [0x22B9EC8], 0x2, "", "uint16_t")

    GXI_VRAM_LOCK_ID = Symbol([0x2B9ECA], [0x22B9ECA], 0x2, "", "uint16_t")
    ...
    SUB_BG_EXT_PLTT = Symbol([0x2B9EE8], [0x22B9EE8], 0x4, "", "undefined4")

    CLR_IMG = Symbol([0x2B9F04], [0x22B9F04], 0x4, "", "undefined4")
