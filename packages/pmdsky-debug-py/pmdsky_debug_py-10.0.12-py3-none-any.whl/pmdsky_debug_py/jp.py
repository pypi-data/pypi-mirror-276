...
class JpArm9Data:
    ...
    AURA_BOW_ID_LAST = Symbol(
        [0xCC34], [0x200CC34], None, "Highest item ID of the aura bows.", "enum item_id"
    )
    ...
    SPECIAL_BAND_STAT_BOOST = Symbol(
        [0xA2C40], [0x20A2C40], 0x2, "Stat boost value for the Special Band.", "int16_t"
    )

    MUNCH_BELT_STAT_BOOST = Symbol(
        [0xA2C50], [0x20A2C50], 0x2, "Stat boost value for the Munch Belt.", "int16_t"
    )
    ...
    MIN_IQ_EXCLUSIVE_MOVE_USER = Symbol([0xA2C60], [0x20A2C60], 0x4, "", "int32_t")

    WONDER_GUMMI_IQ_GAIN = Symbol(
        [0xA2C64], [0x20A2C64], 0x2, "IQ gain when ingesting wonder gummis.", "int16_t"
    )

    AURA_BOW_STAT_BOOST = Symbol(
        [0xA2C6C], [0x20A2C6C], 0x2, "Stat boost value for the aura bows.", "int16_t"
    )

    MIN_IQ_ITEM_MASTER = Symbol([0xA2C78], [0x20A2C78], 0x4, "", "int32_t")
    ...
    POWER_BAND_STAT_BOOST = Symbol(
        [0xA2C80], [0x20A2C80], 0x2, "Stat boost value for the Power Band.", "int16_t"
    )
    ...
    ZINC_BAND_STAT_BOOST = Symbol(
        [0xA2C88], [0x20A2C88], 0x2, "Stat boost value for the Zinc Band.", "int16_t"
    )
    ...
    TACTICS_UNLOCK_LEVEL_TABLE = Symbol(
        [0xA2D14], [0x20A2D14], 0x18, "type: int16_t[12]", "int16_t[12]"
    )
    ...
    IQ_GROUP_SKILLS = Symbol(
        [0xA3164], [0x20A3164], 0x190, "Irdkwia's notes: 25*16*0x1", "uint8_t[400]"
    )
    ...
    IQ_GUMMI_GAIN_TABLE = Symbol(
        [0xA3684], [0x20A3684], 0x288, "type: int16_t[18][18]", "int16_t[18]"
    )

    GUMMI_BELLY_RESTORE_TABLE = Symbol(
        [0xA390C], [0x20A390C], 0x288, "type: int16_t[18][18]", "int16_t[18]"
    )
    ...
    RANK_UP_TABLE = Symbol(
        [0xA3F18], [0x20A3F18], 0xD0, "", "struct rankup_table_entry[13]"
    )
    ...
    MONSTER_SPRITE_DATA = Symbol([0xA40DC], [0x20A40DC], 0x4B0, "", "undefined[1200]")
...
class JpLibsFunctions:
    ...
    DseDriver_LoadDefaultSettings = Symbol([0xE8], [0x206C4A8], None, "", None)
    ...
    DseDriver_ConfigureHeap = Symbol([0x264], [0x206C624], None, "", None)

    DseDriver_Init = Symbol([0x308], [0x206C6C8], None, "", None)

    Dse_SetError = Symbol([0x77C], [0x206CB3C], None, "", None)

    Dse_SetError2 = Symbol([0x7B0], [0x206CB70], None, "", None)

    DseUtil_ByteSwap32 = Symbol([0x7EC], [0x206CBAC], None, "", None)
    ...
    DseMem_Init = Symbol([0x844], [0x206CC04], None, "", None)

    DseMem_Quit = Symbol([0x8B4], [0x206CC74], None, "", None)

    DseMem_AllocateUser = Symbol(None, None, None, "", None)

    DseMem_Allocate = Symbol([0x8E4], [0x206CCA4], None, "", None)

    DseMem_AllocateThreadStack = Symbol([0x9F4], [0x206CDB4], None, "", None)

    DseMem_Free = Symbol([0xB3C], [0x206CEFC], None, "", None)

    DseMem_Clear = Symbol([0xBE4], [0x206CFA4], None, "", None)

    DseFile_CheckHeader = Symbol([0xC44], [0x206D004], None, "", None)

    DseSwd_SysInit = Symbol([0xCC4], [0x206D084], None, "", None)

    DseSwd_SysQuit = Symbol([0xD50], [0x206D110], None, "", None)

    DseSwd_SampleLoaderMain = Symbol([0xD90], [0x206D150], None, "", None)

    DseSwd_MainBankDummyCallback = Symbol([0xDF0], [0x206D1B0], None, "", None)

    DseSwd_LoadMainBank = Symbol([0xDF8], [0x206D1B8], None, "", None)

    DseSwd_LoadBank = Symbol([0x1030], [0x206D3F0], None, "", None)

    DseSwd_IsBankLoading = Symbol([0x1234], [0x206D5F4], None, "", None)

    DseSwd_LoadWaves = Symbol([0x1250], [0x206D610], None, "", None)

    DseSwd_LoadWavesInternal = Symbol([0x1300], [0x206D6C0], None, "", None)

    DseSwd_Unload = Symbol([0x140C], [0x206D7CC], None, "", None)
    ...
    DseSwd_GetInstrument = Symbol([0x14B8], [0x206D878], None, "", None)

    DseSwd_GetNextSplitInRange = Symbol([0x14F0], [0x206D8B0], None, "", None)

    DseSwd_GetMainBankById = Symbol([0x1578], [0x206D938], None, "", None)

    DseSwd_GetBankById = Symbol([0x15C8], [0x206D988], None, "", None)

    DseSwd_InitMainBankFileReader = Symbol([0x1618], [0x206D9D8], None, "", None)

    DseSwd_OpenMainBankFileReader = Symbol([0x1628], [0x206D9E8], None, "", None)

    DseSwd_CloseMainBankFileReader = Symbol([0x1654], [0x206DA14], None, "", None)

    DseSwd_ReadMainBank = Symbol([0x1664], [0x206DA24], None, "", None)

    DseBgm_DefaultSignalCallback = Symbol([0x1728], [0x206DAE8], None, "", None)

    DseBgm_Load = Symbol([0x1730], [0x206DAF0], None, "", None)

    DseBgm_Unload = Symbol([0x1834], [0x206DBF4], None, "", None)

    DseBgm_SetSignalCallback = Symbol([0x186C], [0x206DC2C], None, "", None)

    DseBgm_IsPlaying = Symbol([0x18CC], [0x206DC8C], None, "", None)
    ...
    DseBgm_Stop = Symbol([0x19C4], [0x206DD84], None, "", None)

    DseBgm_StopAll = Symbol([0x1A04], [0x206DDC4], None, "", None)

    DseBgm_SetFades = Symbol([0x1A64], [0x206DE24], None, "", None)

    DseSequence_Start = Symbol([0x1AA4], [0x206DE64], None, "", None)

    DseSequence_PauseList = Symbol([0x1B34], [0x206DEF4], None, "", None)

    DseSequence_SetFades = Symbol([0x1C98], [0x206E058], None, "", None)

    DseSequence_GetParameter = Symbol([0x1F8C], [0x206E34C], None, "", None)

    DseSequence_GetSmallestNumLoops = Symbol([0x2140], [0x206E500], None, "", None)

    DseSequence_Reset = Symbol([0x2194], [0x206E554], None, "", None)

    DseSequence_Stop = Symbol([0x22EC], [0x206E6AC], None, "", None)
    ...
    DseSequence_LoadSong = Symbol([0x247C], [0x206E83C], None, "", None)

    DseSequence_GetById = Symbol([0x257C], [0x206E93C], None, "", None)

    DseSequence_AllocateNew = Symbol([0x25C8], [0x206E988], None, "", None)

    DseSequence_Unload = Symbol([0x2700], [0x206EAC0], None, "", None)

    DseSequence_InitTracks = Symbol([0x2784], [0x206EB44], None, "", None)

    DseBgm_SysSetupNoteList = Symbol([0x27D4], [0x206EB94], None, "", None)

    DseSe_SysReset = Symbol([0x2848], [0x206EC08], None, "", None)

    DseSe_Load = Symbol([0x2940], [0x206ED00], None, "", None)

    DseSe_Unload = Symbol([0x2AF4], [0x206EEB4], None, "", None)

    DseSe_GetUsedBankIDs = Symbol([0x2B84], [0x206EF44], None, "", None)

    DseSe_HasPlayingInstances = Symbol([0x2C58], [0x206F018], None, "", None)

    DseSe_Play = Symbol([0x2D24], [0x206F0E4], None, "", None)

    DseSe_GetEffectSong = Symbol([0x2ED8], [0x206F298], None, "", None)

    DseSe_CheckTooManyInstances = Symbol([0x2F20], [0x206F2E0], None, "", None)

    DseSe_CheckTooManyInstancesInGroup = Symbol([0x3028], [0x206F3E8], None, "", None)

    DseSe_GetBestSeqAllocation = Symbol([0x31EC], [0x206F5AC], None, "", None)

    DseSe_GetById = Symbol([0x3268], [0x206F628], None, "", None)

    DseSe_Stop = Symbol([0x32B4], [0x206F674], None, "", None)

    DseSe_StopAll = Symbol([0x3408], [0x206F7C8], None, "", None)

    DseSe_StopSeq = Symbol([0x3474], [0x206F834], None, "", None)
    ...
    DseDriver_StartMainThread = Symbol([0x4D34], [0x20710F4], None, "", None)

    DseDriver_StartTickTimer = Symbol([0x4E04], [0x20711C4], None, "", None)

    DseDriver_NotifyTick = Symbol([0x4EFC], [0x20712BC], None, "", None)

    DseDriver_Main = Symbol([0x4F3C], [0x20712FC], None, "", None)

    DseSequence_TickNotes = Symbol([0x5088], [0x2071448], None, "", None)
    ...
    DseSequence_TickFades = Symbol([0x56AC], [0x2071A6C], None, "", None)

    DseTrackEvent_Invalid = Symbol([0x5844], [0x2071C04], None, "", None)

    DseTrackEvent_WaitSame = Symbol([0x5850], [0x2071C10], None, "", None)

    DseTrackEvent_WaitDelta = Symbol([0x585C], [0x2071C1C], None, "", None)

    DseTrackEvent_Wait8 = Symbol([0x5874], [0x2071C34], None, "", None)

    DseTrackEvent_Wait16 = Symbol([0x5884], [0x2071C44], None, "", None)

    DseTrackEvent_Wait24 = Symbol([0x58A0], [0x2071C60], None, "", None)

    DseTrackEvent_WaitUntilFadeout = Symbol([0x58C4], [0x2071C84], None, "", None)

    DseTrackEvent_EndTrack = Symbol([0x58F0], [0x2071CB0], None, "", None)

    DseTrackEvent_MainLoopBegin = Symbol([0x593C], [0x2071CFC], None, "", None)

    DseTrackEvent_SubLoopBegin = Symbol([0x5944], [0x2071D04], None, "", None)

    DseTrackEvent_SubLoopEnd = Symbol([0x5984], [0x2071D44], None, "", None)

    DseTrackEvent_SubLoopBreakOnLastIteration = Symbol(
        [0x59C0], [0x2071D80], None, "", None
    )

    DseTrackEvent_SetOctave = Symbol([0x59E8], [0x2071DA8], None, "", None)

    DseTrackEvent_OctaveDelta = Symbol([0x59F4], [0x2071DB4], None, "", None)

    DseTrackEvent_SetBpm = Symbol([0x5A08], [0x2071DC8], None, "", None)

    DseTrackEvent_SetBpm2 = Symbol([0x5A48], [0x2071E08], None, "", None)

    DseTrackEvent_SetBank = Symbol([0x5A88], [0x2071E48], None, "", None)

    DseTrackEvent_SetBankMsb = Symbol([0x5AB4], [0x2071E74], None, "", None)

    DseTrackEvent_SetBankLsb = Symbol([0x5AE4], [0x2071EA4], None, "", None)

    DseTrackEvent_Dummy1Byte = Symbol([0x5B14], [0x2071ED4], None, "", None)

    DseTrackEvent_SetInstrument = Symbol([0x5B1C], [0x2071EDC], None, "", None)

    DseTrackEvent_SongVolumeFade = Symbol([0x5B64], [0x2071F24], None, "", None)

    DseTrackEvent_RestoreEnvelopeDefaults = Symbol(
        [0x5BF0], [0x2071FB0], None, "", None
    )

    DseTrackEvent_SetEnvelopeAttackBegin = Symbol([0x5C08], [0x2071FC8], None, "", None)

    DseTrackEvent_SetEnvelopeAttackTime = Symbol([0x5C28], [0x2071FE8], None, "", None)

    DseTrackEvent_SetEnvelopeHoldTime = Symbol([0x5C48], [0x2072008], None, "", None)

    DseTrackEvent_SetEnvelopeDecayTimeAndSustainLevel = Symbol(
        [0x5C68], [0x2072028], None, "", None
    )

    DseTrackEvent_SetEnvelopeSustainTime = Symbol([0x5C98], [0x2072058], None, "", None)

    DseTrackEvent_SetEnvelopeReleaseTime = Symbol([0x5CB8], [0x2072078], None, "", None)

    DseTrackEvent_SetNoteDurationMultiplier = Symbol(
        [0x5CD8], [0x2072098], None, "", None
    )

    DseTrackEvent_ForceLfoEnvelopeLevel = Symbol([0x5CE4], [0x20720A4], None, "", None)

    DseTrackEvent_SetHoldNotes = Symbol([0x5D00], [0x20720C0], None, "", None)

    DseTrackEvent_SetFlagBit1Unknown = Symbol([0x5D38], [0x20720F8], None, "", None)

    DseTrackEvent_SetOptionalVolume = Symbol([0x5D48], [0x2072108], None, "", None)

    DseTrackEvent_Dummy2Bytes = Symbol([0x5D54], [0x2072114], None, "", None)

    DseTrackEvent_SetTuning = Symbol([0x5D5C], [0x207211C], None, "", None)

    DseTrackEvent_TuningDeltaCoarse = Symbol([0x5DDC], [0x207219C], None, "", None)

    DseTrackEvent_TuningDeltaFine = Symbol([0x5E64], [0x2072224], None, "", None)

    DseTrackEvent_TuningDeltaFull = Symbol([0x5EEC], [0x20722AC], None, "", None)

    DseTrackEvent_TuningFade = Symbol([0x5F7C], [0x207233C], None, "", None)

    DseTrackEvent_SetNoteRandomRegion = Symbol([0x606C], [0x207242C], None, "", None)

    DseTrackEvent_SetTuningJitterAmplitude = Symbol(
        [0x6094], [0x2072454], None, "", None
    )

    DseTrackEvent_SetKeyBend = Symbol([0x60AC], [0x207246C], None, "", None)

    DseTrackEvent_SetUnknown2 = Symbol([0x60D8], [0x2072498], None, "", None)

    DseTrackEvent_SetKeyBendRange = Symbol([0x60F0], [0x20724B0], None, "", None)

    DseTrackEvent_SetupKeyBendLfo = Symbol([0x60FC], [0x20724BC], None, "", None)

    DseTrackEvent_SetupKeyBendLfoEnvelope = Symbol(
        [0x6154], [0x2072514], None, "", None
    )

    DseTrackEvent_UseKeyBendLfo = Symbol([0x617C], [0x207253C], None, "", None)

    DseTrackEvent_SetVolume = Symbol([0x61A4], [0x2072564], None, "", None)

    DseTrackEvent_VolumeDelta = Symbol([0x6238], [0x20725F8], None, "", None)

    DseTrackEvent_VolumeFade = Symbol([0x62E8], [0x20726A8], None, "", None)

    DseTrackEvent_SetExpression = Symbol([0x6344], [0x2072704], None, "", None)

    DseTrackEvent_SetupVolumeLfo = Symbol([0x63D0], [0x2072790], None, "", None)

    DseTrackEvent_SetupVolumeLfoEnvelope = Symbol([0x642C], [0x20727EC], None, "", None)

    DseTrackEvent_UseVolumeLfo = Symbol([0x6454], [0x2072814], None, "", None)

    DseTrackEvent_SetPan = Symbol([0x647C], [0x207283C], None, "", None)

    DseTrackEvent_PanDelta = Symbol([0x64FC], [0x20728BC], None, "", None)

    DseTrackEvent_PanFade = Symbol([0x6590], [0x2072950], None, "", None)

    DseTrackEvent_SetupPanLfo = Symbol([0x65EC], [0x20729AC], None, "", None)

    DseTrackEvent_SetupPanLfoEnvelope = Symbol([0x6648], [0x2072A08], None, "", None)

    DseTrackEvent_UsePanLfo = Symbol([0x6670], [0x2072A30], None, "", None)

    DseTrackEvent_SetupLfo = Symbol([0x6698], [0x2072A58], None, "", None)

    DseTrackEvent_SetupLfoEnvelope = Symbol([0x66F0], [0x2072AB0], None, "", None)

    DseTrackEvent_SetLfoParameter = Symbol([0x6724], [0x2072AE4], None, "", None)

    DseTrackEvent_UseLfo = Symbol([0x6860], [0x2072C20], None, "", None)

    DseTrackEvent_Signal = Symbol([0x6894], [0x2072C54], None, "", None)

    DseTrackEvent_Dummy2Bytes2 = Symbol([0x68C4], [0x2072C84], None, "", None)

    DseSynth_Reset = Symbol([0x7130], [0x20734F0], None, "", None)

    DseSynth_AllocateNew = Symbol([0x71A8], [0x2073568], None, "", None)

    DseSynth_Unload = Symbol([0x7278], [0x2073638], None, "", None)

    DseSynth_ClearHeldNotes = Symbol([0x72E4], [0x20736A4], None, "", None)

    DseSynth_ResetAndSetBankAndSequence = Symbol([0x7380], [0x2073740], None, "", None)

    DseSynth_StopChannels = Symbol([0x73A8], [0x2073768], None, "", None)

    DseSynth_ResetAllVoiceTimersAndVolumes = Symbol(
        [0x73D4], [0x2073794], None, "", None
    )

    DseSynth_RestoreHeldNotes = Symbol([0x742C], [0x20737EC], None, "", None)

    DseSynth_SetGlobalVolumeIndex = Symbol([0x7494], [0x2073854], None, "", None)

    DseSynth_SetBend = Symbol([0x757C], [0x207393C], None, "", None)

    DseSynth_SetVolume = Symbol([0x7610], [0x20739D0], None, "", None)

    DseSynth_SetPan = Symbol([0x76E0], [0x2073AA0], None, "", None)

    DseSynth_SetBankAndSequence = Symbol([0x7774], [0x2073B34], None, "", None)

    DseChannel_Init = Symbol([0x7804], [0x2073BC4], None, "", None)

    DseChannel_DeallocateVoices = Symbol([0x79B8], [0x2073D78], None, "", None)

    DseChannel_ResetTimerAndVolumeForVoices = Symbol(
        [0x7A3C], [0x2073DFC], None, "", None
    )

    DseChannel_SetBank = Symbol([0x7AB8], [0x2073E78], None, "", None)

    DseChannel_SetInstrument = Symbol([0x7AF0], [0x2073EB0], None, "", None)

    DseChannel_SetLfoConstEnvelopeLevel = Symbol([0x7B84], [0x2073F44], None, "", None)

    DseChannel_SetKeyBend = Symbol([0x7BB8], [0x2073F78], None, "", None)

    DseChannel_AllocateNote = Symbol([0x7C00], [0x2073FC0], None, "", None)

    DseChannel_ReleaseNoteInternal = Symbol([0x7C90], [0x2074050], None, "", None)

    DseChannel_ChangeNote = Symbol([0x7D38], [0x20740F8], None, "", None)

    DseChannel_ReleaseNote = Symbol([0x7DC8], [0x2074188], None, "", None)

    DseVoice_PlayNote = Symbol([0x7E04], [0x20741C4], None, "", None)

    DseVoice_ReleaseNote = Symbol([0x8078], [0x2074438], None, "", None)

    DseVoice_UpdateParameters = Symbol([0x80BC], [0x207447C], None, "", None)

    DseVoice_ResetAll = Symbol([0x8260], [0x2074620], None, "", None)

    DseVoice_ResetHW = Symbol([0x8304], [0x20746C4], None, "", None)
    ...
    DseVoice_Cleanup = Symbol([0x84A4], [0x2074864], None, "", None)

    DseVoice_Allocate = Symbol([0x8540], [0x2074900], None, "", None)

    DseVoice_Start = Symbol([0x86A8], [0x2074A68], None, "", None)

    DseVoice_ReleaseHeld = Symbol([0x8704], [0x2074AC4], None, "", None)

    DseVoice_Release = Symbol([0x8784], [0x2074B44], None, "", None)

    DseVoice_Deallocate = Symbol([0x87C8], [0x2074B88], None, "", None)

    DseVoice_FlagForActivation = Symbol([0x88CC], [0x2074C8C], None, "", None)

    DseVoice_FlagForDeactivation = Symbol([0x891C], [0x2074CDC], None, "", None)

    DseVoice_CountNumActiveInChannel = Symbol([0x8954], [0x2074D14], None, "", None)

    DseVoice_UpdateHardware = Symbol([0x8980], [0x2074D40], None, "", None)

    SoundEnvelope_Reset = Symbol(
        [0x8B98], [0x2074F58], None, "r0: Sound envelope pointer", None
    )

    SoundEnvelopeParameters_Reset = Symbol(
        [0x8BAC], [0x2074F6C], None, "r0: Sound envelope parameters pointer", None
    )

    SoundEnvelopeParameters_CheckValidity = Symbol(
        [0x8BC8], [0x2074F88], None, "r0: Sound envelope parameters pointer", None
    )
    ...
    SoundEnvelope_Release = Symbol(
        [0x8E00], [0x20751C0], None, "r0: Sound envelope pointer", None
    )

    SoundEnvelope_Stop = Symbol(
        [0x8E2C], [0x20751EC], None, "r0: Sound envelope pointer", None
    )
    ...
    SoundEnvelope_Stop2 = Symbol(
        [0x8E64], [0x2075224], None, "r0: Sound envelope pointer", None
    )
    ...
    SoundLfoBank_Reset = Symbol(
        [0x8FC4], [0x2075384], None, "r0: LFO bank pointer", None
    )
    ...
    Crypto_RC4Init = Symbol([0x9648], [0x2075A08], None, "", None)

    Mtx_LookAt = Symbol([0x9750], [0x2075B10], None, "", None)

    Mtx_OrthoW = Symbol([0x9858], [0x2075C18], None, "", None)

    FX_Div = Symbol([0x9A60], [0x2075E20], None, "", None)

    FX_GetDivResultFx64c = Symbol([0x9A70], [0x2075E30], None, "", None)

    FX_GetDivResult = Symbol([0x9A94], [0x2075E54], None, "", None)

    FX_InvAsync = Symbol([0x9ACC], [0x2075E8C], None, "", None)

    FX_DivAsync = Symbol([0x9AFC], [0x2075EBC], None, "", None)

    FX_DivS32 = Symbol([0x9B24], [0x2075EE4], None, "", None)

    FX_ModS32 = Symbol([0x9B60], [0x2075F20], None, "", None)

    Vec_DotProduct = Symbol([0x9B9C], [0x2075F5C], None, "", None)

    Vec_CrossProduct = Symbol([0x9BD8], [0x2075F98], None, "", None)

    Vec_Normalize = Symbol([0x9C5C], [0x207601C], None, "", None)

    Vec_Distance = Symbol([0x9D74], [0x2076134], None, "", None)

    FX_Atan2Idx = Symbol([0x9DF0], [0x20761B0], None, "", None)

    GX_Init = Symbol([0x9F9C], [0x207635C], None, "", None)

    GX_HBlankIntr = Symbol([0xA0E8], [0x20764A8], None, "", None)

    GX_VBlankIntr = Symbol([0xA110], [0x20764D0], None, "", None)

    GX_DispOff = Symbol([0xA144], [0x2076504], None, "", None)

    GX_DispOn = Symbol([0xA180], [0x2076540], None, "", None)

    GX_SetGraphicsMode = Symbol([0xA1C8], [0x2076588], None, "", None)

    Gxs_SetGraphicsMode = Symbol([0xA230], [0x20765F0], None, "", None)

    GXx_SetMasterBrightness = Symbol([0xA24C], [0x207660C], None, "", None)

    GX_InitGxState = Symbol([0xA274], [0x2076634], None, "", None)
    ...
    GX_SetBankForBg = Symbol([0xA38C], [0x207674C], None, "", None)

    GX_SetBankForObj = Symbol([0xA61C], [0x20769DC], None, "", None)

    GX_SetBankForBgExtPltt = Symbol([0xA76C], [0x2076B2C], None, "", None)

    GX_SetBankForObjExtPltt = Symbol([0xA86C], [0x2076C2C], None, "", None)

    GX_SetBankForTex = Symbol([0xA918], [0x2076CD8], None, "", None)

    GX_SetBankForTexPltt = Symbol([0xAAF0], [0x2076EB0], None, "", None)

    GX_SetBankForClearImage = Symbol([0xABD8], [0x2076F98], None, "", None)

    GX_SetBankForArm7 = Symbol([0xAD0C], [0x20770CC], None, "", None)

    GX_SetBankForLcdc = Symbol([0xADB8], [0x2077178], None, "", None)

    GX_SetBankForSubBg = Symbol([0xADD8], [0x2077198], None, "", None)

    GX_SetBankForSubObj = Symbol([0xAE80], [0x2077240], None, "", None)

    GX_SetBankForSubBgExtPltt = Symbol([0xAEF0], [0x20772B0], None, "", None)

    GX_SetBankForSubObjExtPltt = Symbol([0xAF70], [0x2077330], None, "", None)
    ...
    DisableBankForX = Symbol([0xB0E4], [0x20774A4], None, "", None)
    ...
    G2_GetBG0ScrPtr = Symbol([0xB310], [0x20776D0], None, "", None)

    G2S_GetBG0ScrPtr = Symbol([0xB344], [0x2077704], None, "", None)

    G2_GetBG1ScrPtr = Symbol([0xB364], [0x2077724], None, "", None)

    G2S_GetBG1ScrPtr = Symbol([0xB398], [0x2077758], None, "", None)

    G2_GetBG2ScrPtr = Symbol([0xB3B8], [0x2077778], None, "", None)

    G2_GetBG3ScrPtr = Symbol([0xB43C], [0x20777FC], None, "", None)

    G2_GetBG0CharPtr = Symbol([0xB4C0], [0x2077880], None, "", None)

    G2S_GetBG0CharPtr = Symbol([0xB4F4], [0x20778B4], None, "", None)

    G2_GetBG1CharPtr = Symbol([0xB514], [0x20778D4], None, "", None)

    G2S_GetBG1CharPtr = Symbol([0xB548], [0x2077908], None, "", None)

    G2_GetBG2CharPtr = Symbol([0xB568], [0x2077928], None, "", None)

    G2_GetBG3CharPtr = Symbol([0xB5B8], [0x2077978], None, "", None)

    G2x_SetBlendAlpha = Symbol([0xB610], [0x20779D0], None, "", None)

    G2x_SetBlendBrightness = Symbol([0xB62C], [0x20779EC], None, "", None)

    G2x_ChangeBlendBrightness = Symbol([0xB654], [0x2077A14], None, "", None)

    G3_LoadMtx44 = Symbol([0xB698], [0x2077A58], None, "", None)
    ...
    G3X_Init = Symbol([0xB6EC], [0x2077AAC], None, "", None)

    G3X_Reset = Symbol([0xB7F8], [0x2077BB8], None, "", None)

    G3X_ClearFifo = Symbol([0xB864], [0x2077C24], None, "", None)

    G3X_InitMtxStack = Symbol([0xB88C], [0x2077C4C], None, "", None)

    G3X_ResetMtxStack = Symbol([0xB924], [0x2077CE4], None, "", None)

    G3X_SetClearColor = Symbol([0xB9B4], [0x2077D74], None, "", None)

    G3X_InitTable = Symbol([0xB9DC], [0x2077D9C], None, "", None)

    G3X_GetMtxStackLevelPV = Symbol([0xBA7C], [0x2077E3C], None, "", None)

    G3X_GetMtxStackLevelPJ = Symbol([0xBAAC], [0x2077E6C], None, "", None)

    GXi_NopClearFifo128 = Symbol([0xBADC], [0x2077E9C], None, "", None)

    G3i_OrthoW = Symbol([0xBB70], [0x2077F30], None, "", None)

    G3i_LookAt = Symbol([0xBBD4], [0x2077F94], None, "", None)

    GX_LoadBgPltt = Symbol([0xBC20], [0x2077FE0], None, "", None)

    Gxs_LoadBgPltt = Symbol([0xBC74], [0x2078034], None, "", None)

    GX_LoadObjPltt = Symbol([0xBCCC], [0x207808C], None, "", None)

    Gxs_LoadObjPltt = Symbol([0xBD24], [0x20780E4], None, "", None)

    GX_LoadOam = Symbol([0xBD7C], [0x207813C], None, "", None)

    Gxs_LoadOam = Symbol([0xBDD0], [0x2078190], None, "", None)

    GX_LoadObj = Symbol([0xBE28], [0x20781E8], None, "", None)

    Gxs_LoadObj = Symbol([0xBE80], [0x2078240], None, "", None)
    ...
    GX_BeginLoadBgExtPltt = Symbol([0xC2F8], [0x20786B8], None, "", None)

    GX_EndLoadBgExtPltt = Symbol([0xC398], [0x2078758], None, "", None)

    GX_BeginLoadObjExtPltt = Symbol([0xC3E0], [0x20787A0], None, "", None)

    GX_EndLoadObjExtPltt = Symbol([0xC428], [0x20787E8], None, "", None)

    Gxs_BeginLoadBgExtPltt = Symbol([0xC46C], [0x207882C], None, "", None)

    Gxs_EndLoadBgExtPltt = Symbol([0xC484], [0x2078844], None, "", None)

    Gxs_BeginLoadObjExtPltt = Symbol([0xC4C4], [0x2078884], None, "", None)

    Gxs_EndLoadObjExtPltt = Symbol([0xC4DC], [0x207889C], None, "", None)

    GX_BeginLoadTex = Symbol([0xC51C], [0x20788DC], None, "", None)

    GX_LoadTex = Symbol([0xC578], [0x2078938], None, "", None)

    GX_EndLoadTex = Symbol([0xC6B8], [0x2078A78], None, "", None)

    GX_BeginLoadTexPltt = Symbol([0xC704], [0x2078AC4], None, "", None)

    GX_LoadTexPltt = Symbol([0xC738], [0x2078AF8], None, "", None)

    GX_EndLoadTexPltt = Symbol([0xC7A4], [0x2078B64], None, "", None)
    ...
    GX_SendFifo64B = Symbol([0xC80C], [0x2078BCC], None, "", None)

    OS_GetLockID = Symbol([0xCF54], [0x2079314], None, "", None)
...
class JpOverlay10Data:
    ...
    OREN_BERRY_DAMAGE = Symbol(
        [0x7900], [0x22C5B20], 0x2, "Damage dealt by eating an Oren Berry.", "int16_t"
    )
    ...
    GOLD_THORN_POWER = Symbol(
        [0x7998], [0x22C5BB8], 0x2, "Attack power for Golden Thorns.", "int16_t"
    )
    ...
    STICK_POWER = Symbol(
        [0x7AEC], [0x22C5D0C], 0x2, "Attack power for Sticks.", "int16_t"
    )
    ...
    THROWN_ITEM_HIT_CHANCE = Symbol(
        None, None, 0x2, "Chance of a hurled item hitting the target (90%).", "int16_t"
    )

    GEO_PEBBLE_DAMAGE = Symbol(
        [0x7B7C], [0x22C5D9C], 0x2, "Damage dealt by Geo Pebbles.", "int16_t"
    )

    GRAVELEROCK_DAMAGE = Symbol(
        [0x7B80], [0x22C5DA0], 0x2, "Damage dealt by Gravelerocks.", "int16_t"
    )

    RARE_FOSSIL_DAMAGE = Symbol(
        [0x7B84], [0x22C5DA4], 0x2, "Damage dealt by Rare Fossils.", "int16_t"
    )
    ...
    CORSOLA_TWIG_POWER = Symbol(
        [0x7BA0], [0x22C5DC0], 0x2, "Attack power for Corsola Twigs.", "int16_t"
    )

    CACNEA_SPIKE_POWER = Symbol(
        [0x7BA4], [0x22C5DC4], 0x2, "Attack power for Cacnea Spikes.", "int16_t"
    )

    GOLD_FANG_POWER = Symbol(
        [0x7BA8], [0x22C5DC8], 0x2, "Attack power for Gold Fangs.", "int16_t"
    )

    SILVER_SPIKE_POWER = Symbol(
        [0x7BAC], [0x22C5DCC], 0x2, "Attack power for Silver Spikes.", "int16_t"
    )

    IRON_THORN_POWER = Symbol(
        [0x7BB0], [0x22C5DD0], 0x2, "Attack power for Iron Thorns.", "int16_t"
    )
...
class JpOverlay11Functions:
    ...
    SsbLoad2 = Symbol([0x8448], [0x22E5D28], None, "", None)
    ...
    StationLoadHanger = Symbol([0x8920], [0x22E6200], None, "", None)

    ScriptStationLoadTalk = Symbol([0x9130], [0x22E6A10], None, "", None)

    SsbLoad1 = Symbol([0x9A9C], [0x22E737C], None, "", None)
...
class JpOverlay13Data:
    ...
    QUIZ_QUESTION_STRINGS = Symbol(
        [0x2074], [0x238D714], 0x84, "0x2 * (66 questions)", "uint16_t[66]"
    )
...
class JpOverlay14Functions:
    ...
    SentryState0 = Symbol([0x20B0], [0x238D750], None, "No params.", None)

    SentryState1 = Symbol([0x20D4], [0x238D774], None, "No params.", None)

    SentryState2 = Symbol([0x212C], [0x238D7CC], None, "No params.", None)

    SentryState3 = Symbol([0x2150], [0x238D7F0], None, "No params.", None)

    SentryState4 = Symbol([0x2278], [0x238D918], None, "No params.", None)
    ...
    SentryState6 = Symbol([0x22A8], [0x238D948], None, "No params.", None)
    ...
    SentryState8 = Symbol([0x22E4], [0x238D984], None, "No params.", None)

    SentryState9 = Symbol([0x2308], [0x238D9A8], None, "No params.", None)
    ...
    SentryStateB = Symbol([0x2344], [0x238D9E4], None, "No params.", None)
    ...
    SentryStateF = Symbol([0x31D0], [0x238E870], None, "No params.", None)

    SentryState10 = Symbol([0x31E8], [0x238E888], None, "No params.", None)
    ...
    SentryState12 = Symbol([0x3278], [0x238E918], None, "No params.", None)
    ...
    SentryState15 = Symbol([0x32F0], [0x238E990], None, "No params.", None)

    SentryState16 = Symbol([0x3330], [0x238E9D0], None, "No params.", None)
    ...
    SentryState18 = Symbol([0x3400], [0x238EAA0], None, "No params.", None)
    ...
    SentryState1A = Symbol([0x3450], [0x238EAF0], None, "No params.", None)
    ...
    SentryState1D = Symbol([0x3564], [0x238EC04], None, "No params.", None)
    ...
    SentryState1F = Symbol([0x35E0], [0x238EC80], None, "No params.", None)
    ...
    SentryState21 = Symbol([0x3674], [0x238ED14], None, "No params.", None)
...
class JpOverlay14Data:
    ...
    SENTRY_DEBUG_MENU_ITEMS = Symbol(
        [0x3968], [0x238F008], 0x48, "", "struct simple_menu_id_item[9]"
    )
...
class JpOverlay15Data:
    ...
    BANK_MAIN_MENU_ITEMS = Symbol(
        [0xF2C], [0x238C5CC], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class JpOverlay16Data:
    ...
    EVO_MENU_ITEMS_CONFIRM = Symbol(
        [0x2BE8], [0x238E288], 0x18, "", "struct simple_menu_id_item[3]"
    )

    EVO_SUBMENU_ITEMS = Symbol(
        [0x2C00], [0x238E2A0], 0x20, "", "struct simple_menu_id_item[4]"
    )

    EVO_MAIN_MENU_ITEMS = Symbol(
        [0x2C20], [0x238E2C0], 0x20, "", "struct simple_menu_id_item[4]"
    )
...
class JpOverlay17Data:
    ...
    ASSEMBLY_MENU_ITEMS_CONFIRM = Symbol(
        [0x1A40], [0x238D0E0], 0x18, "", "struct simple_menu_id_item[3]"
    )

    ASSEMBLY_MAIN_MENU_ITEMS_1 = Symbol(
        [0x1A58], [0x238D0F8], 0x18, "", "struct simple_menu_id_item[3]"
    )

    ASSEMBLY_MAIN_MENU_ITEMS_2 = Symbol(
        [0x1A70], [0x238D110], 0x20, "", "struct simple_menu_id_item[4]"
    )

    ASSEMBLY_SUBMENU_ITEMS_1 = Symbol(
        [0x1A90], [0x238D130], 0x28, "", "struct simple_menu_id_item[5]"
    )

    ASSEMBLY_SUBMENU_ITEMS_2 = Symbol(
        [0x1AB8], [0x238D158], 0x30, "", "struct simple_menu_id_item[6]"
    )

    ASSEMBLY_SUBMENU_ITEMS_3 = Symbol(
        [0x1AE8], [0x238D188], 0x30, "", "struct simple_menu_id_item[6]"
    )

    ASSEMBLY_SUBMENU_ITEMS_4 = Symbol(
        [0x1B18], [0x238D1B8], 0x38, "", "struct simple_menu_id_item[7]"
    )

    ASSEMBLY_SUBMENU_ITEMS_5 = Symbol(
        [0x1B50], [0x238D1F0], 0x38, "", "struct simple_menu_id_item[7]"
    )

    ASSEMBLY_SUBMENU_ITEMS_6 = Symbol(
        [0x1B88], [0x238D228], 0x38, "", "struct simple_menu_id_item[7]"
    )

    ASSEMBLY_SUBMENU_ITEMS_7 = Symbol(
        [0x1BC0], [0x238D260], 0x40, "", "struct simple_menu_id_item[8]"
    )
...
class JpOverlay18Data:
    ...
    LINK_SHOP_MENU_ITEMS_CONFIRM = Symbol(
        [0x31EC], [0x238E88C], 0x18, "", "struct simple_menu_id_item[3]"
    )

    LINK_SHOP_SUBMENU_ITEMS_1 = Symbol(
        [0x3204], [0x238E8A4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    LINK_SHOP_SUBMENU_ITEMS_2 = Symbol(
        [0x3224], [0x238E8C4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    LINK_SHOP_MAIN_MENU_ITEMS = Symbol(
        [0x3244], [0x238E8E4], 0x20, "", "struct simple_menu_id_item[4]"
    )

    LINK_SHOP_SUBMENU_ITEMS_3 = Symbol(
        [0x3264], [0x238E904], 0x28, "", "struct simple_menu_id_item[5]"
    )

    LINK_SHOP_SUBMENU_ITEMS_4 = Symbol(
        [0x328C], [0x238E92C], 0x30, "", "struct simple_menu_id_item[6]"
    )

    LINK_SHOP_SUBMENU_ITEMS_5 = Symbol(
        [0x32BC], [0x238E95C], 0x48, "", "struct simple_menu_id_item[9]"
    )

    LINK_SHOP_SUBMENU_ITEMS_6 = Symbol(
        [0x3304], [0x238E9A4], 0x48, "", "struct simple_menu_id_item[9]"
    )

    LINK_SHOP_SUBMENU_ITEMS_7 = Symbol(
        [0x334C], [0x238E9EC], 0x48, "", "struct simple_menu_id_item[9]"
    )
...
class JpOverlay19Data:
    ...
    BAR_MENU_ITEMS_CONFIRM_1 = Symbol(
        [0x40C0], [0x238F760], 0x18, "", "struct simple_menu_id_item[3]"
    )

    BAR_MENU_ITEMS_CONFIRM_2 = Symbol(
        [0x40D8], [0x238F778], 0x18, "", "struct simple_menu_id_item[3]"
    )
    ...
    BAR_MAIN_MENU_ITEMS = Symbol(
        [0x4108], [0x238F7A8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    BAR_SUBMENU_ITEMS_1 = Symbol(
        [0x4128], [0x238F7C8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    BAR_SUBMENU_ITEMS_2 = Symbol(
        [0x4148], [0x238F7E8], 0x30, "", "struct simple_menu_id_item[6]"
    )
...
class JpOverlay20Data:
    ...
    RECYCLE_MENU_ITEMS_CONFIRM_1 = Symbol(
        [0x2E40], [0x238E4E0], 0x18, "", "struct simple_menu_id_item[3]"
    )

    RECYCLE_MENU_ITEMS_CONFIRM_2 = Symbol(
        [0x2E58], [0x238E4F8], 0x18, "", "struct simple_menu_id_item[3]"
    )

    RECYCLE_SUBMENU_ITEMS_1 = Symbol(
        [0x2E70], [0x238E510], 0x18, "", "struct simple_menu_id_item[3]"
    )

    RECYCLE_SUBMENU_ITEMS_2 = Symbol(
        [0x2E88], [0x238E528], 0x20, "", "struct simple_menu_id_item[4]"
    )

    RECYCLE_MAIN_MENU_ITEMS_1 = Symbol(
        [0x2EA8], [0x238E548], 0x28, "", "struct simple_menu_id_item[5]"
    )
    ...
    RECYCLE_MAIN_MENU_ITEMS_2 = Symbol(
        [0x2F44], [0x238E5E4], 0x20, "", "struct simple_menu_id_item[4]"
    )
    ...
    RECYCLE_MAIN_MENU_ITEMS_3 = Symbol(
        [0x2FB4], [0x238E654], 0x18, "", "struct simple_menu_id_item[3]"
    )
...
class JpOverlay21Data:
    ...
    SWAP_SHOP_MENU_ITEMS_CONFIRM = Symbol(
        [0x2908], [0x238DFA8], 0x18, "", "struct simple_menu_id_item[3]"
    )

    SWAP_SHOP_SUBMENU_ITEMS_1 = Symbol(
        [0x2920], [0x238DFC0], 0x18, "", "struct simple_menu_id_item[3]"
    )

    SWAP_SHOP_SUBMENU_ITEMS_2 = Symbol(
        [0x2938], [0x238DFD8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SWAP_SHOP_MAIN_MENU_ITEMS_1 = Symbol(
        [0x2958], [0x238DFF8], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SWAP_SHOP_MAIN_MENU_ITEMS_2 = Symbol(
        [0x2978], [0x238E018], 0x28, "", "struct simple_menu_id_item[5]"
    )

    SWAP_SHOP_SUBMENU_ITEMS_3 = Symbol(
        [0x29A0], [0x238E040], 0x30, "", "struct simple_menu_id_item[6]"
    )
...
class JpOverlay22Data:
    ...
    SHOP_MENU_ITEMS_CONFIRM = Symbol(
        [0x4728], [0x238FDC8], 0x18, "", "struct simple_menu_id_item[3]"
    )

    SHOP_MAIN_MENU_ITEMS_1 = Symbol(
        [0x4740], [0x238FDE0], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SHOP_MAIN_MENU_ITEMS_2 = Symbol(
        [0x4760], [0x238FE00], 0x20, "", "struct simple_menu_id_item[4]"
    )

    SHOP_MAIN_MENU_ITEMS_3 = Symbol(
        [0x4780], [0x238FE20], 0x30, "", "struct simple_menu_id_item[6]"
    )
...
class JpOverlay23Data:
    ...
    STORAGE_MENU_ITEMS_CONFIRM = Symbol(
        [0x3214], [0x238E8B4], 0x18, "", "struct simple_menu_id_item[3]"
    )

    STORAGE_MAIN_MENU_ITEMS_1 = Symbol(
        [0x322C], [0x238E8CC], 0x20, "", "struct simple_menu_id_item[4]"
    )

    STORAGE_MAIN_MENU_ITEMS_2 = Symbol(
        [0x324C], [0x238E8EC], 0x20, "", "struct simple_menu_id_item[4]"
    )

    STORAGE_MAIN_MENU_ITEMS_3 = Symbol(
        [0x326C], [0x238E90C], 0x20, "", "struct simple_menu_id_item[4]"
    )

    STORAGE_MAIN_MENU_ITEMS_4 = Symbol(
        [0x328C], [0x238E92C], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class JpOverlay24Data:
    ...
    DAYCARE_MENU_ITEMS_CONFIRM = Symbol(
        [0x23E8], [0x238DA88], 0x18, "", "struct simple_menu_id_item[3]"
    )

    DAYCARE_MAIN_MENU_ITEMS = Symbol(
        [0x2400], [0x238DAA0], 0x20, "", "struct simple_menu_id_item[4]"
    )
...
class JpOverlay25Data:
    ...
    APPRAISAL_MENU_ITEMS_CONFIRM = Symbol(
        [0x1374], [0x238CA14], 0x18, "", "struct simple_menu_id_item[3]"
    )

    APPRAISAL_MAIN_MENU_ITEMS = Symbol(
        [0x138C], [0x238CA2C], 0x20, "", "struct simple_menu_id_item[4]"
    )

    APPRAISAL_SUBMENU_ITEMS = Symbol(
        [0x13AC], [0x238CA4C], 0x20, "", "struct simple_menu_id_item[4]"
    )
...
class JpOverlay27Data:
    ...
    DISCARD_ITEMS_MENU_ITEMS_CONFIRM = Symbol(
        [0x284C], [0x238DEEC], 0x18, "", "struct simple_menu_id_item[3]"
    )

    DISCARD_ITEMS_SUBMENU_ITEMS_1 = Symbol(
        [0x2864], [0x238DF04], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DISCARD_ITEMS_SUBMENU_ITEMS_2 = Symbol(
        [0x2884], [0x238DF24], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DISCARD_ITEMS_MAIN_MENU_ITEMS = Symbol(
        [0x28A4], [0x238DF44], 0x28, "", "struct simple_menu_id_item[5]"
    )
...
class JpOverlay29Functions:
    ...
    DisplayMessage2 = Symbol(
        [0x70C58], [0x234E538], None, "Very similar to DisplayMessage", None
    )
...
class JpOverlay31Data:
    ...
    DUNGEON_MAIN_MENU_ITEMS = Symbol(
        [0x75FC], [0x238B09C], 0x40, "", "struct simple_menu_id_item[8]"
    )
    ...
    DUNGEON_SUBMENU_ITEMS_1 = Symbol(
        [0x7698], [0x238B138], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DUNGEON_SUBMENU_ITEMS_2 = Symbol(
        [0x76B8], [0x238B158], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DUNGEON_SUBMENU_ITEMS_3 = Symbol(
        [0x76D8], [0x238B178], 0x20, "", "struct simple_menu_id_item[4]"
    )

    DUNGEON_SUBMENU_ITEMS_4 = Symbol(
        [0x76F8], [0x238B198], 0x20, "", "struct simple_menu_id_item[4]"
    )
    ...
    DUNGEON_SUBMENU_ITEMS_5 = Symbol(
        [0x7944], [0x238B3E4], 0x18, "", "struct simple_menu_id_item[3]"
    )
    ...
    DUNGEON_SUBMENU_ITEMS_6 = Symbol(
        [0x79C8], [0x238B468], 0x48, "", "struct simple_menu_id_item[9]"
    )
...
class JpOverlay34Data:
    ...
    START_MENU_ITEMS_CONFIRM = Symbol(
        [0xD4C], [0x22DE62C], 0x18, "", "struct simple_menu_id_item[3]"
    )
    ...
    DUNGEON_DEBUG_MENU_ITEMS = Symbol(
        [0xD74], [0x22DE654], 0x28, "", "struct simple_menu_id_item[5]"
    )
