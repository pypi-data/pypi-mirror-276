...
class ASRBase:
    ...
    def __init__(self, lan, modelsize=None, cache_dir=None, model_dir=None, model = None, logfile=sys.stderr):
...
class WhisperApiASR(ASRBase):
    ...
    def __init__(self, lan=None, temperature=0, model=None, logfile=sys.stderr):
        self.logfile = logfile
