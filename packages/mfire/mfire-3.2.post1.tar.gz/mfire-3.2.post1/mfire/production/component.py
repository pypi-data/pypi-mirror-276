...
class CDPMarineText(BaseCDPComponent):
    """
    This class creates an object containing the configuration of a text-type
    risk_component for the marine general situation.

    The `SitGenText` attribute is the text string of the risk_component.
    """
    ...
    def from_composite(
        ...
        """Creates a `CDPMarineText` object from a `SynthesisComponentComposite` object.
        ...
        Returns:
            CDPMarineText: The converted risk_component.
        """
        base_dict = (
            super().from_composite(component=component, geo_id=geo_id).model_dump()
        )
