...
class TestWeatherReducer:
    ...
    @pytest.mark.parametrize(
        "code_J3,code_J4",
        [(50, 51), (60, 62), (90, 93), (58, 0), (63, 0), (92, 0)],
    )
    def test_handle_straddling_code_J3J4(self, code_J3, code_J4, assert_equals_result):
...
class TestWeatherBuilder:
    def test_compute_without_condition(self):
        builder = WeatherBuilderFactory(
            composite=WeatherCompositeFactory(check_condition_factory=False)
        )
        assert builder.compute() is None

    def test_template_key_0_ts(self):
        builder = WeatherBuilderFactory(reduction_factory={})
        assert builder.template_key == "0xTS"

    @pytest.mark.parametrize(
        "temp,severe,expected",
        [
            (False, False, "1xTS"),
            (True, False, "1xTS_temp"),
            (False, True, "1xTS_severe"),
            (True, True, "1xTS_temp_severe"),
        ],
    )
    def test_template_key_1_ts(self, temp, severe, expected):
        reduction = {
            "TS1": {
                "temporality": "temp" if temp else None,
                "localisation": ...,
                "label": ...,
            }
        }
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (False, False, False, "2xTS"),
            (True, False, False, "2xTS_temp1"),
            (False, True, False, "2xTS_temp2"),
            (True, True, False, "2xTS_temp"),
            # with severe sentence
            (False, False, True, "2xTS_severe"),
            (True, False, True, "2xTS_temp1_severe"),
            (False, True, True, "2xTS_temp2_severe"),
            (True, True, True, "2xTS_temp_severe"),
        ],
    )
    def test_template_key_2_ts(self, temp1, temp2, severe, expected):
        reduction = {
            "TS1": {
                "temporality": "temp1" if temp1 else None,
                "localisation": ...,
                "label": ...,
            },
            "TS2": {
                "temporality": "temp2" if temp2 else None,
                "localisation": ...,
                "label": ...,
            },
        }
    ...
    @pytest.mark.parametrize(
        ...
        [
            (False, False, False, "3xTS"),
            (True, False, False, "3xTS_temp1"),
            (False, True, False, "3xTS_temp2"),
            (False, False, True, "3xTS_temp3"),
            (True, True, False, "3xTS_temp12"),
            (True, False, True, "3xTS_temp13"),
            (False, True, True, "3xTS_temp23"),
            (True, True, True, "3xTS_temp123"),
        ],
    )
    def test_template_key_3_ts(self, temp1, temp2, temp3, expected):
        builder = WeatherBuilderFactory(
            reduction_factory={
                "TS1": {
                    "temporality": "temp1" if temp1 else None,
                ...
                "TS3": {
                    "temporality": "temp3" if temp3 else None,
                    "localisation": ...,
                    "label": ...,
                },
            }
    ...
    def test_template_key_unimplemented(self):
        builder = WeatherBuilderFactory(
            reduction_factory={
                "TS1": ...,
                "TS2": ...,
        ...
        assert builder.template_key == "Unimplemented"

    def test_compute_0_ts(self, assert_equals_result):
        builder = WeatherBuilderFactory(reduction_factory={})
        assert_equals_result(builder.compute())

    @pytest.mark.parametrize("temp,loc,severe", product([True, False], repeat=3))
    def test_compute_1_ts(self, temp, loc, severe, assert_equals_result):
        reduction = {
            "TS1": {
                "label": "neige",
                "temporality": "Le mercredi matin" if temp else None,
                "localisation": "au-dessus de 500m" if loc else None,
            }
        }
    ...
    def test_compute_2_ts(self, temp1, loc1, temp2, loc2, severe, assert_equals_result):
        reduction = {
            "TS1": {
                "label": "neige faible",
    ...
    def test_compute_3_ts(
        self, temp1, loc1, temp2, loc2, temp3, loc3, assert_equals_result
    ):
        builder = WeatherBuilderFactory(
            reduction_factory={
                "TS1": {
...
class TestWeatherBuilderIntegration:
    @staticmethod
    def _compute(
        codes: list,
        valid_times: list,
