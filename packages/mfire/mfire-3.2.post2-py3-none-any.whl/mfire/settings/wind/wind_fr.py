...
TEMPLATE_B1_1: str = (
    "Vent de {{ wd_periods[0]['wd']|safe }}, "
    "{{ wf_periods[0]['interval'][0] }} à "
    "{{ wf_periods[0]['interval'][1] }} {{ units }}."
)

TEMPLATE_B1_2: str = (
    "Vent de {{ wd_periods[0]['wd']|safe }} s'orientant "
...
TEMPLATE_B2_5: str = (
    ...
    "{{ wf_periods[0]['interval'][1] }} {{ units }}, "
    "{{ wf_periods[0]['time_desc']|safe }} "
    "de {{ wd_periods[0]['wd']|safe }}, et "
    "{{ wf_periods[1]['time_desc']|safe }} "
    "de {{ wd_periods[1]['wd']|safe }} puis "
    "{{ wd_periods[2]['wd'] }}."
)
...
TEMPLATE_B2_10: str = (
    "Vent de {{ wd_periods[0]['wd']|safe }}, entre "
...
TEMPLATE_B2_13: str = (
    ...
    "{{ wf_periods[0]['interval'][1] }} {{ units }}, "
    "{{ wf_periods[0]['time_desc']|safe }} "
    "de {{ wd_periods[0]['wd']|safe }} puis {{ wd_periods[1]['wd'] }}, "
...
TEMPLATE_B2_14: str = (
    ...
    "de {{ wd_periods[0]['wd']|safe }}, et "
    "{{ wf_periods[1]['time_desc']|safe }} "
    "de {{ wd_periods[1]['wd']|safe }} puis {{ wd_periods[2]['wd'] }}."
)
...
TEMPLATES_DICT_FR: dict[str, str] = {
