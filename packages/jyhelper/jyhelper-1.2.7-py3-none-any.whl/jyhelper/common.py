...
class common:
    ...
    """
    @staticmethod
    def multipleThreadRunTasks(max_workers,tasks,get_result=False,get_exceptions=False):
    ...
    # 多进程运行任务
    @staticmethod
    def multipleProcessRunTasks(max_workers, tasks, get_result=False, get_exceptions=False):
        # 创建一个拥有 max_workers 个线程的线程池
