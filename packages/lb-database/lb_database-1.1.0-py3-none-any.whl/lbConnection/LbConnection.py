...
class LbConnection:
    ...
    def __init__(self):
        ...
        url_database: str = self.check_and_read_environment_variables(variable="anon_con")
        name_database: str = self.check_and_read_environment_variables(variable="db_anon")
