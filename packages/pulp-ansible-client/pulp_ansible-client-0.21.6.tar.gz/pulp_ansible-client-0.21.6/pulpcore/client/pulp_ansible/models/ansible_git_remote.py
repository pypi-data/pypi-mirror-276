...
class AnsibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, name=None, client_cert=None, password=None, max_retries=None, proxy_password=None, ca_cert=None, connect_timeout=None, tls_validation=None, headers=None, sock_connect_timeout=None, url=None, proxy_username=None, client_key=None, username=None, rate_limit=None, sock_read_timeout=None, download_concurrency=None, proxy_url=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
