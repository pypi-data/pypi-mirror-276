...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, client_cert=None, pulp_created=None, max_retries=None, pulp_last_updated=None, ca_cert=None, connect_timeout=None, tls_validation=None, headers=None, sock_connect_timeout=None, url=None, hidden_fields=None, rate_limit=None, sock_read_timeout=None, pulp_href=None, download_concurrency=None, proxy_url=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
