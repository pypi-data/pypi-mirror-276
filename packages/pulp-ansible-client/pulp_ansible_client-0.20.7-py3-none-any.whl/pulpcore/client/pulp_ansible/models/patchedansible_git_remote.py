...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_key=None, headers=None, password=None, proxy_url=None, username=None, max_retries=None, connect_timeout=None, ca_cert=None, name=None, pulp_labels=None, sock_connect_timeout=None, total_timeout=None, proxy_username=None, sock_read_timeout=None, proxy_password=None, url=None, tls_validation=None, rate_limit=None, client_cert=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
