...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, proxy_url=None, pulp_last_updated=None, max_retries=None, connect_timeout=None, ca_cert=None, pulp_href=None, name=None, pulp_labels=None, pulp_created=None, sock_connect_timeout=None, total_timeout=None, hidden_fields=None, sock_read_timeout=None, url=None, tls_validation=None, rate_limit=None, client_cert=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
