...
class Person:
    ...
    def __init__(self, *, name: str = None, number: int = None, last_coordinate: Point = Point(0, 0),
        ...
        self.name = name or (first_name + " " + last_name if first_name and last_name else first_name or last_name)
