...
**garcia2009** could always use more documentation, whether as
part of the official **garcia2009** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `garcia2009` for local
development.

1. Fork the `garcia2009` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/garcia2009.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd garcia2009
    (dvlpt) garcia2009$ flake8
    (dvlpt) garcia2009$ pytest
    
    (dvlpt) garcia2009$ tox
...
.. _issues: https://gitlab.com/b326/garcia2009/issues
