...
class Relation(RelationProtocol):
    ...
    def get_norm(self) -> RealNumber:
        ...
        square_self = self**2
        return default_functions.one_integrate(square_self) / (self.sample)
    ...
    def diff(self: R) -> R:
        ...
        """
        result = default_functions.differentiate(self)
    ...
    def integrate(self: R) -> R:
        ...
        """
        result = default_functions.integrate(self)
        return type(self)(result)
    ...
    def interpolate_extrapolate(
        ...
        new_y = default_functions.interpolate_extrapolate(
    ...
    def correlate(cls: Type[R], r1: 'Relation', r2: 'Relation') -> R:
        ...
        if isinstance(r1, Relation) and isinstance(r2, Relation):
            result = default_functions.correlate(cls, r1, r2)
            return cls(result)
        else:
    ...
    def convolve(cls: Type[R], r1: 'Relation', r2: 'Relation') -> R:
        ...
        """
        if isinstance(r1, Relation) and isinstance(r2, Relation):
            result = default_functions.convolve(cls, r1, r2)
            return cls(result)
        else:
    ...
    def math_operation(
        ...
        if isinstance(b, RelationProtocol):
            ...
            return r1.x.copy(), default_functions.math_operation(
                r1.y.copy(), r2.y.copy(), name_operation
            )
        else:
            return a.x.copy(), default_functions.math_operation(
