...
class Axis:
    ...
    def get_common_axis(
        ...
        return default_functions.get_common_axis(axis1, axis2, is_correct_end)
    ...
    def get_using_end(
        ...
        """
        return default_functions.get_using_end(
    ...
    def get_from_array(
        ...
        return default_functions.get_axis_from_array(x, sample)
