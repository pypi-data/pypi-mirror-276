...
class WebSocketService:
    ...
    def register_handler(self, event: Union[Event, str], handler: Callable):
        ...
        if event in [Event.MARKET, Event.SUMMARY, Event.ERROR]:
    ...
    def __handle_market(self, tick: Tick):
        ...
        tick.bid += truncate_float(bid_spread, symbol.digits)
        tick.ask += truncate_float(ask_spread, symbol.digits)
