...
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./App */ "./lib/App.js");
...
const plugin = {
    ...
    activate: (app, palette, documentManager, launcher, htmlTracker) => {
        ...
        const s3_open_function = (s3_link) => {
            (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('s3', {}, ['s3location', s3_link])
                .then(data => {
                console.log(data);
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('settings')
            .then(data => {
            console.log(data);
            domain = data['domain'];
            token = data['token'];
        ...
        app.commands.addCommand(command, {
            label: 'Onyx',
            caption: 'Onyx',
            icon: _icon__WEBPACK_IMPORTED_MODULE_5__.chatIcon,
            execute: () => {
                if (!widget || widget.disposed) {
                    const content = new _App__WEBPACK_IMPORTED_MODULE_6__.ReactAppWidget(domain, token, s3_open_function);
        ...
        app.commands.addCommand(s3_command, {
            ...
            icon: _icon__WEBPACK_IMPORTED_MODULE_5__.chatIcon,
            execute: () => {
                s3_open_function('s3://mscape-published-reports/C-B01922D432_scylla_report.html');
            }
        });
...
//# sourceMappingURL=lib_index_js.00a67ef4cb4442c3574f.js.map