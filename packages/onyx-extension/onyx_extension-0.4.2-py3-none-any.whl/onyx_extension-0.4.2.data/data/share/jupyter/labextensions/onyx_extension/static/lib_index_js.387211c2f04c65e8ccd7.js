...
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./App */ "./lib/App.js");
...
const plugin = {
    ...
    activate: (app, palette, documentManager, launcher) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)('settings')
            .then(data => {
            console.log(data);
            domain = data['domain'];
            token = data['token'];
        ...
        app.commands.addCommand(command, {
            label: 'Onyx',
            caption: 'Onyx',
            icon: _icon__WEBPACK_IMPORTED_MODULE_4__.chatIcon,
            execute: () => {
                if (!widget || widget.disposed) {
                    const content = new _App__WEBPACK_IMPORTED_MODULE_5__.ReactAppWidget(domain, token);
