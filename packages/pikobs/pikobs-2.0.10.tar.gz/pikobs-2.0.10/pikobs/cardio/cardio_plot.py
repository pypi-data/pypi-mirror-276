...
def cardio_plot(pathwork,datestart, dateend, fonction,flag_type, family, fig_title, plot_type, channel, id_stn, varno):
 ...
 # channel   = LARG[2]
  ...
  path_output_work=f'{pathwork}/cardio_{datestart}_{dateend}_{fonction}_{flag_type}_{family}.db'
 # print (path_output_work) 
  ...
  #conn.execute("SELECT load_extension('/home/dlo001/RADAR/radvelso/radvelso/extension/blobint.so')")
#  print ("1")
  #conn.execute("SELECT load_extension('/home/dlo001/Plotout/libudfsqlite/src/libudfsqlite-shared.so')")
 # print ("2")
  query = f"""
           SELECT
                DATE,  
...
#  ax2.set_ylim(0, 5)
  ...
  fig.autofmt_xdate()
  fig.suptitle(f'Experience:{TITLE} Satellite:{id_stn} channel:{channel}', fontsize=15, fontweight='bold')
  
  #plt.show()

  plt.savefig(f'{pathwork}/cardio/cardio_{family}_{id_stn}_{channel}.png',format='png',dpi=100)
