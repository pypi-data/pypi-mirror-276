...
class GUI:
    def __init__(self):
        ...
        self.top_portion.grid_rowconfigure(4, weight=1)
        ...
        self.srcml_input_frame = tk.Frame(self.top_portion, bg="pink")
        self.srcml_input_frame.grid(row=2, column=0, sticky="nsew")
        self.srcml_input_frame.grid_rowconfigure(0, weight=1)
        self.srcml_input_frame.grid_columnconfigure(0, weight=4)
        self.srcml_input_frame.grid_columnconfigure(1, weight=1)

        self.srcml_input_guide = tk.Frame(self.srcml_input_frame)
        self.srcml_input_guide.columnconfigure(0, weight=10)
        self.srcml_input_guide.rowconfigure(0, weight=10)
        self.srcml_input_guide.grid(row=0, column=0, sticky="nsew")
        self.srcml_input_guide.grid_propagate(False)

        self.srcml_input_text = tk.Entry(self.srcml_input_guide, textvariable=tk.StringVar())
        self.srcml_input_text.insert(0, "Enter file path to libsrcml.dll")
        self.srcml_input_text.grid(sticky="ew")

        self.srcml_browse_guide = tk.Frame(self.srcml_input_frame)
        self.srcml_browse_guide.columnconfigure(0, weight=10)
        self.srcml_browse_guide.rowconfigure(0, weight=10)
        self.srcml_browse_guide.grid(row=0, column=1, sticky="nsew")
        self.srcml_browse_guide.grid_propagate(False)

        self.srcml_browse_button = tk.Button(self.srcml_browse_guide, text="Browse", command=lambda: browse(self.srcml_input_text))
        self.srcml_browse_button.grid(row=0, column=0, sticky="ew")

        self.url_input_frame = tk.Frame(self.top_portion)
        self.url_input_frame.grid(row=3, column=0, sticky="nsew")
        ...
        self.example_input_frame_guide.grid(row=4, column=0, sticky="nsew")
    ...
    def start(self):
        ...
        def start_appium_server():
            ...
            write_json(paths, f"output/{file_name}_res.json")
