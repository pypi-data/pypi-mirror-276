...
# Oppgave 1.57 Vindpark III: Hus og elbiler (Matematikk AS)
...
if _blokk == 1:
    ...
    txt_a              = "a) Antall hus vindparken forsyner (år)     :"
...
# a) Antall hus vindparken forsyner (år)
