...
**yin2009** could always use more documentation, whether as
part of the official **yin2009** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `yin2009` for local
development.

1. Fork the `yin2009` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/yin2009.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd yin2009
    (dvlpt) yin2009$ flake8
    (dvlpt) yin2009$ pytest
...
.. _issues: https://gitlab.com/b326/yin2009/issues
