from sciobject.sciobject import ScientificObject, ClassLogbook, sci_method, freshly_create_log_folders
...
class ExampleObject(ScientificObject):
    ...
    @sci_method
    def optional_args(self, som_arg="a", different="b"):
        return som_arg+different
