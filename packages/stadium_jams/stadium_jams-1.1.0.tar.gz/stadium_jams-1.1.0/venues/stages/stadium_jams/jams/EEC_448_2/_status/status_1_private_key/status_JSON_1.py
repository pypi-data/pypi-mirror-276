...
'''
	python3 status.proc.py "jams/EEC_448_2/_status/status_1_private_key/status_JSON_1.py"
'''
...
import stadium_jams.jams.EEC_448_2.private_key.scan as private_scan
