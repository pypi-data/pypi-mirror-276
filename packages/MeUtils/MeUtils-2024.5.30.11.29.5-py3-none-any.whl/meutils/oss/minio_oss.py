...
class Minio(_Minio):
    ...
    def __init__(self, endpoint: Optional[str] = None,
        ...
        super().__init__(endpoint=endpoint, access_key=access_key, secret_key=secret_key, secure=secure, **kwargs)
    ...
    async def put_object_for_openai(
        ...
        file_id = str(Path(prefix) / f"{shortuuid.random()}{extension}")
...
if __name__ == '__main__':
    ...
    _ = client.put_object_for_openai("https://sfile.chatglm.cn/chatglm4/82834747-0fcf-4ecb-94b0-92e5e749798b.docx")
