...
from trainerbase.memory import ARCH, ConvertibleToAddress, allocate, ensure_address, pm
...
class AllocatingCodeInjection(AbstractCodeInjection):  # pylint: disable=too-many-instance-attributes
    def __init__(  # pylint: disable=too-many-arguments
        ...
        *,
        ...
        experimental_allocate_nearest_to_injection_point: bool = False,
    ):
        ...
        self._experimental_allocate_nearest_to_injection_point = experimental_allocate_nearest_to_injection_point

    @override
    def inject(self):
        self.injection_point = self.address.resolve()

        nearest_to = self.injection_point if self._experimental_allocate_nearest_to_injection_point else None
        self.new_memory_address: int = allocate(self.new_memory_size, nearest_to=nearest_to)
