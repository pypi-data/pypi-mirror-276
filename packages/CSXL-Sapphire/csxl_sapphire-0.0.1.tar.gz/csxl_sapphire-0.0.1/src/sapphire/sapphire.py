...
class Sapphire:
    @staticmethod
    def calculate_rank_score(videoID: str) -> float:
        """
        Calculates the rank score of the YouTube video using the Sapphire algorithm.
        ...
        rank_score = InformationalRetrievalRank(
            qualified_terms, freq_dist, qualification
        )
