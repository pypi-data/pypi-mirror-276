...
class TestFormElem802(unittest.TestCase):
    ...
    def test_decode_all_form_elem(self):
        test_files = os.listdir(self.data_dir)
        test_files = [
            "03-привязки явно убраны",
            "12-левая граница к лево другого элемента с сохранением пропорций",
            "13-изменено одно окончание привязки"
        ]
        result = ''
        for file_name in test_files:
            if file_name == 'temp':
    ...
    def test_decode_form_elem(self):
        ...
        # file_name = '12-левая граница к лево другого элемента с сохранением пропорций'
        # file_name = '13-изменено одно окончание привязки'
        # file_name = 'ПанелиБезСтраниц'
        # file_name = 'form'
