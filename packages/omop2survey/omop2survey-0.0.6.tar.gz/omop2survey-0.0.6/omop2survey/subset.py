...
def import_survey_data(selection):
    ...
    df_name = f"survey_df{selection}"
    globals()[df_name] = survey_df
    print(f"Dataset saved as: {df_name}")
    print(f"The number of unique person_ids in the dataset: {globals()[df_name]['person_id'].nunique()}")
    return df_name
