...
VERSION = '0.0.0.2' #Muy importante, deberéis ir cambiando la versión de vuestra librería según incluyáis nuevas funcionalidades
...
DESCRIPTION = 'Wrapper de Modelos de IA y Estructuras de Agentes para ciberseguridad especialmente ofensiva y ciberinteligencia' #Descripción corta
