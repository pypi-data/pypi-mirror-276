...
class ImplStorage(ImplBase):
    ...
    @flag(name="checkpoints", default=True, help="when True, checkpoints markers are also plotted")
    @flag(name="catch-up", default=True, help="when True, running line includes catch-up segments")
