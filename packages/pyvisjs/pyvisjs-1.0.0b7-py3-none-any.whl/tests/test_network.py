...
def test_network_render_default_params(mock_Environment):
    ...
    mock_render.assert_called_once_with(data=DATA, pyvisjs=PYVISJS, tables=TABLES)
...
def test_network_pyvisjs_dataTables_all_tables(mock_Environment):
    ...
    DATA = {
        ...
        "edges": [
            ...
            {'category': 'tele', 'direction': 'out', 'to': 'LMT', 'label': '33', 'from': 'AM'},       
            {'category': 'pers', 'direction': 'in', 'to': 'AM', 'label': '50', 'from': 'JL'}, 
    ...
    net.add_edge("AM", "LMT", label="33", category="tele", direction="out")
    net.add_edge("JL", "AM", label="50", category="pers", direction="in")
    net.render()
