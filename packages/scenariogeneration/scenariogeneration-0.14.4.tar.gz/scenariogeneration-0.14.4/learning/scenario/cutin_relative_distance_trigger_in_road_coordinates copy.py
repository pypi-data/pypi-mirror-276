...
class Scenario(ScenarioGenerator):
    ...
    def road(self, **kwargs):
        ...
        road_id = 0
        road_length = 500
        geometry = xodr.Spiral(1/road_length, -1/road_length, road_length)
        n_left_lanes = 1
        n_right_lanes = 2
    ...
    def scenario(self, **kwargs):
        ...
        target_start_lane_id = ego_start_lane_id  # left ego
        ...
        dest_lane_id = ego_start_lane_id + 1
        ...
        # Storyboard
        stop_sim_trigger_delay = 0
        stop_sim_condition_end_time = 10
        sb = xosc.StoryBoard(
            init,
            xosc.ValueTrigger(
                "Stop simulation",
                stop_sim_trigger_delay,
                xosc.ConditionEdge.rising,
                xosc.SimulationTimeCondition(
                    stop_sim_condition_end_time,
                    xosc.Rule.greaterThan
                ),
                "stop"
            ),
