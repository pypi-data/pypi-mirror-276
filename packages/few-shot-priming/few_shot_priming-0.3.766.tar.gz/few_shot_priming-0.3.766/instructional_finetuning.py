...
def run_instructional_fine_tuning(config, params, experiment, validate, few_shot_size, logger, model_path_fine_tuned, debug,
                                  model_path=None, topic_count=None, sampling_strategy=None,
    ...
    if sampling_strategy =="similar":
        return run_instructiona_fine_tuning_similar(config, params, experiment, validate, few_shot_size, logger, model_path_fine_tuned, debug, model_path=model_path, topic_count=topic_count, similarity=similarity,
