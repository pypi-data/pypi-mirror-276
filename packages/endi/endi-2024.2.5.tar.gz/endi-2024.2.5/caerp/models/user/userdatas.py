...
class CaeSituationOption(ConfigurableOption):
    ...
    is_integration = Column(
        ...
        info={
            "colanderalchemy": {
                "title": "Donne droit à un compte de enDI",
                "description": "Si un entrepreneur a ce statut, \
un compte de enDI lui sera automatiquement associé",
            }
        },
    )
...
class UserDatas(Node):
    ...
    id = Column(
        ...
        primary_key=True,
        info={
            "colanderalchemy": {"exclude": True, "title": "Identifiant de enDI"},
        },
    )
