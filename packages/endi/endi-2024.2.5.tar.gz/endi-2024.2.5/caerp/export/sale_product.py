...
class CaerpSalesCatalogExportSchema(colander.MappingSchema):
    ...
    As of now de enDI supports only import/export between the same minor version..
    That means data cannot be exported from de enDI 6.6 and imported in 6.7. But 6.6.1->6.6.2 is ok
