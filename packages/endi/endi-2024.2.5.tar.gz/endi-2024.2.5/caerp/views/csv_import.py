...
d'insérer de nouvelle données dans de enDI, ou de mettre à jour \
...
associer les champs de votre fichier avec les données de d'enDI."
    _schema = None
