...
CAERP_FORUM_LINK = HTML.tag(
    ...
    c="Forum des utilisateurs d’de enDI",
    target="_blank",
    title="Ouvrir le forum des utilisateurs d’de enDI dans une nouvelle fenêtre",
)
CAERP_DOC_LINK = HTML.tag(
    ...
    c="Documentation",
    target="_blank",
    title="Ouvrir la documentation d’de enDI dans une nouvelle fenêtre",
)
