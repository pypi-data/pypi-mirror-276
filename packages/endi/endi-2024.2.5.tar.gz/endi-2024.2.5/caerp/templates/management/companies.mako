        ...
        <table class="hover_table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="col_number" title="Total HT des factures de enDI ${current_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number archive" title="Total HT des factures de enDI ${previous_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number" title="Total HT des notes de dépenses de enDI ${current_exercice_period_label}">
                        Dépenses<br><small>${current_exercice['label']}</small>
                    </th>
                    <th scope="col" class="col_number archive" title="Total HT des notes de dépenses de enDI ${previous_exercice_period_label}">
                        Dépenses<br><small>${previous_exercice['label']}</small>
                    </th>
                    <th scope="col" class="col_number" title="Total HT des factures fournisseur de enDI ${current_exercice_period_label}">
                        Achats<br><small>${current_exercice['label']}</small>
                    </th>
                    <th scope="col" class="col_number archive" title="Total HT des factures fournisseur de enDI ${previous_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number" title="Total des kilomètres saisis dans de enDI ${current_exercice_period_label}">
                    ...
                    <th scope="col" class="col_number archive" title="Total des kilomètres saisis dans de enDI ${previous_exercice_period_label}">
