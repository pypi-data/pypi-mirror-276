...
<div>
    ...
    <div class='alert alert-info'>
        ...
        <ul>
            ...
            <li>Les écritures qui n'ont pas pu être associées à des enseignes dans de enDI</li>
        </ul><br />
