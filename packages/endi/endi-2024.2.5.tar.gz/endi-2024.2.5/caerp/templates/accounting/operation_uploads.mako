...
<div>
    ...
    <div class='alert alert-warning'>
        ...
        Lors de la clôture comptable (et principalement lors de la saisie des reports d’à-nouveaux) n’oubliez pas d’indiquer à de enDI que la clôture a été faite sans quoi les calculs des états de trésorerie seraient erronnés.<br />
	...
	<div class='alert alert-info'>
		...
		Vous trouverez ci-dessous la liste des fichiers comptables ou synchronisations automatiques traités par de enDI.<br />
		Les écritures présentes dans les fichiers comptables ou dans les données synchronisées sont importées dans de enDI par un automate en "tâche de fond".<br /><br />
		Après le traitement, vous avez dû recevoir un e-mail de compte rendu à l'adresse d'administration configurée dans
		<a href="#" onclick="window.openPopup('/admin/main/contact');" title="Cet écran s’ouvrira dans une nouvelle fenêtre" aria-label="Cet écran s’ouvrira dans une nouvelle fenêtre">Configuration -> Configuration générale -> Adresse e-mail de contact de enDI</a><br /><br />
