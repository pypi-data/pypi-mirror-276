...
class Nomad_SDK:
	...
	def upload_asset(self, NAME: str | None, EXISTING_ASSET_ID: str | None, 
		...
		try:
			...
			print("Start upload")
			START_UPLOAD_INFO = _start_upload(self, self, self.token, self.config["serviceApiUrl"], 
				NAME, EXISTING_ASSET_ID, RELATED_CONTENT_ID, UPLOAD_OVERWRITE_OPTION, FILE, 
				PARENT_ID, LANGUAGE_ID, self.config["debugMode"])
	
			_multi_thread_upload(self, self, self.token, self.config["serviceApiUrl"], FILE, 
				START_UPLOAD_INFO, self.config["debugMode"])
	
			_upload_complete_asset(self, self, self.token, self.config["serviceApiUrl"], 
			...
			if START_UPLOAD_INFO:
				_cancel_upload(self, self, self.token, self.config["serviceApiUrl"], 
					START_UPLOAD_INFO["id"], self.debug_mode)
			raise Exception(error.args[0])
	...
	def upload_related_asset(self, EXISTING_ASSET_ID: str, RELATED_ASSET_ID: str | None,
		...
		try:
			...
			print("Start upload")
			START_UPLOAD_INFO = _start_related_asset_upload(self, self, self.token, self.config["serviceApiUrl"],
			...
			DETAILS = _get_asset_details(self, self, self.token, self.config["serviceApiUrl"], EXISTING_ASSET_ID,
	...
	def get_audit(self, CONTENT_ID: str) -> dict:
		try:
			...
			AUDIT = _get_audit(self, self, self.token, self.config["serviceApiUrl"], CONTENT_ID, self.debug_mode)
	...
	def clear_server_cache(self) -> None:
		try:
			...
			_clear_server_cache(self, self, self.token, self.config["serviceApiUrl"], self.debug_mode)
	...
	def get_config(self, CONFIG_TYPE: int) -> dict:
		try:
			...
			CONFIG = _get_config(self, self, self.token, self.config["serviceApiUrl"], CONFIG_TYPE, self.debug_mode)
	...
	def get_server_time(self) -> dict:
		try:
			...
			SERVER_TIME = _get_server_time(self, self, self.token, self.config["serviceApiUrl"], self.debug_mode)
	...
	def create_content(self, CONTENT_DEFINITION_ID: str, LANGUAGE_ID: str | None) -> dict:
		try:
			...
			CONTENT_ID = _create_content(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def deactivate_content_user_track(self, SESSION_ID: str, CONTENT_ID: str,
		...
		try:
			...
			_deactivate_content_user_track(self, self, self.token, self.config["serviceApiUrl"], SESSION_ID, 
	...
	def delete_content(self, CONTENT_ID: str, CONTENT_DEFINITION_ID: str) -> None:
		try:
			...
			_delete_content(self, self, self.token, self.config["serviceApiUrl"], CONTENT_ID, 
	...
	def get_content(self, CONTENT_ID, CONTENT_DEFINITION_ID, IS_REVISION) -> dict:
		try:
			...
			CONTENT = _get_content(self, self, self.token, self.config["serviceApiUrl"], CONTENT_ID, 
	...
	def get_content_user_track(self, CONTENT_ID: str, CONTENT_DEFINITION_ID: str, 
		...
		try:
			...
			CONTENT = _get_content_user_track(self, self, self.token, self.config["serviceApiUrl"], CONTENT_ID, 
	...
	def get_content_user_track_touch(self, CONTENT_ID: str, CONTENT_DEFINITION_ID: str) -> dict:
		try:
			...
			CONTENT = _get_content_user_track_touch(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def update_content(self, CONTENT_ID: str, CONTENT_DEFINITION_ID: str, PROPERTIES: dict, 
		...
		try:
			...
			_update_content(self, self, self.token, self.config["serviceApiUrl"], CONTENT_ID, 
	...
	def add_custom_properties(self, CONTENT_ID: str, NAME: str | None, DATE: str | None,
		...
		try:
			...
			CONTENT = _add_custom_properties(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def add_related_content(self, CONTENT_ID: str, RELATED_CONTENT_ID: str, 
		...
		try:
			...
			CONTENT = _add_related_content(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def add_tag_or_collection(self, TYPE: str, CONTENT_ID: str, CONTENT_DEFINITION: str, 
		...
		try:
			...
			CONTENT = _add_tag_or_collection(self, self, self.token, self.config["serviceApiUrl"], TYPE, 
	...
	def bulk_update_metadata(self, CONTENT_IDS: List[str], COLLECTION_IDS: List[str], 
		...
		try:
			...
			_bulk_update_metadata(self, self, self.token, self.config["serviceApiUrl"], CONTENT_IDS, 
	...
	def create_tag_or_collection(self, TYPE: str, TAG_NAME: str) -> dict:
		try:
			...
			CONTENT = _create_tag_or_collection(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def delete_related_content(self, CONTENT_ID: str, RELATED_CONTENT_ID: str, 
		...
		try:
			...
			CONTENT = _delete_related_content(self, self, self.token, self.config["serviceApiUrl"], 
				CONTENT_ID, RELATED_CONTENT_ID, CONTENT_DEFINITION, self.config["apiType"],
				self.debug_mode)
	...
	def delete_tag_or_collection(self, TYPE: str, TAG_ID: str) -> dict:
		try:
			...
			CONTENT = _delete_tag_or_collection(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def get_tag_or_collection(self, TYPE: str, TAG_ID: str) -> dict:
		try:
			...
			CONTENT = _get_tag_or_collection(self, self, self.token, self.config["serviceApiUrl"], 
				TYPE, TAG_ID, self.debug_mode)
	...
	def remove_tag_or_collection(self, TYPE: str, CONTENT_ID: str, 
		...
		try:
			...
			CONTENT = _remove_tag_or_collection(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def get_content_definition(self, ID: str) -> dict:
		try:
			...
			CONTENT = _get_content_definition(self, self, self.token, self.config["serviceApiUrl"], ID, self.debug_mode)
	...
	def get_content_definitions(self, CONTENT_MANAGEMENT_TYPE: int | None, SORT_COLUMN: str | None,
		...
		try:
			...
			CONTENT = _get_content_definitions(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def add_live_schedule_to_event(self, EVENT_ID: str, SLATE_VIDEO: dict | None, 
		...
		try:
			...
			_add_live_schedule_to_event(self, self, self.token, self.config["serviceApiUrl"], EVENT_ID, SLATE_VIDEO, 
	...
	def create_and_update_event(self, CONTENT_ID: str | None, CONTENT_DEFINITION_ID: str, 
		...
		try:
			...
			EVENT = _create_and_update_event(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def delete_event(self, CONTENT_ID: str, CONTENT_DEFINITION_ID: str) -> None:
		try:
			...
			_delete_event(self, self, self.token, self.config["serviceApiUrl"], CONTENT_ID, 
				CONTENT_DEFINITION_ID, self.debug_mode)
	...
	def extend_live_schedule(self, EVENT_ID: str, RECURRING_DAYS: List[dict],
		...
		try:
			...
			_extend_live_schedule(self, self, self.token, self.config["serviceApiUrl"], EVENT_ID, 
	...
	def get_live_schedule(self, EVENT_ID: str) -> dict:
		try:
			...
			EVENT = _get_live_schedule(self, self, self.token, self.config["serviceApiUrl"], EVENT_ID, 
				self.debug_mode)
	...
	def start_live_schedule(self, EVENT_ID: str) -> None:
		try:
			...
			_start_live_schedule(self, self, self.token, self.config["serviceApiUrl"], EVENT_ID, 
				self.debug_mode)
	...
	def stop_live_schedule(self, EVENT_ID: str) -> None:
		try:
			...
			_stop_live_schedule(self, self, self.token, self.config["serviceApiUrl"], EVENT_ID, 
				self.debug_mode)
	...
	def clip_live_channel(self, LIVE_CHANNEL_ID: str, START_TIME_CODE: str | None, 
		...
		try:
			...
			LIVE_CHANNEL = _clip_live_channel(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def create_live_channel(self, NAME: str | None, THUMBNAIL_IMAGE_ID: str | None, 
		...
		try:
			...
			LIVE_CHANNEL_INFO = _create_live_channel(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def delete_live_channel(self, LIVE_CHANNEL_ID: str, DELETE_INPUTS: bool) -> None:
		try:
			...
			_delete_live_channel(self, self, self.token, self.config["serviceApiUrl"], LIVE_CHANNEL_ID, 
	...
	def get_live_channel(self, LIVE_CHANNEL_ID: str) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_live_channel(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def get_live_channels(self) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_live_channels(self, self, self, self.token, self.config["serviceApiUrl"], 
				self.debug_mode)
	...
	def live_channel_refresh(self) -> None:
		try:
			...
			_live_channel_refresh(self, self, self.token, self.config["serviceApiUrl"], self.debug_mode)
	...
	def next_event(self, LIVE_CHANNEL_ID: str) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _next_event(self, self, self.token, self.config["serviceApiUrl"], 
				LIVE_CHANNEL_ID, self.debug_mode)
	...
	def start_live_channel(self, LIVE_CHANNEL_ID: str, WAIT_FOR_START: bool | None) -> None:
		try:
			...
			_start_live_channel(self, self, self.token, self.config["serviceApiUrl"], LIVE_CHANNEL_ID, 
	...
	def start_output_tracking(self, LIVE_CHANNEL_ID: str) -> None:
		try:
			...
			_start_output_tracking(self, self, self.token, self.config["serviceApiUrl"], LIVE_CHANNEL_ID, 
				self.debug_mode)
	...
	def stop_live_channel(self, LIVE_CHANNEL_ID: str, WAIT_FOR_STOP: bool | None) -> None:
		try:
			...
			_stop_live_channel(self, self, self.token, self.config["serviceApiUrl"], LIVE_CHANNEL_ID, 
	...
	def update_live_channel(self, LIVE_CHANNEL_ID: str, NAME: str | None, 
		...
		try:
			...
			LIVE_CHANNLEL_INFO = _update_live_channel(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def create_live_input(self, NAME: str | None, SOURCE: str | None, TYPE: str | None, 
		...
		try:
			...
			LIVE_CHANNEL_INFO = _create_live_input(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def delete_live_input(self, LIVE_INPUT_ID: str) -> None:
		try:
			...
			_delete_live_input(self, self, self.token, self.config["serviceApiUrl"], LIVE_INPUT_ID, 
								self.debug_mode)
	...
	def get_live_input(self, LIVE_INPUT_ID: str) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_live_input(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def get_live_inputs(self) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_live_inputs(self, self, self.token, self.config["serviceApiUrl"], 
				self.debug_mode)
	...
	def update_live_input(self, LIVE_INPUT_ID: str, NAME: str | None, SOURCE: str | None, 
		...
		try:
			...
			LIVE_CHANNEL_INFO = _update_live_input(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def cancel_broadcast(self, LIVE_OPERATOR_ID: str) -> None:
		try:
			...
			_cancel_broadcast(self, self, self.token, self.config["serviceApiUrl"], LIVE_OPERATOR_ID, 
				self.debug_mode)
	...
	def cancel_segment(self, LIVE_OPERATOR_ID: str) -> None:
		try:
			...
			_cancel_segment(self, self, self.token, self.config["serviceApiUrl"], LIVE_OPERATOR_ID, 
				self.debug_mode)
	...
	def complete_segment(self, LIVE_OPERATOR_ID: str, RELATED_CONTENT_IDS: List[str] | None, 
		...
		try:
			...
			_complete_segment(self, self, self.token, self.config["serviceApiUrl"], LIVE_OPERATOR_ID, 
	...
	def get_completed_segments(self, LIVE_OPERATOR_ID: str) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_completed_segments(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def get_live_operator(self, LIVE_OPERATOR_ID: str) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_live_operator(self, self, self.token, self.config["serviceApiUrl"], 
				LIVE_OPERATOR_ID, self.debug_mode)
	...
	def get_live_operators(self) -> dict:
		try:
			...
			LIVE_CHANNEL_INFO = _get_live_operators(self, self, self.token, self.config["serviceApiUrl"], 
				self.debug_mode)
	...
	def start_broadcast(self, LIVE_OPERATOR_ID: str, PREROLL_ASSET_ID: str | None, 
		...
		try:
			...
			START_BROADCAST_INFO = _start_broadcast(self, self, self.token, self.config["serviceApiUrl"], LIVE_OPERATOR_ID, 
	...
	def start_segment(self, LIVE_OPERATOR_ID: str) -> None:
		try:
			...
			_start_segment(self, self, self.token, self.config["serviceApiUrl"], LIVE_OPERATOR_ID, 
				self.debug_mode)
	...
	def stop_broadcast(self, LIVE_OPERATOR_ID: str) -> None:
		try:
			...
			_stop_broadcast(self, self, self.token, self.config["serviceApiUrl"], LIVE_OPERATOR_ID, 
				self.debug_mode)
	...
	def create_live_output_profile(self, NAME: str, OUTPUT_TYPE: str | None, ENABLED: bool | None,
		...
		try:
			...
			LIVE_OUTPUT_INFO = _create_live_output_profile(self, self, self.token, self.config["serviceApiUrl"], 
	...
	def delete_live_output_profile(self, LIVE_OUTPUT_ID: str) -> None:
		try:
			...
			_delete_live_output_profile(self, self, self.token, self.config["serviceApiUrl"], LIVE_OUTPUT_ID, 
				self.debug_mode)
