...
class ClustFCC(BiobbObject):
    ...
    def launch(self) -> int:
        ...
        fu.zip_list(self.io_dict['out']['output_cluster_zip_path'], output_file_list, self.out_log)
...
def clust_fcc(input_haddock_wf_data_zip: str, output_cluster_zip_path: str,
    ...
    return ClustFCC(input_haddock_wf_data_zip=input_haddock_wf_data_zip,
                    output_cluster_zip_path=output_cluster_zip_path,
...
def main():
    parser = argparse.ArgumentParser(description="Wrapper of the haddock ClustFCC module.",
    ...
    clust_fcc(input_haddock_wf_data_zip=args.input_haddock_wf_data_zip,
