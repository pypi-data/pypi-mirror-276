...
def flex_ref(input_haddock_wf_data_zip: str, refinement_output_zip_path: str,
    ...
    return FlexRef(input_haddock_wf_data_zip=input_haddock_wf_data_zip,
                   refinement_output_zip_path=refinement_output_zip_path,
...
def main():
    parser = argparse.ArgumentParser(description="Wrapper of the haddock FlexRef module.",
    ...
    flex_ref(input_haddock_wf_data_zip=args.input_haddock_wf_data_zip,
