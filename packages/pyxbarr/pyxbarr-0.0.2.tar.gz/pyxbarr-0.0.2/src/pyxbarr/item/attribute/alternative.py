...
from pyxbarr.item.attribute.__base__ import Attribute, AttributeName, INVALID_ATTRIBUTE_VALUE
...
class AlternateAttribute(Attribute):
    ...
    Notes:
        This attribute is fully managed by pyxbarr and should not be accessed directly.
    """
