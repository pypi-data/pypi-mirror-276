...
def merge_data(folders, pv_format=False):
    ...
    for folder in folders:
        ...
        if data_source == "v":
            ...
            scalefactors["tissue_lowres_scalef"] = scalefactors["tissue_lowres_scalef"] / micron_per_pixel
        scalefactor_hires_vals.append(scalefactors["tissue_hires_scalef"])
        scalefactor_lowres_vals.append(scalefactors["tissue_lowres_scalef"])
    ...
    scalefactors_for_save["tissue_lowres_scalef"] = min(scalefactor_lowres_vals)
