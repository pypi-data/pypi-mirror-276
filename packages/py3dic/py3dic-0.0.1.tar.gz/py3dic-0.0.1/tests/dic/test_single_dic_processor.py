...
from py3dic.dic import DICProcessorBatch
from py3dic.dic._old_pydic import read_dic_file
from py3dic.dic import SingleImageDisplacementProcessor, DICProcessorRolling,EnumInteropolation, EnumStrainType
...
def test_single_dic_processor():
    ...
    # expected value
    idp  = ImageDisplacementProcessorBatch(image_pattern=image_pattern, 
