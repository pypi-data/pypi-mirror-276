...
from .. import Char2Num, char2num as default_char2num, parse_sample as _parse_sample, Sample as GenericSample
...
def parse_sample(line: str, char2num: Char2Num = default_char2num) -> Sample:
  (tokens, ends), labs = _parse_sample(line)
  input_ids = [char2num[tok] for tok in tokens]
