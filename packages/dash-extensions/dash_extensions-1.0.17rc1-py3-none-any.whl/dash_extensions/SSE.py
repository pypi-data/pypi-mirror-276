...
- value (string; optional):
    ...
    _type = 'SSE'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, options=Component.UNDEFINED, url=Component.UNDEFINED, concat=Component.UNDEFINED, value=Component.UNDEFINED, animate_delay=Component.UNDEFINED, animate_chunk=Component.UNDEFINED, done=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'animate_chunk', 'animate_delay', 'concat', 'done', 'options', 'url', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'animate_chunk', 'animate_delay', 'concat', 'done', 'options', 'url', 'value']
