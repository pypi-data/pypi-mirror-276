...
T = TypeVar("T", bound="AssistantToolResourcesType0FileSearch")


@_attrs_define
class AssistantToolResourcesType0FileSearch:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assistant_tool_resources_type_0_file_search = cls(
            vector_store_ids=vector_store_ids,
        )

        assistant_tool_resources_type_0_file_search.additional_properties = d
        return assistant_tool_resources_type_0_file_search
