...
T = TypeVar("T", bound="RunStepCompletionUsageType0")


@_attrs_define
class RunStepCompletionUsageType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        run_step_completion_usage_type_0 = cls(
            completion_tokens=completion_tokens,
            prompt_tokens=prompt_tokens,
            total_tokens=total_tokens,
        )

        run_step_completion_usage_type_0.additional_properties = d
        return run_step_completion_usage_type_0
