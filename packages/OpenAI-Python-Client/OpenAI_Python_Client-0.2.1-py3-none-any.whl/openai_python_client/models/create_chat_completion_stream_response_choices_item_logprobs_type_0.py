...
T = TypeVar("T", bound="CreateChatCompletionStreamResponseChoicesItemLogprobsType0")


@_attrs_define
class CreateChatCompletionStreamResponseChoicesItemLogprobsType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_chat_completion_stream_response_choices_item_logprobs_type_0 = cls(
            content=content,
        )

        create_chat_completion_stream_response_choices_item_logprobs_type_0.additional_properties = d
        return create_chat_completion_stream_response_choices_item_logprobs_type_0
