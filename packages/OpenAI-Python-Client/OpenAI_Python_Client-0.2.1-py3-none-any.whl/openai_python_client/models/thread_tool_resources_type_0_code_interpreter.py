...
T = TypeVar("T", bound="ThreadToolResourcesType0CodeInterpreter")


@_attrs_define
class ThreadToolResourcesType0CodeInterpreter:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        thread_tool_resources_type_0_code_interpreter = cls(
            file_ids=file_ids,
        )

        thread_tool_resources_type_0_code_interpreter.additional_properties = d
        return thread_tool_resources_type_0_code_interpreter
