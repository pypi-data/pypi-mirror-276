...
T = TypeVar("T", bound="AssistantMessageFunctionCall")
...
class AssistantMessageFunctionCall:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assistant_message_function_call = cls(
            arguments=arguments,
            name=name,
        )

        assistant_message_function_call.additional_properties = d
        return assistant_message_function_call
