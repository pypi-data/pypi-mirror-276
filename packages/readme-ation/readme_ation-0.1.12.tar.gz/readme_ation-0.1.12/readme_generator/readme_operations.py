import os
import re
from .utils import get_python_version, get_imported_packages, open_or_create_readme
from .package_manager import get_installed_packages, get_specific_packages_versions

def add_setup_with_versions(file_paths, readme_path):
    readme_content = open_or_create_readme(readme_path)
    python_version = get_python_version()
    installed_packages = get_installed_packages()
    imported_packages = get_imported_packages(file_paths)
