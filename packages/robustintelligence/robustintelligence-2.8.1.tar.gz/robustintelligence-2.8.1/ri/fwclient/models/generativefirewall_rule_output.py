...
class GenerativefirewallRuleOutput(BaseModel):
    ...
    regulatory_standards: Optional[List[GenerativefirewallStandardInfo]] = Field(default=None, description="Standards encodes which regulatory standards (MITRE, OWASP) are addressed by this firewall rule.", alias="regulatoryStandards")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regulatoryStandards": [GenerativefirewallStandardInfo.from_dict(_item) for _item in obj["regulatoryStandards"]] if obj.get("regulatoryStandards") is not None else None
        })
        return _obj
