...
class RimeRepoMetadata(BaseModel):
    """
    RimeRepoMetadata
    """ # noqa: E501
    ...
    reputation: Optional[RimeRepoMetadataReputation] = None
    license: Optional[RimeRepoMetadataLicense] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RimeRepoMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RimeRepoMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "reputation": RimeRepoMetadataReputation.from_dict(obj["reputation"]) if obj.get("reputation") is not None else None,
            "license": RimeRepoMetadataLicense.from_dict(obj["license"]) if obj.get("license") is not None else None,
