...
class RimeGetModelSecurityReportResponse(BaseModel):
    ...
    repo_metadata: Optional[RimeRepoMetadata] = Field(default=None, alias="repoMetadata")
    file_scan_result: Optional[RimeFileScanResult] = Field(default=None, alias="fileScanResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repoMetadata": RimeRepoMetadata.from_dict(obj["repoMetadata"]) if obj.get("repoMetadata") is not None else None,
            "fileScanResult": RimeFileScanResult.from_dict(obj["fileScanResult"]) if obj.get("fileScanResult") is not None else None
        })
        return _obj
