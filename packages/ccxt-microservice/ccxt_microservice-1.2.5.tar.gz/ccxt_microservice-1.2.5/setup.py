...
setuptools.setup(
    ...
    description="Micro service to call cryptocurrency exchanges API using [ccxt](https://github.com/ccxt/ccxt).",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/ccxt-microservice",  # 模块github地址
