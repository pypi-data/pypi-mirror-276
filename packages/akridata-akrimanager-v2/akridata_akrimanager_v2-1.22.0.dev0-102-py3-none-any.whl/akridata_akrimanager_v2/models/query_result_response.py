...
class QueryResultResponse(object):
    ...
    openapi_types = {
        ...
        'result_set_json_list': 'list[object]'
    }
    ...
    def __init__(self, query_id=None, max_per_page=None, row_count=None, page_token=None, columns_list=None, result_set=None, result_set_json_list=None, local_vars_configuration=None):  # noqa: E501
    ...
    def result_set_json_list(self, result_set_json_list):
        ...
        :type result_set_json_list: list[object]
        """
