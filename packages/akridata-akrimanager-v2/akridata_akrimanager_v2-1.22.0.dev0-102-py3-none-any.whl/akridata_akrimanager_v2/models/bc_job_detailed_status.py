...
class BCJobDetailedStatus(object):
    ...
    def __init__(self, job_id=None, job_type=None, progress=None, status=None, error_msg=None, start_time=None, end_time=None, pipeline_ids=None, local_vars_configuration=None):  # noqa: E501
