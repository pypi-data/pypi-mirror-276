...
class BCAttachmentProgressReportResp(object):
    ...
    def __init__(self, start_time=None, end_time=None, status=None, error_logs=None, total_files_to_be_processed=None, total_files_processed=None, skipped_files_count=None, stage=None, total_tasks=None, tasks_waiting_for_resource=None, tasks_active=None, tasks_completed=None, input_sub_dir=None, policy_details=None, progress=None, local_vars_configuration=None):  # noqa: E501
