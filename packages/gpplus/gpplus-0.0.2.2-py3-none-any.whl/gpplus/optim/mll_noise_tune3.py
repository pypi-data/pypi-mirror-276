...
def noise_tune3_fixed_noise(
    model:GPR,add_prior:bool=True,
    num_restarts:int=16,criterion:str='NLL',
    ...
    while True:
        ...
        if t == 1:
            ...
            if index >= 2 and index < len(history['noise_history'])-2:
                ...
                print(f'Negative log likelihood_final={nllll}')
        ...
        for i in range(1):#(len(noises)):
            ...
            model.likelihood.initialize(**{'noise':actual_noise_value/(model.y_std **2.0)})
