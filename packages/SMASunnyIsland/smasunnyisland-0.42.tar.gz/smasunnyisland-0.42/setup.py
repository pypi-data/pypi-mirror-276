...
setup(
    ...
    packages=find_packages(include=['smasunnyisland', 'vendor.pysunspec']),
    package_dir={
        'smasunnyisland': 'smasunnyisland',
        'vendor.pysunspec': 'vendor/pysunspec',
    },
    install_requires=['pyserial', 'pymodbus==2.5.3'],
